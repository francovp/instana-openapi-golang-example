...
func (r ApiGetInfrastructureMetricsRequest) Execute() (*InfrastructureMetricResult, *http.Response, error) {
...
*/
func (a *InfrastructureMetricsApiService) GetInfrastructureMetrics(ctx context.Context) ApiGetInfrastructureMetricsRequest {
	return ApiGetInfrastructureMetricsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *InfrastructureMetricsApiService) GetInfrastructureMetricsExecute(r ApiGetInfrastructureMetricsRequest) (*InfrastructureMetricResult, *http.Response, error) {
	var (
