...
// ApplicationAlertConfigWithMetadata struct for ApplicationAlertConfigWithMetadata
type ApplicationAlertConfigWithMetadata struct {
...
func NewApplicationAlertConfigWithMetadata(alertChannelIds []string, applications map[string]ApplicationNode, boundaryScope string, customPayloadFields []CustomPayloadField, description string, evaluationType string, granularity int32, id string, name string, rule ApplicationAlertRule, tagFilterExpression TagFilterExpressionElement, threshold Threshold, timeThreshold ApplicationTimeThreshold) *ApplicationAlertConfigWithMetadata {
	this := ApplicationAlertConfigWithMetadata{}
...
func (o ApplicationAlertConfigWithMetadata) MarshalJSON() ([]byte, error) {
...
type NullableApplicationAlertConfigWithMetadata struct {
	value *ApplicationAlertConfigWithMetadata
	isSet bool
}

func (v NullableApplicationAlertConfigWithMetadata) Get() *ApplicationAlertConfigWithMetadata {
	return v.value
}

func (v *NullableApplicationAlertConfigWithMetadata) Set(val *ApplicationAlertConfigWithMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationAlertConfigWithMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationAlertConfigWithMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationAlertConfigWithMetadata(val *ApplicationAlertConfigWithMetadata) *NullableApplicationAlertConfigWithMetadata {
	return &NullableApplicationAlertConfigWithMetadata{value: val, isSet: true}
}

func (v NullableApplicationAlertConfigWithMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationAlertConfigWithMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
