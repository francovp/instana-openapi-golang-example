...
// WebsiteEventBasedSliEntityAllOf struct for WebsiteEventBasedSliEntityAllOf
type WebsiteEventBasedSliEntityAllOf struct {
...
func NewWebsiteEventBasedSliEntityAllOf() *WebsiteEventBasedSliEntityAllOf {
	this := WebsiteEventBasedSliEntityAllOf{}
	return &this
}
...
func (o WebsiteEventBasedSliEntityAllOf) MarshalJSON() ([]byte, error) {
...
type NullableWebsiteEventBasedSliEntityAllOf struct {
	value *WebsiteEventBasedSliEntityAllOf
	isSet bool
}

func (v NullableWebsiteEventBasedSliEntityAllOf) Get() *WebsiteEventBasedSliEntityAllOf {
	return v.value
}

func (v *NullableWebsiteEventBasedSliEntityAllOf) Set(val *WebsiteEventBasedSliEntityAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableWebsiteEventBasedSliEntityAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableWebsiteEventBasedSliEntityAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebsiteEventBasedSliEntityAllOf(val *WebsiteEventBasedSliEntityAllOf) *NullableWebsiteEventBasedSliEntityAllOf {
	return &NullableWebsiteEventBasedSliEntityAllOf{value: val, isSet: true}
}

func (v NullableWebsiteEventBasedSliEntityAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebsiteEventBasedSliEntityAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
