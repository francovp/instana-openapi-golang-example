...
// WebsiteBeaconGroupsResult struct for WebsiteBeaconGroupsResult
type WebsiteBeaconGroupsResult struct {
...
func NewWebsiteBeaconGroupsResult(items []WebsiteBeaconGroupsItem) *WebsiteBeaconGroupsResult {
	this := WebsiteBeaconGroupsResult{}
	this.Items = items
	return &this
}
...
func (o WebsiteBeaconGroupsResult) MarshalJSON() ([]byte, error) {
...
type NullableWebsiteBeaconGroupsResult struct {
	value *WebsiteBeaconGroupsResult
	isSet bool
}

func (v NullableWebsiteBeaconGroupsResult) Get() *WebsiteBeaconGroupsResult {
	return v.value
}

func (v *NullableWebsiteBeaconGroupsResult) Set(val *WebsiteBeaconGroupsResult) {
	v.value = val
	v.isSet = true
}

func (v NullableWebsiteBeaconGroupsResult) IsSet() bool {
	return v.isSet
}

func (v *NullableWebsiteBeaconGroupsResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebsiteBeaconGroupsResult(val *WebsiteBeaconGroupsResult) *NullableWebsiteBeaconGroupsResult {
	return &NullableWebsiteBeaconGroupsResult{value: val, isSet: true}
}

func (v NullableWebsiteBeaconGroupsResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebsiteBeaconGroupsResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
