...
// InvitationResult struct for InvitationResult
...
func (o InvitationResult) MarshalJSON() ([]byte, error) {
...
type NullableInvitationResult struct {
	value *InvitationResult
	isSet bool
}

func (v NullableInvitationResult) Get() *InvitationResult {
	return v.value
}

func (v *NullableInvitationResult) Set(val *InvitationResult) {
	v.value = val
	v.isSet = true
}

func (v NullableInvitationResult) IsSet() bool {
	return v.isSet
}

func (v *NullableInvitationResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvitationResult(val *InvitationResult) *NullableInvitationResult {
	return &NullableInvitationResult{value: val, isSet: true}
}

func (v NullableInvitationResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvitationResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
