...
type ApiGetApplicationEndpointsRequest struct {
	ctx                      context.Context
...
// Name of service
func (r ApiGetApplicationEndpointsRequest) NameFilter(nameFilter string) ApiGetApplicationEndpointsRequest {
	r.nameFilter = &nameFilter
	return r
}

// Type of Endpoint
func (r ApiGetApplicationEndpointsRequest) Types(types []string) ApiGetApplicationEndpointsRequest {
	r.types = &types
	return r
}

// List of technologies
func (r ApiGetApplicationEndpointsRequest) Technologies(technologies []string) ApiGetApplicationEndpointsRequest {
	r.technologies = &technologies
	return r
}

// Size of time window in milliseconds
func (r ApiGetApplicationEndpointsRequest) WindowSize(windowSize int64) ApiGetApplicationEndpointsRequest {
	r.windowSize = &windowSize
	return r
}

// Timestamp since Unix Epoch in milliseconds of the end of the time window
func (r ApiGetApplicationEndpointsRequest) To(to int64) ApiGetApplicationEndpointsRequest {
	r.to = &to
	return r
}

// Page number from results
func (r ApiGetApplicationEndpointsRequest) Page(page int32) ApiGetApplicationEndpointsRequest {
	r.page = &page
	return r
}

// Number of items per page
func (r ApiGetApplicationEndpointsRequest) PageSize(pageSize int32) ApiGetApplicationEndpointsRequest {
	r.pageSize = &pageSize
	return r
}

// Filter for application scope, i.e: INBOUND or ALL
func (r ApiGetApplicationEndpointsRequest) ApplicationBoundaryScope(applicationBoundaryScope string) ApiGetApplicationEndpointsRequest {
	r.applicationBoundaryScope = &applicationBoundaryScope
	return r
}

func (r ApiGetApplicationEndpointsRequest) Execute() (*EndpointResult, *http.Response, error) {
	return r.ApiService.GetApplicationEndpointsExecute(r)
}

/*
GetApplicationEndpoints Get endpoints

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetApplicationEndpointsRequest
*/
func (a *ApplicationResourcesApiService) GetApplicationEndpoints(ctx context.Context) ApiGetApplicationEndpointsRequest {
	return ApiGetApplicationEndpointsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ApplicationResourcesApiService) GetApplicationEndpointsExecute(r ApiGetApplicationEndpointsRequest) (*EndpointResult, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationResourcesApiService.GetApplicationEndpoints")
	if err != nil {
...
func (r ApiGetApplicationServicesRequest) Execute() (*ServiceResult, *http.Response, error) {
...
*/
func (a *ApplicationResourcesApiService) GetApplicationServices(ctx context.Context) ApiGetApplicationServicesRequest {
	return ApiGetApplicationServicesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ApplicationResourcesApiService) GetApplicationServicesExecute(r ApiGetApplicationServicesRequest) (*ServiceResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetApplicationsRequest) Execute() (*ApplicationResult, *http.Response, error) {
...
*/
func (a *ApplicationResourcesApiService) GetApplications(ctx context.Context) ApiGetApplicationsRequest {
	return ApiGetApplicationsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ApplicationResourcesApiService) GetApplicationsExecute(r ApiGetApplicationsRequest) (*ApplicationResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetServicesRequest) Execute() (*ServiceResult, *http.Response, error) {
...
*/
func (a *ApplicationResourcesApiService) GetServices(ctx context.Context) ApiGetServicesRequest {
	return ApiGetServicesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return ServiceResult
func (a *ApplicationResourcesApiService) GetServicesExecute(r ApiGetServicesRequest) (*ServiceResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
