...
// MobileAppBeaconGroupsItem struct for MobileAppBeaconGroupsItem
type MobileAppBeaconGroupsItem struct {
...
func NewMobileAppBeaconGroupsItem(cursor IngestionOffsetCursor, metrics map[string][][]float32, name string) *MobileAppBeaconGroupsItem {
	this := MobileAppBeaconGroupsItem{}
	this.Cursor = cursor
...
func (o *MobileAppBeaconGroupsItem) GetEarliestTimestamp() int64 {
	if o == nil || isNil(o.EarliestTimestamp) {
		var ret int64
		return ret
	}
...
func (o MobileAppBeaconGroupsItem) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["cursor"] = o.Cursor
	}
	if !isNil(o.EarliestTimestamp) {
...
type NullableMobileAppBeaconGroupsItem struct {
	value *MobileAppBeaconGroupsItem
	isSet bool
}

func (v NullableMobileAppBeaconGroupsItem) Get() *MobileAppBeaconGroupsItem {
	return v.value
}

func (v *NullableMobileAppBeaconGroupsItem) Set(val *MobileAppBeaconGroupsItem) {
	v.value = val
	v.isSet = true
}

func (v NullableMobileAppBeaconGroupsItem) IsSet() bool {
	return v.isSet
}

func (v *NullableMobileAppBeaconGroupsItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMobileAppBeaconGroupsItem(val *MobileAppBeaconGroupsItem) *NullableMobileAppBeaconGroupsItem {
	return &NullableMobileAppBeaconGroupsItem{value: val, isSet: true}
}

func (v NullableMobileAppBeaconGroupsItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMobileAppBeaconGroupsItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
