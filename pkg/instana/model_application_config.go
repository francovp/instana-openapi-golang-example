...
type ApplicationConfig struct {
	...
	MatchSpecification  *MatchExpressionDTO         `json:"matchSpecification,omitempty"`
...
// GetMatchSpecification returns the MatchSpecification field value if set, zero value otherwise.
func (o *ApplicationConfig) GetMatchSpecification() MatchExpressionDTO {
	if o == nil || isNil(o.MatchSpecification) {
...
// GetMatchSpecificationOk returns a tuple with the MatchSpecification field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetMatchSpecification gets a reference to the given MatchExpressionDTO and assigns it to the MatchSpecification field.
