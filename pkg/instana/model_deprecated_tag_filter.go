...
// DeprecatedTagFilter struct for DeprecatedTagFilter
type DeprecatedTagFilter struct {
...
func (o DeprecatedTagFilter) MarshalJSON() ([]byte, error) {
...
type NullableDeprecatedTagFilter struct {
	value *DeprecatedTagFilter
	isSet bool
}

func (v NullableDeprecatedTagFilter) Get() *DeprecatedTagFilter {
	return v.value
}

func (v *NullableDeprecatedTagFilter) Set(val *DeprecatedTagFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableDeprecatedTagFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableDeprecatedTagFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeprecatedTagFilter(val *DeprecatedTagFilter) *NullableDeprecatedTagFilter {
	return &NullableDeprecatedTagFilter{value: val, isSet: true}
}

func (v NullableDeprecatedTagFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeprecatedTagFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
