...
// BackendTraceReference struct for BackendTraceReference
type BackendTraceReference struct {
...
func (o BackendTraceReference) MarshalJSON() ([]byte, error) {
...
type NullableBackendTraceReference struct {
	value *BackendTraceReference
	isSet bool
}

func (v NullableBackendTraceReference) Get() *BackendTraceReference {
	return v.value
}

func (v *NullableBackendTraceReference) Set(val *BackendTraceReference) {
	v.value = val
	v.isSet = true
}

func (v NullableBackendTraceReference) IsSet() bool {
	return v.isSet
}

func (v *NullableBackendTraceReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBackendTraceReference(val *BackendTraceReference) *NullableBackendTraceReference {
	return &NullableBackendTraceReference{value: val, isSet: true}
}

func (v NullableBackendTraceReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBackendTraceReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
