...
// SyntheticTypeConfiguration Synthetic test configuration that is unique to a synthetic type. Valid types are BrowserScriptConfiguration, HttpActionConfiguration, HttpScriptConfiguration, WebpageActionConfiguration, WebpageScriptConfiguration.  Only HttpActionConfiguration, HttpScriptConfiguration and BrowserScriptConfiguration   are enabled at this time.
type SyntheticTypeConfiguration struct {
...
func NewSyntheticTypeConfiguration(markSyntheticCall bool, syntheticType string) *SyntheticTypeConfiguration {
	this := SyntheticTypeConfiguration{}
...
// GetMarkSyntheticCall returns the MarkSyntheticCall field value
func (o *SyntheticTypeConfiguration) GetMarkSyntheticCall() bool {
	...
	return o.MarkSyntheticCall
}

// GetMarkSyntheticCallOk returns a tuple with the MarkSyntheticCall field value
// and a boolean to check if the value has been set.
func (o *SyntheticTypeConfiguration) GetMarkSyntheticCallOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.MarkSyntheticCall, true
}

// SetMarkSyntheticCall sets field value
func (o *SyntheticTypeConfiguration) SetMarkSyntheticCall(v bool) {
	o.MarkSyntheticCall = v
}
...
// GetSyntheticType returns the SyntheticType field value
...
// GetSyntheticTypeOk returns a tuple with the SyntheticType field value
// and a boolean to check if the value has been set.
...
// SetSyntheticType sets field value
...
func (o SyntheticTypeConfiguration) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["markSyntheticCall"] = o.MarkSyntheticCall
	}
	if !isNil(o.Retries) {
...
type NullableSyntheticTypeConfiguration struct {
	value *SyntheticTypeConfiguration
	isSet bool
}

func (v NullableSyntheticTypeConfiguration) Get() *SyntheticTypeConfiguration {
	return v.value
}

func (v *NullableSyntheticTypeConfiguration) Set(val *SyntheticTypeConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableSyntheticTypeConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableSyntheticTypeConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyntheticTypeConfiguration(val *SyntheticTypeConfiguration) *NullableSyntheticTypeConfiguration {
	return &NullableSyntheticTypeConfiguration{value: val, isSet: true}
}

func (v NullableSyntheticTypeConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyntheticTypeConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
