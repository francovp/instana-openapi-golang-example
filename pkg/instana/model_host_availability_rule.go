...
// HostAvailabilityRule struct for HostAvailabilityRule
type HostAvailabilityRule struct {
...
func NewHostAvailabilityRule(ruleType string) *HostAvailabilityRule {
	this := HostAvailabilityRule{}
...
func (o HostAvailabilityRule) MarshalJSON() ([]byte, error) {
...
type NullableHostAvailabilityRule struct {
	value *HostAvailabilityRule
	isSet bool
}

func (v NullableHostAvailabilityRule) Get() *HostAvailabilityRule {
	return v.value
}

func (v *NullableHostAvailabilityRule) Set(val *HostAvailabilityRule) {
	v.value = val
	v.isSet = true
}

func (v NullableHostAvailabilityRule) IsSet() bool {
	return v.isSet
}

func (v *NullableHostAvailabilityRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostAvailabilityRule(val *HostAvailabilityRule) *NullableHostAvailabilityRule {
	return &NullableHostAvailabilityRule{value: val, isSet: true}
}

func (v NullableHostAvailabilityRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostAvailabilityRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
