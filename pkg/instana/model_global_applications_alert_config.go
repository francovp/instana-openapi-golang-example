...
// GlobalApplicationsAlertConfig struct for GlobalApplicationsAlertConfig
type GlobalApplicationsAlertConfig struct {
...
func NewGlobalApplicationsAlertConfig(alertChannelIds []string, applications map[string]ApplicationNode, boundaryScope string, customPayloadFields []CustomPayloadField, description string, evaluationType string, granularity int32, name string, rule ApplicationAlertRule, tagFilterExpression TagFilterExpressionElement, threshold Threshold, timeThreshold ApplicationTimeThreshold) *GlobalApplicationsAlertConfig {
	this := GlobalApplicationsAlertConfig{}
...
func (o GlobalApplicationsAlertConfig) MarshalJSON() ([]byte, error) {
...
type NullableGlobalApplicationsAlertConfig struct {
	value *GlobalApplicationsAlertConfig
	isSet bool
}

func (v NullableGlobalApplicationsAlertConfig) Get() *GlobalApplicationsAlertConfig {
	return v.value
}

func (v *NullableGlobalApplicationsAlertConfig) Set(val *GlobalApplicationsAlertConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableGlobalApplicationsAlertConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableGlobalApplicationsAlertConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGlobalApplicationsAlertConfig(val *GlobalApplicationsAlertConfig) *NullableGlobalApplicationsAlertConfig {
	return &NullableGlobalApplicationsAlertConfig{value: val, isSet: true}
}

func (v NullableGlobalApplicationsAlertConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGlobalApplicationsAlertConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
