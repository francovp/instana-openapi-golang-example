...
// TestResultCommonProperties struct for TestResultCommonProperties
type TestResultCommonProperties struct {
	ClientId             string                `json:"clientId"`
	Errors               []string              `json:"errors,omitempty"`
	Id                   *string               `json:"id,omitempty"`
	LocationId           *string               `json:"locationId,omitempty"`
	TestCommonProperties *TestCommonProperties `json:"testCommonProperties,omitempty"`
...
func NewTestResultCommonProperties(clientId string, testId string) *TestResultCommonProperties {
	this := TestResultCommonProperties{}
...
// GetTestCommonProperties returns the TestCommonProperties field value if set, zero value otherwise.
func (o *TestResultCommonProperties) GetTestCommonProperties() TestCommonProperties {
	if o == nil || isNil(o.TestCommonProperties) {
		var ret TestCommonProperties
		return ret
	}
	return *o.TestCommonProperties
}

// GetTestCommonPropertiesOk returns a tuple with the TestCommonProperties field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TestResultCommonProperties) GetTestCommonPropertiesOk() (*TestCommonProperties, bool) {
	if o == nil || isNil(o.TestCommonProperties) {
		return nil, false
	}
	return o.TestCommonProperties, true
}
...
// SetTestCommonProperties gets a reference to the given TestCommonProperties and assigns it to the TestCommonProperties field.
func (o *TestResultCommonProperties) SetTestCommonProperties(v TestCommonProperties) {
	o.TestCommonProperties = &v
}
...
func (o TestResultCommonProperties) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.TestCommonProperties) {
		toSerialize["testCommonProperties"] = o.TestCommonProperties
	}
	if true {
...
type NullableTestResultCommonProperties struct {
	value *TestResultCommonProperties
	isSet bool
}

func (v NullableTestResultCommonProperties) Get() *TestResultCommonProperties {
	return v.value
}

func (v *NullableTestResultCommonProperties) Set(val *TestResultCommonProperties) {
	v.value = val
	v.isSet = true
}

func (v NullableTestResultCommonProperties) IsSet() bool {
	return v.isSet
}

func (v *NullableTestResultCommonProperties) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTestResultCommonProperties(val *TestResultCommonProperties) *NullableTestResultCommonProperties {
	return &NullableTestResultCommonProperties{value: val, isSet: true}
}

func (v NullableTestResultCommonProperties) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTestResultCommonProperties) UnmarshalJSON(src []byte) error {
	v.isSet = true
