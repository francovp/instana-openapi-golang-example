...
// AdaptiveBaselineAllOf struct for AdaptiveBaselineAllOf
type AdaptiveBaselineAllOf struct {
...
func (o *AdaptiveBaselineAllOf) GetDeviationFactor() float64 {
	if o == nil || isNil(o.DeviationFactor) {
		var ret float64
		return ret
	}
...
func (o AdaptiveBaselineAllOf) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.DeviationFactor) {
		toSerialize["deviationFactor"] = o.DeviationFactor
	}
	return json.Marshal(toSerialize)
}

type NullableAdaptiveBaselineAllOf struct {
	value *AdaptiveBaselineAllOf
	isSet bool
}

func (v NullableAdaptiveBaselineAllOf) Get() *AdaptiveBaselineAllOf {
	return v.value
}

func (v *NullableAdaptiveBaselineAllOf) Set(val *AdaptiveBaselineAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAdaptiveBaselineAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAdaptiveBaselineAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdaptiveBaselineAllOf(val *AdaptiveBaselineAllOf) *NullableAdaptiveBaselineAllOf {
	return &NullableAdaptiveBaselineAllOf{value: val, isSet: true}
}

func (v NullableAdaptiveBaselineAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdaptiveBaselineAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
