...
// StatusCodeApplicationAlertRuleAllOf struct for StatusCodeApplicationAlertRuleAllOf
type StatusCodeApplicationAlertRuleAllOf struct {
...
func NewStatusCodeApplicationAlertRuleAllOf() *StatusCodeApplicationAlertRuleAllOf {
	this := StatusCodeApplicationAlertRuleAllOf{}
	return &this
}
...
func (o StatusCodeApplicationAlertRuleAllOf) MarshalJSON() ([]byte, error) {
...
type NullableStatusCodeApplicationAlertRuleAllOf struct {
	value *StatusCodeApplicationAlertRuleAllOf
	isSet bool
}

func (v NullableStatusCodeApplicationAlertRuleAllOf) Get() *StatusCodeApplicationAlertRuleAllOf {
	return v.value
}

func (v *NullableStatusCodeApplicationAlertRuleAllOf) Set(val *StatusCodeApplicationAlertRuleAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStatusCodeApplicationAlertRuleAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStatusCodeApplicationAlertRuleAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStatusCodeApplicationAlertRuleAllOf(val *StatusCodeApplicationAlertRuleAllOf) *NullableStatusCodeApplicationAlertRuleAllOf {
	return &NullableStatusCodeApplicationAlertRuleAllOf{value: val, isSet: true}
}

func (v NullableStatusCodeApplicationAlertRuleAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStatusCodeApplicationAlertRuleAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
