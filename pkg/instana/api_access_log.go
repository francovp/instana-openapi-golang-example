...
// AccessLogApiService AccessLogApi service
type AccessLogApiService service

type ApiGetAccessLogsRequest struct {
	ctx        context.Context
	ApiService *AccessLogApiService
	offset     *int32
	query      *string
	pageSize   *int32
}

func (r ApiGetAccessLogsRequest) Offset(offset int32) ApiGetAccessLogsRequest {
	r.offset = &offset
	return r
}

func (r ApiGetAccessLogsRequest) Query(query string) ApiGetAccessLogsRequest {
	r.query = &query
	return r
}
...
func (r ApiGetAccessLogsRequest) Execute() (*AccessLogResponse, *http.Response, error) {
	return r.ApiService.GetAccessLogsExecute(r)
}

/*
GetAccessLogs Access log

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetAccessLogsRequest
*/
func (a *AccessLogApiService) GetAccessLogs(ctx context.Context) ApiGetAccessLogsRequest {
	return ApiGetAccessLogsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *AccessLogApiService) GetAccessLogsExecute(r ApiGetAccessLogsRequest) (*AccessLogResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *AccessLogResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccessLogApiService.GetAccessLogs")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/settings/accesslog"
