...
// TagFilterExpression struct for TagFilterExpression
...
func NewTagFilterExpression(elements []TagFilterExpressionElement, logicalOperator string, type_ string) *TagFilterExpression {
	this := TagFilterExpression{}
	this.Type = type_
...
func (o TagFilterExpression) MarshalJSON() ([]byte, error) {
...
type NullableTagFilterExpression struct {
	value *TagFilterExpression
	isSet bool
}

func (v NullableTagFilterExpression) Get() *TagFilterExpression {
	return v.value
}

func (v *NullableTagFilterExpression) Set(val *TagFilterExpression) {
	v.value = val
	v.isSet = true
}

func (v NullableTagFilterExpression) IsSet() bool {
	return v.isSet
}

func (v *NullableTagFilterExpression) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagFilterExpression(val *TagFilterExpression) *NullableTagFilterExpression {
	return &NullableTagFilterExpression{value: val, isSet: true}
}

func (v NullableTagFilterExpression) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagFilterExpression) UnmarshalJSON(src []byte) error {
	v.isSet = true
