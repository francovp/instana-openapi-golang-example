...
// CustomEventWebsiteAlertRule struct for CustomEventWebsiteAlertRule
type CustomEventWebsiteAlertRule struct {
...
func NewCustomEventWebsiteAlertRule(customEventName string, alertType string, metricName string) *CustomEventWebsiteAlertRule {
	this := CustomEventWebsiteAlertRule{}
...
func (o CustomEventWebsiteAlertRule) MarshalJSON() ([]byte, error) {
...
type NullableCustomEventWebsiteAlertRule struct {
	value *CustomEventWebsiteAlertRule
	isSet bool
}

func (v NullableCustomEventWebsiteAlertRule) Get() *CustomEventWebsiteAlertRule {
	return v.value
}

func (v *NullableCustomEventWebsiteAlertRule) Set(val *CustomEventWebsiteAlertRule) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomEventWebsiteAlertRule) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomEventWebsiteAlertRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomEventWebsiteAlertRule(val *CustomEventWebsiteAlertRule) *NullableCustomEventWebsiteAlertRule {
	return &NullableCustomEventWebsiteAlertRule{value: val, isSet: true}
}

func (v NullableCustomEventWebsiteAlertRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomEventWebsiteAlertRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
