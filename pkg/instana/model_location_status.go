...
type LocationStatus struct {
	...
	SuccessRuns   *int64   `json:"successRuns,omitempty"`
	TotalTestRuns *int64   `json:"totalTestRuns,omitempty"`
}
...
// GetSuccessRuns returns the SuccessRuns field value if set, zero value otherwise.
func (o *LocationStatus) GetSuccessRuns() int64 {
	if o == nil || isNil(o.SuccessRuns) {
		var ret int64
		return ret
	}
	return *o.SuccessRuns
}

// GetSuccessRunsOk returns a tuple with the SuccessRuns field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LocationStatus) GetSuccessRunsOk() (*int64, bool) {
	if o == nil || isNil(o.SuccessRuns) {
		return nil, false
	}
	return o.SuccessRuns, true
}
...
// SetSuccessRuns gets a reference to the given int64 and assigns it to the SuccessRuns field.
func (o *LocationStatus) SetSuccessRuns(v int64) {
	o.SuccessRuns = &v
}

// GetTotalTestRuns returns the TotalTestRuns field value if set, zero value otherwise.
func (o *LocationStatus) GetTotalTestRuns() int64 {
	if o == nil || isNil(o.TotalTestRuns) {
		var ret int64
		return ret
	}
...
// GetTotalTestRunsOk returns a tuple with the TotalTestRuns field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetTotalTestRuns gets a reference to the given int64 and assigns it to the TotalTestRuns field.
...
func (o LocationStatus) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.SuccessRuns) {
		toSerialize["successRuns"] = o.SuccessRuns
	}
	if !isNil(o.TotalTestRuns) {
		toSerialize["totalTestRuns"] = o.TotalTestRuns
	}
