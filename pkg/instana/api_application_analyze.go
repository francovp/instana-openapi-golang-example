...
func (r ApiGetCallGroupRequest) Execute() (*CallGroupsResult, *http.Response, error) {
...
*/
func (a *ApplicationAnalyzeApiService) GetCallGroup(ctx context.Context) ApiGetCallGroupRequest {
	return ApiGetCallGroupRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ApplicationAnalyzeApiService) GetCallGroupExecute(r ApiGetCallGroupRequest) (*CallGroupsResult, *http.Response, error) {
	var (
...
type ApiGetCorrelatedTracesRequest struct {
	ctx           context.Context
	ApiService    *ApplicationAnalyzeApiService
	correlationId *string
}

func (r ApiGetCorrelatedTracesRequest) CorrelationId(correlationId string) ApiGetCorrelatedTracesRequest {
	r.correlationId = &correlationId
	return r
}

func (r ApiGetCorrelatedTracesRequest) Execute() ([]BackendTraceReference, *http.Response, error) {
	return r.ApiService.GetCorrelatedTracesExecute(r)
}
...
GetCorrelatedTraces Resolve backend trace IDs using correlation IDs from website and mobile app monitoring beacons.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetCorrelatedTracesRequest
*/
func (a *ApplicationAnalyzeApiService) GetCorrelatedTraces(ctx context.Context) ApiGetCorrelatedTracesRequest {
	return ApiGetCorrelatedTracesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ApplicationAnalyzeApiService) GetCorrelatedTracesExecute(r ApiGetCorrelatedTracesRequest) ([]BackendTraceReference, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue []BackendTraceReference
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationAnalyzeApiService.GetCorrelatedTraces")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/application-monitoring/analyze/backend-correlation"
	...
	if strlen(*r.correlationId) < 0 {
		return localVarReturnValue, nil, reportError("correlationId must have at least 0 elements")
	}
	if strlen(*r.correlationId) > 128 {
		return localVarReturnValue, nil, reportError("correlationId must have less than 128 elements")
	}

	localVarQueryParams.Add("correlationId", parameterToString(*r.correlationId, ""))
	// to determine the Content-Type header
...
func (r ApiGetTraceRequest) Execute() (*FullTrace, *http.Response, error) {
...
*/
func (a *ApplicationAnalyzeApiService) GetTrace(ctx context.Context, id string) ApiGetTraceRequest {
	return ApiGetTraceRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return FullTrace
func (a *ApplicationAnalyzeApiService) GetTraceExecute(r ApiGetTraceRequest) (*FullTrace, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetTraceGroupsRequest) Execute() (*TraceGroupsResult, *http.Response, error) {
...
*/
func (a *ApplicationAnalyzeApiService) GetTraceGroups(ctx context.Context) ApiGetTraceGroupsRequest {
	return ApiGetTraceGroupsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ApplicationAnalyzeApiService) GetTraceGroupsExecute(r ApiGetTraceGroupsRequest) (*TraceGroupsResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetTracesRequest) Execute() (*TraceResult, *http.Response, error) {
...
*/
func (a *ApplicationAnalyzeApiService) GetTraces(ctx context.Context) ApiGetTracesRequest {
	return ApiGetTracesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return TraceResult
func (a *ApplicationAnalyzeApiService) GetTracesExecute(r ApiGetTracesRequest) (*TraceResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
