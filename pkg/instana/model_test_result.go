...
type TestResult struct {
	TestResult      []TestResultItem `json:"testResult,omitempty"`
	TestResultItems []TestResultItem `json:"testResultItems,omitempty"`
}
...
// SetTestResult gets a reference to the given []TestResultItem and assigns it to the TestResult field.
func (o *TestResult) SetTestResult(v []TestResultItem) {
	o.TestResult = v
}

// GetTestResultItems returns the TestResultItems field value if set, zero value otherwise.
func (o *TestResult) GetTestResultItems() []TestResultItem {
	if o == nil || isNil(o.TestResultItems) {
		var ret []TestResultItem
		return ret
	}
	return o.TestResultItems
}

// GetTestResultItemsOk returns a tuple with the TestResultItems field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TestResult) GetTestResultItemsOk() ([]TestResultItem, bool) {
	if o == nil || isNil(o.TestResultItems) {
		return nil, false
	}
	return o.TestResultItems, true
}
...
// SetTestResultItems gets a reference to the given []TestResultItem and assigns it to the TestResultItems field.
...
func (o TestResult) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.TestResultItems) {
		toSerialize["testResultItems"] = o.TestResultItems
	}
