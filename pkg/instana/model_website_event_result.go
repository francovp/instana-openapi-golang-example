...
// WebsiteEventResult struct for WebsiteEventResult
type WebsiteEventResult struct {
...
func (o WebsiteEventResult) MarshalJSON() ([]byte, error) {
...
type NullableWebsiteEventResult struct {
	value *WebsiteEventResult
	isSet bool
}

func (v NullableWebsiteEventResult) Get() *WebsiteEventResult {
	return v.value
}

func (v *NullableWebsiteEventResult) Set(val *WebsiteEventResult) {
	v.value = val
	v.isSet = true
}

func (v NullableWebsiteEventResult) IsSet() bool {
	return v.isSet
}

func (v *NullableWebsiteEventResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebsiteEventResult(val *WebsiteEventResult) *NullableWebsiteEventResult {
	return &NullableWebsiteEventResult{value: val, isSet: true}
}

func (v NullableWebsiteEventResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebsiteEventResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
