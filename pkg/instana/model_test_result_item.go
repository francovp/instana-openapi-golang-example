...
// TestResultItem struct for TestResultItem
...
func (o TestResultItem) MarshalJSON() ([]byte, error) {
...
type NullableTestResultItem struct {
	value *TestResultItem
	isSet bool
}

func (v NullableTestResultItem) Get() *TestResultItem {
	return v.value
}

func (v *NullableTestResultItem) Set(val *TestResultItem) {
	v.value = val
	v.isSet = true
}

func (v NullableTestResultItem) IsSet() bool {
	return v.isSet
}

func (v *NullableTestResultItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTestResultItem(val *TestResultItem) *NullableTestResultItem {
	return &NullableTestResultItem{value: val, isSet: true}
}

func (v NullableTestResultItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTestResultItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
