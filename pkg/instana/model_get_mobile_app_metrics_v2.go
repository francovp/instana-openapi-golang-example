...
// GetMobileAppMetricsV2 struct for GetMobileAppMetricsV2
type GetMobileAppMetricsV2 struct {
...
func (o GetMobileAppMetricsV2) MarshalJSON() ([]byte, error) {
...
type NullableGetMobileAppMetricsV2 struct {
	value *GetMobileAppMetricsV2
	isSet bool
}

func (v NullableGetMobileAppMetricsV2) Get() *GetMobileAppMetricsV2 {
	return v.value
}

func (v *NullableGetMobileAppMetricsV2) Set(val *GetMobileAppMetricsV2) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMobileAppMetricsV2) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMobileAppMetricsV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMobileAppMetricsV2(val *GetMobileAppMetricsV2) *NullableGetMobileAppMetricsV2 {
	return &NullableGetMobileAppMetricsV2{value: val, isSet: true}
}

func (v NullableGetMobileAppMetricsV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMobileAppMetricsV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
