...
// GetMobileAppBeacons struct for GetMobileAppBeacons
type GetMobileAppBeacons struct {
...
func (o GetMobileAppBeacons) MarshalJSON() ([]byte, error) {
...
type NullableGetMobileAppBeacons struct {
	value *GetMobileAppBeacons
	isSet bool
}

func (v NullableGetMobileAppBeacons) Get() *GetMobileAppBeacons {
	return v.value
}

func (v *NullableGetMobileAppBeacons) Set(val *GetMobileAppBeacons) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMobileAppBeacons) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMobileAppBeacons) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMobileAppBeacons(val *GetMobileAppBeacons) *NullableGetMobileAppBeacons {
	return &NullableGetMobileAppBeacons{value: val, isSet: true}
}

func (v NullableGetMobileAppBeacons) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMobileAppBeacons) UnmarshalJSON(src []byte) error {
	v.isSet = true
