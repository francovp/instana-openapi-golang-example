...
type ApiGetApplicationDataMetricsV2Request struct {
	ctx                   context.Context
	ApiService            *ApplicationMetricsApiService
	getApplicationMetrics *GetApplicationMetrics
}

func (r ApiGetApplicationDataMetricsV2Request) GetApplicationMetrics(getApplicationMetrics GetApplicationMetrics) ApiGetApplicationDataMetricsV2Request {
	r.getApplicationMetrics = &getApplicationMetrics
	return r
}

func (r ApiGetApplicationDataMetricsV2Request) Execute() (*MetricAPIResult, *http.Response, error) {
	return r.ApiService.GetApplicationDataMetricsV2Execute(r)
}

/*
GetApplicationDataMetricsV2 Get Application Data Metrics

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetApplicationDataMetricsV2Request
*/
func (a *ApplicationMetricsApiService) GetApplicationDataMetricsV2(ctx context.Context) ApiGetApplicationDataMetricsV2Request {
	return ApiGetApplicationDataMetricsV2Request{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ApplicationMetricsApiService) GetApplicationDataMetricsV2Execute(r ApiGetApplicationDataMetricsV2Request) (*MetricAPIResult, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationMetricsApiService.GetApplicationDataMetricsV2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/application-monitoring/v2/metrics"
	...
	// body params
	localVarPostBody = r.getApplicationMetrics
	if r.ctx != nil {
...
func (r ApiGetApplicationMetricsRequest) Execute() (*ApplicationMetricResult, *http.Response, error) {
...
*/
func (a *ApplicationMetricsApiService) GetApplicationMetrics(ctx context.Context) ApiGetApplicationMetricsRequest {
	return ApiGetApplicationMetricsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ApplicationMetricsApiService) GetApplicationMetricsExecute(r ApiGetApplicationMetricsRequest) (*ApplicationMetricResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetEndpointsMetricsRequest) Execute() (*EndpointMetricResult, *http.Response, error) {
...
*/
func (a *ApplicationMetricsApiService) GetEndpointsMetrics(ctx context.Context) ApiGetEndpointsMetricsRequest {
	return ApiGetEndpointsMetricsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ApplicationMetricsApiService) GetEndpointsMetricsExecute(r ApiGetEndpointsMetricsRequest) (*EndpointMetricResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetServicesMetricsRequest) Execute() (*ServiceMetricResult, *http.Response, error) {
...
*/
func (a *ApplicationMetricsApiService) GetServicesMetrics(ctx context.Context) ApiGetServicesMetricsRequest {
	return ApiGetServicesMetricsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ApplicationMetricsApiService) GetServicesMetricsExecute(r ApiGetServicesMetricsRequest) (*ServiceMetricResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
