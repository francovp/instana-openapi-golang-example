...
func (r ApiAddApplicationConfigRequest) Execute() (*ApplicationConfig, *http.Response, error) {
...
*/
func (a *ApplicationSettingsApiService) AddApplicationConfig(ctx context.Context) ApiAddApplicationConfigRequest {
	return ApiAddApplicationConfigRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ApplicationSettingsApiService) AddApplicationConfigExecute(r ApiAddApplicationConfigRequest) (*ApplicationConfig, *http.Response, error) {
	var (
...
type ApiAddManualServiceConfigRequest struct {
	ctx                    context.Context
	ApiService             *ApplicationSettingsApiService
	newManualServiceConfig *NewManualServiceConfig
}

func (r ApiAddManualServiceConfigRequest) NewManualServiceConfig(newManualServiceConfig NewManualServiceConfig) ApiAddManualServiceConfigRequest {
	r.newManualServiceConfig = &newManualServiceConfig
	return r
}

func (r ApiAddManualServiceConfigRequest) Execute() (*ManualServiceConfig, *http.Response, error) {
	return r.ApiService.AddManualServiceConfigExecute(r)
}
...
**enabled** `true`
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiAddManualServiceConfigRequest
*/
func (a *ApplicationSettingsApiService) AddManualServiceConfig(ctx context.Context) ApiAddManualServiceConfigRequest {
	return ApiAddManualServiceConfigRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ApplicationSettingsApiService) AddManualServiceConfigExecute(r ApiAddManualServiceConfigRequest) (*ManualServiceConfig, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ManualServiceConfig
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationSettingsApiService.AddManualServiceConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/application-monitoring/settings/manual-service"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.newManualServiceConfig == nil {
		return localVarReturnValue, nil, reportError("newManualServiceConfig is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.newManualServiceConfig
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKeyAuth"]; ok {
...
func (r ApiAddServiceConfigRequest) Execute() (*ServiceConfig, *http.Response, error) {
...
*/
func (a *ApplicationSettingsApiService) AddServiceConfig(ctx context.Context) ApiAddServiceConfigRequest {
	return ApiAddServiceConfigRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ApplicationSettingsApiService) AddServiceConfigExecute(r ApiAddServiceConfigRequest) (*ServiceConfig, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiCreateEndpointConfigRequest) Execute() (*HttpEndpointConfig, *http.Response, error) {
...
*/
func (a *ApplicationSettingsApiService) CreateEndpointConfig(ctx context.Context) ApiCreateEndpointConfigRequest {
	return ApiCreateEndpointConfigRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ApplicationSettingsApiService) CreateEndpointConfigExecute(r ApiCreateEndpointConfigRequest) (*HttpEndpointConfig, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiDeleteApplicationConfigRequest) Execute() (*http.Response, error) {
...
*/
func (a *ApplicationSettingsApiService) DeleteApplicationConfig(ctx context.Context, id string) ApiDeleteApplicationConfigRequest {
	return ApiDeleteApplicationConfigRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *ApplicationSettingsApiService) DeleteApplicationConfigExecute(r ApiDeleteApplicationConfigRequest) (*http.Response, error) {
	var (
...
func (r ApiDeleteEndpointConfigRequest) Execute() (*http.Response, error) {
...
*/
func (a *ApplicationSettingsApiService) DeleteEndpointConfig(ctx context.Context, id string) ApiDeleteEndpointConfigRequest {
	return ApiDeleteEndpointConfigRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *ApplicationSettingsApiService) DeleteEndpointConfigExecute(r ApiDeleteEndpointConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
...
type ApiDeleteManualServiceConfigRequest struct {
	ctx        context.Context
	ApiService *ApplicationSettingsApiService
	id         string
}

func (r ApiDeleteManualServiceConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteManualServiceConfigExecute(r)
}
...
**This is an experimental endpoint to workaround service mapping issues.**
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiDeleteManualServiceConfigRequest
*/
func (a *ApplicationSettingsApiService) DeleteManualServiceConfig(ctx context.Context, id string) ApiDeleteManualServiceConfigRequest {
	return ApiDeleteManualServiceConfigRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *ApplicationSettingsApiService) DeleteManualServiceConfigExecute(r ApiDeleteManualServiceConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationSettingsApiService.DeleteManualServiceConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/application-monitoring/settings/manual-service/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterToString(r.id, "")), -1)
...
func (r ApiDeleteServiceConfigRequest) Execute() (*http.Response, error) {
...
*/
func (a *ApplicationSettingsApiService) DeleteServiceConfig(ctx context.Context, id string) ApiDeleteServiceConfigRequest {
	return ApiDeleteServiceConfigRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *ApplicationSettingsApiService) DeleteServiceConfigExecute(r ApiDeleteServiceConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
...
type ApiGetAllManualServiceConfigsRequest struct {
	ctx        context.Context
	ApiService *ApplicationSettingsApiService
}

func (r ApiGetAllManualServiceConfigsRequest) Execute() ([]ManualServiceConfig, *http.Response, error) {
	return r.ApiService.GetAllManualServiceConfigsExecute(r)
}
...
**This is an experimental endpoint to workaround service mapping issues.**
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetAllManualServiceConfigsRequest
*/
func (a *ApplicationSettingsApiService) GetAllManualServiceConfigs(ctx context.Context) ApiGetAllManualServiceConfigsRequest {
	return ApiGetAllManualServiceConfigsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return []ManualServiceConfig
func (a *ApplicationSettingsApiService) GetAllManualServiceConfigsExecute(r ApiGetAllManualServiceConfigsRequest) ([]ManualServiceConfig, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationSettingsApiService.GetAllManualServiceConfigs")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetApplicationConfigRequest) Execute() (*ApplicationConfig, *http.Response, error) {
...
*/
func (a *ApplicationSettingsApiService) GetApplicationConfig(ctx context.Context, id string) ApiGetApplicationConfigRequest {
	return ApiGetApplicationConfigRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return ApplicationConfig
func (a *ApplicationSettingsApiService) GetApplicationConfigExecute(r ApiGetApplicationConfigRequest) (*ApplicationConfig, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetApplicationConfigsRequest) Execute() ([]ApplicationConfig, *http.Response, error) {
...
*/
func (a *ApplicationSettingsApiService) GetApplicationConfigs(ctx context.Context) ApiGetApplicationConfigsRequest {
	return ApiGetApplicationConfigsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return []ApplicationConfig
func (a *ApplicationSettingsApiService) GetApplicationConfigsExecute(r ApiGetApplicationConfigsRequest) ([]ApplicationConfig, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetEndpointConfigRequest) Execute() (*HttpEndpointConfig, *http.Response, error) {
...
*/
func (a *ApplicationSettingsApiService) GetEndpointConfig(ctx context.Context, id string) ApiGetEndpointConfigRequest {
	return ApiGetEndpointConfigRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return HttpEndpointConfig
func (a *ApplicationSettingsApiService) GetEndpointConfigExecute(r ApiGetEndpointConfigRequest) (*HttpEndpointConfig, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetEndpointConfigsRequest) Execute() ([]HttpEndpointConfig, *http.Response, error) {
...
*/
func (a *ApplicationSettingsApiService) GetEndpointConfigs(ctx context.Context) ApiGetEndpointConfigsRequest {
	return ApiGetEndpointConfigsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return []HttpEndpointConfig
func (a *ApplicationSettingsApiService) GetEndpointConfigsExecute(r ApiGetEndpointConfigsRequest) ([]HttpEndpointConfig, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetServiceConfigRequest) Execute() (*ServiceConfig, *http.Response, error) {
...
*/
func (a *ApplicationSettingsApiService) GetServiceConfig(ctx context.Context, id string) ApiGetServiceConfigRequest {
	return ApiGetServiceConfigRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return ServiceConfig
func (a *ApplicationSettingsApiService) GetServiceConfigExecute(r ApiGetServiceConfigRequest) (*ServiceConfig, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetServiceConfigsRequest) Execute() ([]ServiceConfig, *http.Response, error) {
...
*/
func (a *ApplicationSettingsApiService) GetServiceConfigs(ctx context.Context) ApiGetServiceConfigsRequest {
	return ApiGetServiceConfigsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return []ServiceConfig
func (a *ApplicationSettingsApiService) GetServiceConfigsExecute(r ApiGetServiceConfigsRequest) ([]ServiceConfig, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiOrderServiceConfigRequest) Execute() (*http.Response, error) {
...
*/
func (a *ApplicationSettingsApiService) OrderServiceConfig(ctx context.Context) ApiOrderServiceConfigRequest {
	return ApiOrderServiceConfigRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *ApplicationSettingsApiService) OrderServiceConfigExecute(r ApiOrderServiceConfigRequest) (*http.Response, error) {
	var (
...
func (r ApiPutApplicationConfigRequest) Execute() (*ApplicationConfig, *http.Response, error) {
...
Update an existing Application Perspective.
...
*/
func (a *ApplicationSettingsApiService) PutApplicationConfig(ctx context.Context, id string) ApiPutApplicationConfigRequest {
	return ApiPutApplicationConfigRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return ApplicationConfig
func (a *ApplicationSettingsApiService) PutApplicationConfigExecute(r ApiPutApplicationConfigRequest) (*ApplicationConfig, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiPutServiceConfigRequest) Execute() (*ServiceConfig, *http.Response, error) {
...
*/
func (a *ApplicationSettingsApiService) PutServiceConfig(ctx context.Context, id string) ApiPutServiceConfigRequest {
	return ApiPutServiceConfigRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return ServiceConfig
func (a *ApplicationSettingsApiService) PutServiceConfigExecute(r ApiPutServiceConfigRequest) (*ServiceConfig, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiReplaceAllRequest) Execute() ([]ServiceConfig, *http.Response, error) {
...
*/
func (a *ApplicationSettingsApiService) ReplaceAll(ctx context.Context) ApiReplaceAllRequest {
	return ApiReplaceAllRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return []ServiceConfig
func (a *ApplicationSettingsApiService) ReplaceAllExecute(r ApiReplaceAllRequest) ([]ServiceConfig, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
...
type ApiReplaceAllManualServiceConfigsRequest struct {
	ctx                    context.Context
	ApiService             *ApplicationSettingsApiService
	newManualServiceConfig *[]NewManualServiceConfig
}

func (r ApiReplaceAllManualServiceConfigsRequest) NewManualServiceConfig(newManualServiceConfig []NewManualServiceConfig) ApiReplaceAllManualServiceConfigsRequest {
	r.newManualServiceConfig = &newManualServiceConfig
	return r
}

func (r ApiReplaceAllManualServiceConfigsRequest) Execute() ([]ManualServiceConfig, *http.Response, error) {
	return r.ApiService.ReplaceAllManualServiceConfigsExecute(r)
}
...
**enabled** `true`
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiReplaceAllManualServiceConfigsRequest
*/
func (a *ApplicationSettingsApiService) ReplaceAllManualServiceConfigs(ctx context.Context) ApiReplaceAllManualServiceConfigsRequest {
	return ApiReplaceAllManualServiceConfigsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return []ManualServiceConfig
func (a *ApplicationSettingsApiService) ReplaceAllManualServiceConfigsExecute(r ApiReplaceAllManualServiceConfigsRequest) ([]ManualServiceConfig, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationSettingsApiService.ReplaceAllManualServiceConfigs")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateEndpointConfigRequest) Execute() (*HttpEndpointConfig, *http.Response, error) {
...
*/
func (a *ApplicationSettingsApiService) UpdateEndpointConfig(ctx context.Context, id string) ApiUpdateEndpointConfigRequest {
	return ApiUpdateEndpointConfigRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return HttpEndpointConfig
func (a *ApplicationSettingsApiService) UpdateEndpointConfigExecute(r ApiUpdateEndpointConfigRequest) (*HttpEndpointConfig, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
...
type ApiUpdateManualServiceConfigRequest struct {
	ctx                 context.Context
	ApiService          *ApplicationSettingsApiService
	id                  string
	manualServiceConfig *ManualServiceConfig
}

func (r ApiUpdateManualServiceConfigRequest) ManualServiceConfig(manualServiceConfig ManualServiceConfig) ApiUpdateManualServiceConfigRequest {
	r.manualServiceConfig = &manualServiceConfig
	return r
}

func (r ApiUpdateManualServiceConfigRequest) Execute() (*ManualServiceConfig, *http.Response, error) {
	return r.ApiService.UpdateManualServiceConfigExecute(r)
}
...
**enabled** `true`
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiUpdateManualServiceConfigRequest
*/
func (a *ApplicationSettingsApiService) UpdateManualServiceConfig(ctx context.Context, id string) ApiUpdateManualServiceConfigRequest {
	return ApiUpdateManualServiceConfigRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return ManualServiceConfig
func (a *ApplicationSettingsApiService) UpdateManualServiceConfigExecute(r ApiUpdateManualServiceConfigRequest) (*ManualServiceConfig, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationSettingsApiService.UpdateManualServiceConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.manualServiceConfig == nil {
		return localVarReturnValue, nil, reportError("manualServiceConfig is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.manualServiceConfig
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKeyAuth"]; ok {
