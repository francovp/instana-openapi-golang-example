...
func (r ApiGetBeaconGroupsRequest) Execute() (*WebsiteBeaconGroupsResult, *http.Response, error) {
...
*/
func (a *WebsiteAnalyzeApiService) GetBeaconGroups(ctx context.Context) ApiGetBeaconGroupsRequest {
	return ApiGetBeaconGroupsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *WebsiteAnalyzeApiService) GetBeaconGroupsExecute(r ApiGetBeaconGroupsRequest) (*WebsiteBeaconGroupsResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *WebsiteBeaconGroupsResult
	)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		var v WebsiteBeaconGroupsResult
...
func (r ApiGetBeaconsRequest) Execute() (*WebsiteBeaconResult, *http.Response, error) {
...
*/
func (a *WebsiteAnalyzeApiService) GetBeacons(ctx context.Context) ApiGetBeaconsRequest {
	return ApiGetBeaconsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return WebsiteBeaconResult
func (a *WebsiteAnalyzeApiService) GetBeaconsExecute(r ApiGetBeaconsRequest) (*WebsiteBeaconResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *WebsiteBeaconResult
	)
