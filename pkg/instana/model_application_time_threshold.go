...
// ApplicationTimeThreshold struct for ApplicationTimeThreshold
type ApplicationTimeThreshold struct {
...
func (o ApplicationTimeThreshold) MarshalJSON() ([]byte, error) {
...
type NullableApplicationTimeThreshold struct {
	value *ApplicationTimeThreshold
	isSet bool
}

func (v NullableApplicationTimeThreshold) Get() *ApplicationTimeThreshold {
	return v.value
}

func (v *NullableApplicationTimeThreshold) Set(val *ApplicationTimeThreshold) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationTimeThreshold) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationTimeThreshold) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationTimeThreshold(val *ApplicationTimeThreshold) *NullableApplicationTimeThreshold {
	return &NullableApplicationTimeThreshold{value: val, isSet: true}
}

func (v NullableApplicationTimeThreshold) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationTimeThreshold) UnmarshalJSON(src []byte) error {
	v.isSet = true
