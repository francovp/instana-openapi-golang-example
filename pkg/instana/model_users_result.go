...
type UsersResult struct {
	Invitations []InvitationResult `json:"invitations,omitempty"`
...
// SetInvitations gets a reference to the given []InvitationResult and assigns it to the Invitations field.
