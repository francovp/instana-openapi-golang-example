...
// TestResultDetailData struct for TestResultDetailData
type TestResultDetailData struct {
	Har                      map[string]interface{}     `json:"har,omitempty"`
	Images                   []string                   `json:"images,omitempty"`
	Logs                     *string                    `json:"logs,omitempty"`
	Name                     *string                    `json:"name,omitempty"`
	SubtransactionAvgMetrics map[string]interface{}     `json:"subtransactionAvgMetrics,omitempty"`
	Subtransactions          []TestResultSubtransaction `json:"subtransactions,omitempty"`
...
// GetSubtransactionAvgMetrics returns the SubtransactionAvgMetrics field value if set, zero value otherwise.
func (o *TestResultDetailData) GetSubtransactionAvgMetrics() map[string]interface{} {
	if o == nil || isNil(o.SubtransactionAvgMetrics) {
		var ret map[string]interface{}
		return ret
	}
	return o.SubtransactionAvgMetrics
}

// GetSubtransactionAvgMetricsOk returns a tuple with the SubtransactionAvgMetrics field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TestResultDetailData) GetSubtransactionAvgMetricsOk() (map[string]interface{}, bool) {
	if o == nil || isNil(o.SubtransactionAvgMetrics) {
		return map[string]interface{}{}, false
	}
	return o.SubtransactionAvgMetrics, true
}
...
// SetSubtransactionAvgMetrics gets a reference to the given map[string]interface{} and assigns it to the SubtransactionAvgMetrics field.
func (o *TestResultDetailData) SetSubtransactionAvgMetrics(v map[string]interface{}) {
	o.SubtransactionAvgMetrics = v
}

// GetSubtransactions returns the Subtransactions field value if set, zero value otherwise.
func (o *TestResultDetailData) GetSubtransactions() []TestResultSubtransaction {
	if o == nil || isNil(o.Subtransactions) {
		var ret []TestResultSubtransaction
		return ret
	}
	return o.Subtransactions
}

// GetSubtransactionsOk returns a tuple with the Subtransactions field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetSubtransactions gets a reference to the given []TestResultSubtransaction and assigns it to the Subtransactions field.
...
// SetTestResultId gets a reference to the given string and assigns it to the TestResultId field.
...
func (o TestResultDetailData) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.SubtransactionAvgMetrics) {
		toSerialize["subtransactionAvgMetrics"] = o.SubtransactionAvgMetrics
	}
	if !isNil(o.Subtransactions) {
		toSerialize["subtransactions"] = o.Subtransactions
	}
	if !isNil(o.TestId) {
		toSerialize["testId"] = o.TestId
	}
	if !isNil(o.TestResultId) {
...
type NullableTestResultDetailData struct {
	value *TestResultDetailData
	isSet bool
}

func (v NullableTestResultDetailData) Get() *TestResultDetailData {
	return v.value
}

func (v *NullableTestResultDetailData) Set(val *TestResultDetailData) {
	v.value = val
	v.isSet = true
}

func (v NullableTestResultDetailData) IsSet() bool {
	return v.isSet
}

func (v *NullableTestResultDetailData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTestResultDetailData(val *TestResultDetailData) *NullableTestResultDetailData {
	return &NullableTestResultDetailData{value: val, isSet: true}
}

func (v NullableTestResultDetailData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTestResultDetailData) UnmarshalJSON(src []byte) error {
	v.isSet = true
