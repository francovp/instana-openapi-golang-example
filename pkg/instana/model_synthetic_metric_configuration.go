...
// SyntheticMetricConfiguration struct for SyntheticMetricConfiguration
type SyntheticMetricConfiguration struct {
...
func NewSyntheticMetricConfiguration(aggregation string, metric string) *SyntheticMetricConfiguration {
	this := SyntheticMetricConfiguration{}
...
func (o SyntheticMetricConfiguration) MarshalJSON() ([]byte, error) {
...
type NullableSyntheticMetricConfiguration struct {
	value *SyntheticMetricConfiguration
	isSet bool
}

func (v NullableSyntheticMetricConfiguration) Get() *SyntheticMetricConfiguration {
	return v.value
}

func (v *NullableSyntheticMetricConfiguration) Set(val *SyntheticMetricConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableSyntheticMetricConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableSyntheticMetricConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyntheticMetricConfiguration(val *SyntheticMetricConfiguration) *NullableSyntheticMetricConfiguration {
	return &NullableSyntheticMetricConfiguration{value: val, isSet: true}
}

func (v NullableSyntheticMetricConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyntheticMetricConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
