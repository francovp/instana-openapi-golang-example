...
func (o *SliReport) GetErrorBudgetRemaining() int32 {
	if o == nil || isNil(o.ErrorBudgetRemaining) {
		var ret int32
		return ret
	}
...
func (o *SliReport) GetTotalErrorBudget() int32 {
	if o == nil || isNil(o.TotalErrorBudget) {
		var ret int32
		return ret
	}
...
func (o *SliReport) GetViolationDistribution() map[string]int32 {
	if o == nil || isNil(o.ViolationDistribution) {
...
func (o SliReport) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.ErrorBudgetRemaining) {
	...
	if !isNil(o.TotalErrorBudget) {
		toSerialize["totalErrorBudget"] = o.TotalErrorBudget
	}
	if !isNil(o.ViolationDistribution) {
