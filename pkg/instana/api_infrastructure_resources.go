...
func (r ApiGetMonitoringStateRequest) Execute() (*MonitoringState, *http.Response, error) {
...
*/
func (a *InfrastructureResourcesApiService) GetMonitoringState(ctx context.Context) ApiGetMonitoringStateRequest {
	return ApiGetMonitoringStateRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *InfrastructureResourcesApiService) GetMonitoringStateExecute(r ApiGetMonitoringStateRequest) (*MonitoringState, *http.Response, error) {
	var (
...
func (r ApiGetSnapshotRequest) Execute() (*SnapshotItem, *http.Response, error) {
...
*/
func (a *InfrastructureResourcesApiService) GetSnapshot(ctx context.Context, id string) ApiGetSnapshotRequest {
	return ApiGetSnapshotRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return SnapshotItem
func (a *InfrastructureResourcesApiService) GetSnapshotExecute(r ApiGetSnapshotRequest) (*SnapshotItem, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InfrastructureResourcesApiService.GetSnapshot")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetSnapshotsRequest) Execute() (*SnapshotResult, *http.Response, error) {
...
*/
func (a *InfrastructureResourcesApiService) GetSnapshots(ctx context.Context) ApiGetSnapshotsRequest {
	return ApiGetSnapshotsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *InfrastructureResourcesApiService) GetSnapshotsExecute(r ApiGetSnapshotsRequest) (*SnapshotResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InfrastructureResourcesApiService.GetSnapshots")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiSoftwareVersionsRequest) Execute() ([]SoftwareVersion, *http.Response, error) {
...
*/
func (a *InfrastructureResourcesApiService) SoftwareVersions(ctx context.Context) ApiSoftwareVersionsRequest {
	return ApiSoftwareVersionsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *InfrastructureResourcesApiService) SoftwareVersionsExecute(r ApiSoftwareVersionsRequest) ([]SoftwareVersion, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
