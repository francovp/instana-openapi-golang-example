...
// ServiceEventResultAllOf struct for ServiceEventResultAllOf
type ServiceEventResultAllOf struct {
...
func (o ServiceEventResultAllOf) MarshalJSON() ([]byte, error) {
...
type NullableServiceEventResultAllOf struct {
	value *ServiceEventResultAllOf
	isSet bool
}

func (v NullableServiceEventResultAllOf) Get() *ServiceEventResultAllOf {
	return v.value
}

func (v *NullableServiceEventResultAllOf) Set(val *ServiceEventResultAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceEventResultAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceEventResultAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceEventResultAllOf(val *ServiceEventResultAllOf) *NullableServiceEventResultAllOf {
	return &NullableServiceEventResultAllOf{value: val, isSet: true}
}

func (v NullableServiceEventResultAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceEventResultAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
