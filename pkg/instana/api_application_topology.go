...
// ApplicationTopologyApiService ApplicationTopologyApi service
type ApplicationTopologyApiService service

type ApiGetServicesMapRequest struct {
	ctx                      context.Context
	ApiService               *ApplicationTopologyApiService
	windowSize               *int64
	to                       *int64
...
func (r ApiGetServicesMapRequest) WindowSize(windowSize int64) ApiGetServicesMapRequest {
	r.windowSize = &windowSize
	return r
}

// Timestamp since Unix Epoch in milliseconds of the end of the time window
func (r ApiGetServicesMapRequest) To(to int64) ApiGetServicesMapRequest {
	r.to = &to
	return r
}

// Filter by application ID
func (r ApiGetServicesMapRequest) ApplicationId(applicationId string) ApiGetServicesMapRequest {
	r.applicationId = &applicationId
	return r
}

// Filter by application scope, i.e., INBOUND or ALL. The default value is INBOUND. Applies only if application ID filter is specified.
func (r ApiGetServicesMapRequest) ApplicationBoundaryScope(applicationBoundaryScope string) ApiGetServicesMapRequest {
	r.applicationBoundaryScope = &applicationBoundaryScope
	return r
}

func (r ApiGetServicesMapRequest) Execute() (*ServiceMap, *http.Response, error) {
	return r.ApiService.GetServicesMapExecute(r)
}

/*
GetServicesMap Gets the service topology

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetServicesMapRequest
*/
func (a *ApplicationTopologyApiService) GetServicesMap(ctx context.Context) ApiGetServicesMapRequest {
	return ApiGetServicesMapRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return ServiceMap
func (a *ApplicationTopologyApiService) GetServicesMapExecute(r ApiGetServicesMapRequest) (*ServiceMap, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ServiceMap
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationTopologyApiService.GetServicesMap")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/application-monitoring/topology/services"
