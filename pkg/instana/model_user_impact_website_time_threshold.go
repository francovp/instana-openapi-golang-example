...
type UserImpactWebsiteTimeThreshold struct {
	ImpactMeasurementMethod string   `json:"impactMeasurementMethod"`
...
func NewUserImpactWebsiteTimeThreshold(impactMeasurementMethod string, type_ string) *UserImpactWebsiteTimeThreshold {
	this := UserImpactWebsiteTimeThreshold{}
	this.Type = type_
	this.ImpactMeasurementMethod = impactMeasurementMethod
	return &this
}
...
// GetImpactMeasurementMethod returns the ImpactMeasurementMethod field value
func (o *UserImpactWebsiteTimeThreshold) GetImpactMeasurementMethod() string {
	...
	return o.ImpactMeasurementMethod
}

// GetImpactMeasurementMethodOk returns a tuple with the ImpactMeasurementMethod field value
// and a boolean to check if the value has been set.
func (o *UserImpactWebsiteTimeThreshold) GetImpactMeasurementMethodOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ImpactMeasurementMethod, true
}

// SetImpactMeasurementMethod sets field value
func (o *UserImpactWebsiteTimeThreshold) SetImpactMeasurementMethod(v string) {
	o.ImpactMeasurementMethod = v
}
...
func (o *UserImpactWebsiteTimeThreshold) GetUserPercentage() float64 {
	if o == nil || isNil(o.UserPercentage) {
		var ret float64
		return ret
	}
...
func (o UserImpactWebsiteTimeThreshold) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["impactMeasurementMethod"] = o.ImpactMeasurementMethod
	}
	if !isNil(o.UserPercentage) {
