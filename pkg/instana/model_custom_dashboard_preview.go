...
// CustomDashboardPreview struct for CustomDashboardPreview
type CustomDashboardPreview struct {
...
func (o CustomDashboardPreview) MarshalJSON() ([]byte, error) {
...
type NullableCustomDashboardPreview struct {
	value *CustomDashboardPreview
	isSet bool
}

func (v NullableCustomDashboardPreview) Get() *CustomDashboardPreview {
	return v.value
}

func (v *NullableCustomDashboardPreview) Set(val *CustomDashboardPreview) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomDashboardPreview) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomDashboardPreview) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomDashboardPreview(val *CustomDashboardPreview) *NullableCustomDashboardPreview {
	return &NullableCustomDashboardPreview{value: val, isSet: true}
}

func (v NullableCustomDashboardPreview) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomDashboardPreview) UnmarshalJSON(src []byte) error {
	v.isSet = true
