...
// GetApplicationMetrics struct for GetApplicationMetrics
...
func (o GetApplicationMetrics) MarshalJSON() ([]byte, error) {
...
type NullableGetApplicationMetrics struct {
	value *GetApplicationMetrics
	isSet bool
}

func (v NullableGetApplicationMetrics) Get() *GetApplicationMetrics {
	return v.value
}

func (v *NullableGetApplicationMetrics) Set(val *GetApplicationMetrics) {
	v.value = val
	v.isSet = true
}

func (v NullableGetApplicationMetrics) IsSet() bool {
	return v.isSet
}

func (v *NullableGetApplicationMetrics) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetApplicationMetrics(val *GetApplicationMetrics) *NullableGetApplicationMetrics {
	return &NullableGetApplicationMetrics{value: val, isSet: true}
}

func (v NullableGetApplicationMetrics) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetApplicationMetrics) UnmarshalJSON(src []byte) error {
	v.isSet = true
