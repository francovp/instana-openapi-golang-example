...
// MultipleScripts struct for MultipleScripts
type MultipleScripts struct {
...
func (o MultipleScripts) MarshalJSON() ([]byte, error) {
...
type NullableMultipleScripts struct {
	value *MultipleScripts
	isSet bool
}

func (v NullableMultipleScripts) Get() *MultipleScripts {
	return v.value
}

func (v *NullableMultipleScripts) Set(val *MultipleScripts) {
	v.value = val
	v.isSet = true
}

func (v NullableMultipleScripts) IsSet() bool {
	return v.isSet
}

func (v *NullableMultipleScripts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultipleScripts(val *MultipleScripts) *NullableMultipleScripts {
	return &NullableMultipleScripts{value: val, isSet: true}
}

func (v NullableMultipleScripts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultipleScripts) UnmarshalJSON(src []byte) error {
	v.isSet = true
