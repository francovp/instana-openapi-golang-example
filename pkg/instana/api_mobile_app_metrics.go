...
// MobileAppMetricsApiService MobileAppMetricsApi service
type MobileAppMetricsApiService service

type ApiGetMobileAppBeaconMetricsRequest struct {
	ctx                 context.Context
	ApiService          *MobileAppMetricsApiService
	getMobileAppMetrics *GetMobileAppMetrics
}

func (r ApiGetMobileAppBeaconMetricsRequest) GetMobileAppMetrics(getMobileAppMetrics GetMobileAppMetrics) ApiGetMobileAppBeaconMetricsRequest {
	r.getMobileAppMetrics = &getMobileAppMetrics
	return r
}

func (r ApiGetMobileAppBeaconMetricsRequest) Execute() (*MobileAppMetricResult, *http.Response, error) {
	return r.ApiService.GetMobileAppBeaconMetricsExecute(r)
}

/*
GetMobileAppBeaconMetrics Get beacon metrics

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetMobileAppBeaconMetricsRequest

Deprecated
*/
func (a *MobileAppMetricsApiService) GetMobileAppBeaconMetrics(ctx context.Context) ApiGetMobileAppBeaconMetricsRequest {
	return ApiGetMobileAppBeaconMetricsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return MobileAppMetricResult
//
// Deprecated
func (a *MobileAppMetricsApiService) GetMobileAppBeaconMetricsExecute(r ApiGetMobileAppBeaconMetricsRequest) (*MobileAppMetricResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *MobileAppMetricResult
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MobileAppMetricsApiService.GetMobileAppBeaconMetrics")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/mobile-app-monitoring/metrics"
	...
	// body params
	localVarPostBody = r.getMobileAppMetrics
	if r.ctx != nil {
...
type ApiGetMobileAppBeaconMetricsV2Request struct {
	ctx                   context.Context
	ApiService            *MobileAppMetricsApiService
	getMobileAppMetricsV2 *GetMobileAppMetricsV2
}

func (r ApiGetMobileAppBeaconMetricsV2Request) GetMobileAppMetricsV2(getMobileAppMetricsV2 GetMobileAppMetricsV2) ApiGetMobileAppBeaconMetricsV2Request {
	r.getMobileAppMetricsV2 = &getMobileAppMetricsV2
	return r
}

func (r ApiGetMobileAppBeaconMetricsV2Request) Execute() (*MetricAPIResult, *http.Response, error) {
	return r.ApiService.GetMobileAppBeaconMetricsV2Execute(r)
}

/*
GetMobileAppBeaconMetricsV2 Get beacon metrics

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetMobileAppBeaconMetricsV2Request
*/
func (a *MobileAppMetricsApiService) GetMobileAppBeaconMetricsV2(ctx context.Context) ApiGetMobileAppBeaconMetricsV2Request {
	return ApiGetMobileAppBeaconMetricsV2Request{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *MobileAppMetricsApiService) GetMobileAppBeaconMetricsV2Execute(r ApiGetMobileAppBeaconMetricsV2Request) (*MetricAPIResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *MetricAPIResult
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MobileAppMetricsApiService.GetMobileAppBeaconMetricsV2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/mobile-app-monitoring/v2/metrics"
	...
	// body params
	localVarPostBody = r.getMobileAppMetricsV2
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKeyAuth"]; ok {
...
func (r ApiGetSessionRequest) Execute() ([]MobileAppMonitoringBeacon, *http.Response, error) {
...
*/
func (a *MobileAppMetricsApiService) GetSession(ctx context.Context, id string, timestamp int64) ApiGetSessionRequest {
	return ApiGetSessionRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
//
//	@return []MobileAppMonitoringBeacon
func (a *MobileAppMetricsApiService) GetSessionExecute(r ApiGetSessionRequest) ([]MobileAppMonitoringBeacon, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue []MobileAppMonitoringBeacon
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MobileAppMetricsApiService.GetSession")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/mobile-app-monitoring/session"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterToString(r.id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"timestamp"+"}", url.PathEscape(parameterToString(r.timestamp, "")), -1)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		var v []MobileAppMonitoringBeacon
		err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			newErr.error = err.Error()
			return localVarReturnValue, localVarHTTPResponse, newErr
