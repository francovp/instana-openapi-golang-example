...
// AccessLogResponse struct for AccessLogResponse
...
// SetEntries gets a reference to the given []AccessLogEntry and assigns it to the Entries field.
...
func (o AccessLogResponse) MarshalJSON() ([]byte, error) {
...
type NullableAccessLogResponse struct {
	value *AccessLogResponse
	isSet bool
}

func (v NullableAccessLogResponse) Get() *AccessLogResponse {
	return v.value
}

func (v *NullableAccessLogResponse) Set(val *AccessLogResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessLogResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessLogResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessLogResponse(val *AccessLogResponse) *NullableAccessLogResponse {
	return &NullableAccessLogResponse{value: val, isSet: true}
}

func (v NullableAccessLogResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessLogResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
