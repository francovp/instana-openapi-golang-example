...
// ServiceNode struct for ServiceNode
type ServiceNode struct {
	Endpoints map[string]EndpointNode `json:"endpoints"`
...
func (o *ServiceNode) GetEndpoints() map[string]EndpointNode {
	if o == nil {
		var ret map[string]EndpointNode
		return ret
	}
...
func (o ServiceNode) MarshalJSON() ([]byte, error) {
...
type NullableServiceNode struct {
	value *ServiceNode
	isSet bool
}

func (v NullableServiceNode) Get() *ServiceNode {
	return v.value
}

func (v *NullableServiceNode) Set(val *ServiceNode) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceNode) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceNode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceNode(val *ServiceNode) *NullableServiceNode {
	return &NullableServiceNode{value: val, isSet: true}
}

func (v NullableServiceNode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceNode) UnmarshalJSON(src []byte) error {
	v.isSet = true
