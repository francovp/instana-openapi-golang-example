...
// LogsApplicationAlertRule struct for LogsApplicationAlertRule
type LogsApplicationAlertRule struct {
...
func NewLogsApplicationAlertRule(level string, operator string, alertType string, metricName string) *LogsApplicationAlertRule {
	this := LogsApplicationAlertRule{}
...
func (o LogsApplicationAlertRule) MarshalJSON() ([]byte, error) {
...
type NullableLogsApplicationAlertRule struct {
	value *LogsApplicationAlertRule
	isSet bool
}

func (v NullableLogsApplicationAlertRule) Get() *LogsApplicationAlertRule {
	return v.value
}

func (v *NullableLogsApplicationAlertRule) Set(val *LogsApplicationAlertRule) {
	v.value = val
	v.isSet = true
}

func (v NullableLogsApplicationAlertRule) IsSet() bool {
	return v.isSet
}

func (v *NullableLogsApplicationAlertRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLogsApplicationAlertRule(val *LogsApplicationAlertRule) *NullableLogsApplicationAlertRule {
	return &NullableLogsApplicationAlertRule{value: val, isSet: true}
}

func (v NullableLogsApplicationAlertRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLogsApplicationAlertRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
