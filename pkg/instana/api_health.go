...
func (r ApiGetHealthStateRequest) Execute() (*HealthState, *http.Response, error) {
...
*/
func (a *HealthApiService) GetHealthState(ctx context.Context) ApiGetHealthStateRequest {
	return ApiGetHealthStateRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return HealthState
func (a *HealthApiService) GetHealthStateExecute(r ApiGetHealthStateRequest) (*HealthState, *http.Response, error) {
	var (
...
func (r ApiGetVersionRequest) Execute() (*InstanaVersionInfo, *http.Response, error) {
...
func (a *HealthApiService) GetVersionExecute(r ApiGetVersionRequest) (*InstanaVersionInfo, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
