...
// AdaptiveBaseline struct for AdaptiveBaseline
...
func NewAdaptiveBaseline(operator string, type_ string) *AdaptiveBaseline {
...
func (o AdaptiveBaseline) MarshalJSON() ([]byte, error) {
...
type NullableAdaptiveBaseline struct {
	value *AdaptiveBaseline
	isSet bool
}

func (v NullableAdaptiveBaseline) Get() *AdaptiveBaseline {
	return v.value
}

func (v *NullableAdaptiveBaseline) Set(val *AdaptiveBaseline) {
	v.value = val
	v.isSet = true
}

func (v NullableAdaptiveBaseline) IsSet() bool {
	return v.isSet
}

func (v *NullableAdaptiveBaseline) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdaptiveBaseline(val *AdaptiveBaseline) *NullableAdaptiveBaseline {
	return &NullableAdaptiveBaseline{value: val, isSet: true}
}

func (v NullableAdaptiveBaseline) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdaptiveBaseline) UnmarshalJSON(src []byte) error {
	v.isSet = true
