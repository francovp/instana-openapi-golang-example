...
// ManualServiceConfig struct for ManualServiceConfig
type ManualServiceConfig struct {
...
func (o ManualServiceConfig) MarshalJSON() ([]byte, error) {
...
type NullableManualServiceConfig struct {
	value *ManualServiceConfig
	isSet bool
}

func (v NullableManualServiceConfig) Get() *ManualServiceConfig {
	return v.value
}

func (v *NullableManualServiceConfig) Set(val *ManualServiceConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableManualServiceConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableManualServiceConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManualServiceConfig(val *ManualServiceConfig) *NullableManualServiceConfig {
	return &NullableManualServiceConfig{value: val, isSet: true}
}

func (v NullableManualServiceConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManualServiceConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
