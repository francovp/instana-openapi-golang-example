...
// LogsApplicationAlertRuleAllOf struct for LogsApplicationAlertRuleAllOf
type LogsApplicationAlertRuleAllOf struct {
...
func NewLogsApplicationAlertRuleAllOf() *LogsApplicationAlertRuleAllOf {
	this := LogsApplicationAlertRuleAllOf{}
	return &this
}
...
func (o LogsApplicationAlertRuleAllOf) MarshalJSON() ([]byte, error) {
...
type NullableLogsApplicationAlertRuleAllOf struct {
	value *LogsApplicationAlertRuleAllOf
	isSet bool
}

func (v NullableLogsApplicationAlertRuleAllOf) Get() *LogsApplicationAlertRuleAllOf {
	return v.value
}

func (v *NullableLogsApplicationAlertRuleAllOf) Set(val *LogsApplicationAlertRuleAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableLogsApplicationAlertRuleAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableLogsApplicationAlertRuleAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLogsApplicationAlertRuleAllOf(val *LogsApplicationAlertRuleAllOf) *NullableLogsApplicationAlertRuleAllOf {
	return &NullableLogsApplicationAlertRuleAllOf{value: val, isSet: true}
}

func (v NullableLogsApplicationAlertRuleAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLogsApplicationAlertRuleAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
