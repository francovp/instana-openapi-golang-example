...
func (r ApiGetAllUsageRequest) Execute() ([]UsageResult, *http.Response, error) {
...
*/
func (a *UsageApiService) GetAllUsage(ctx context.Context) ApiGetAllUsageRequest {
	return ApiGetAllUsageRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return []UsageResult
func (a *UsageApiService) GetAllUsageExecute(r ApiGetAllUsageRequest) ([]UsageResult, *http.Response, error) {
	var (
...
func (r ApiGetHostsPerDayRequest) Execute() ([]UsageResult, *http.Response, error) {
...
*/
func (a *UsageApiService) GetHostsPerDay(ctx context.Context, day int32, month int32, year int32) ApiGetHostsPerDayRequest {
	return ApiGetHostsPerDayRequest{
		ApiService: a,
		ctx:        ctx,
		day:        day,
...
//
//	@return []UsageResult
func (a *UsageApiService) GetHostsPerDayExecute(r ApiGetHostsPerDayRequest) ([]UsageResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localVarPath = strings.Replace(localVarPath, "{"+"day"+"}", url.PathEscape(parameterToString(r.day, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"month"+"}", url.PathEscape(parameterToString(r.month, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"year"+"}", url.PathEscape(parameterToString(r.year, "")), -1)
...
func (r ApiGetHostsPerMonthRequest) Execute() ([]UsageResult, *http.Response, error) {
...
*/
func (a *UsageApiService) GetHostsPerMonth(ctx context.Context, month int32, year int32) ApiGetHostsPerMonthRequest {
	return ApiGetHostsPerMonthRequest{
		ApiService: a,
		ctx:        ctx,
		month:      month,
...
//
//	@return []UsageResult
func (a *UsageApiService) GetHostsPerMonthExecute(r ApiGetHostsPerMonthRequest) ([]UsageResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetUsagePerDayRequest) Execute() ([]UsageResult, *http.Response, error) {
...
*/
func (a *UsageApiService) GetUsagePerDay(ctx context.Context, day int32, month int32, year int32) ApiGetUsagePerDayRequest {
	return ApiGetUsagePerDayRequest{
		ApiService: a,
		ctx:        ctx,
		day:        day,
...
//
//	@return []UsageResult
func (a *UsageApiService) GetUsagePerDayExecute(r ApiGetUsagePerDayRequest) ([]UsageResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetUsagePerMonthRequest) Execute() ([]UsageResult, *http.Response, error) {
...
*/
func (a *UsageApiService) GetUsagePerMonth(ctx context.Context, month int32, year int32) ApiGetUsagePerMonthRequest {
	return ApiGetUsagePerMonthRequest{
		ApiService: a,
		ctx:        ctx,
		month:      month,
...
//
//	@return []UsageResult
func (a *UsageApiService) GetUsagePerMonthExecute(r ApiGetUsagePerMonthRequest) ([]UsageResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
