...
// ServiceEventResult struct for ServiceEventResult
...
func (o ServiceEventResult) MarshalJSON() ([]byte, error) {
...
type NullableServiceEventResult struct {
	value *ServiceEventResult
	isSet bool
}

func (v NullableServiceEventResult) Get() *ServiceEventResult {
	return v.value
}

func (v *NullableServiceEventResult) Set(val *ServiceEventResult) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceEventResult) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceEventResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceEventResult(val *ServiceEventResult) *NullableServiceEventResult {
	return &NullableServiceEventResult{value: val, isSet: true}
}

func (v NullableServiceEventResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceEventResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
