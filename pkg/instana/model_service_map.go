...
// ServiceMap struct for ServiceMap
type ServiceMap struct {
	Connections []ServiceMapConnection `json:"connections"`
...
func (o ServiceMap) MarshalJSON() ([]byte, error) {
...
type NullableServiceMap struct {
	value *ServiceMap
	isSet bool
}

func (v NullableServiceMap) Get() *ServiceMap {
	return v.value
}

func (v *NullableServiceMap) Set(val *ServiceMap) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceMap) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceMap) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceMap(val *ServiceMap) *NullableServiceMap {
	return &NullableServiceMap{value: val, isSet: true}
}

func (v NullableServiceMap) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceMap) UnmarshalJSON(src []byte) error {
	v.isSet = true
