...
// WebsiteEventResultAllOf struct for WebsiteEventResultAllOf
type WebsiteEventResultAllOf struct {
...
func (o WebsiteEventResultAllOf) MarshalJSON() ([]byte, error) {
...
type NullableWebsiteEventResultAllOf struct {
	value *WebsiteEventResultAllOf
	isSet bool
}

func (v NullableWebsiteEventResultAllOf) Get() *WebsiteEventResultAllOf {
	return v.value
}

func (v *NullableWebsiteEventResultAllOf) Set(val *WebsiteEventResultAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableWebsiteEventResultAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableWebsiteEventResultAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebsiteEventResultAllOf(val *WebsiteEventResultAllOf) *NullableWebsiteEventResultAllOf {
	return &NullableWebsiteEventResultAllOf{value: val, isSet: true}
}

func (v NullableWebsiteEventResultAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebsiteEventResultAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
