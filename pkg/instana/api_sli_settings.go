...
type ApiCreateSliConfigRequest struct {
	ctx              context.Context
	ApiService       *SLISettingsApiService
	sliConfiguration *SliConfiguration
}

func (r ApiCreateSliConfigRequest) SliConfiguration(sliConfiguration SliConfiguration) ApiCreateSliConfigRequest {
	r.sliConfiguration = &sliConfiguration
	return r
}

func (r ApiCreateSliConfigRequest) Execute() (*SliConfigurationWithLastUpdated, *http.Response, error) {
	return r.ApiService.CreateSliConfigExecute(r)
}

/*
CreateSliConfig Create SLI Config
...
These parameters will be removed in the upcoming releases.
	...
	@return ApiCreateSliConfigRequest

Deprecated
*/
func (a *SLISettingsApiService) CreateSliConfig(ctx context.Context) ApiCreateSliConfigRequest {
	return ApiCreateSliConfigRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
// Deprecated
func (a *SLISettingsApiService) CreateSliConfigExecute(r ApiCreateSliConfigRequest) (*SliConfigurationWithLastUpdated, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SLISettingsApiService.CreateSliConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/settings/sli"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.sliConfiguration == nil {
		return localVarReturnValue, nil, reportError("sliConfiguration is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.sliConfiguration
	if r.ctx != nil {
...
type ApiCreateSliConfigV2Request struct {
	ctx              context.Context
	ApiService       *SLISettingsApiService
	sliConfiguration *SliConfiguration
}

func (r ApiCreateSliConfigV2Request) SliConfiguration(sliConfiguration SliConfiguration) ApiCreateSliConfigV2Request {
	r.sliConfiguration = &sliConfiguration
	return r
}

func (r ApiCreateSliConfigV2Request) Execute() (*SliConfigurationWithLastUpdated, *http.Response, error) {
	return r.ApiService.CreateSliConfigV2Execute(r)
}

/*
CreateSliConfigV2 Create SLI Config
...
These parameters will be removed in the upcoming releases.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiCreateSliConfigV2Request
*/
func (a *SLISettingsApiService) CreateSliConfigV2(ctx context.Context) ApiCreateSliConfigV2Request {
	return ApiCreateSliConfigV2Request{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return SliConfigurationWithLastUpdated
func (a *SLISettingsApiService) CreateSliConfigV2Execute(r ApiCreateSliConfigV2Request) (*SliConfigurationWithLastUpdated, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SLISettingsApiService.CreateSliConfigV2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/settings/v2/sli"
...
type ApiDeleteSliConfigRequest struct {
	ctx        context.Context
	ApiService *SLISettingsApiService
	id         string
}

func (r ApiDeleteSliConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteSliConfigExecute(r)
}

/*
DeleteSliConfig Delete SLI Config

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiDeleteSliConfigRequest

Deprecated
*/
func (a *SLISettingsApiService) DeleteSliConfig(ctx context.Context, id string) ApiDeleteSliConfigRequest {
	return ApiDeleteSliConfigRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
// Deprecated
func (a *SLISettingsApiService) DeleteSliConfigExecute(r ApiDeleteSliConfigRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SLISettingsApiService.DeleteSliConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/settings/sli/{id}"
...
type ApiDeleteSliConfigV2Request struct {
	ctx        context.Context
	ApiService *SLISettingsApiService
	id         string
}

func (r ApiDeleteSliConfigV2Request) Execute() (*http.Response, error) {
	return r.ApiService.DeleteSliConfigV2Execute(r)
}

/*
DeleteSliConfigV2 Delete SLI Config

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiDeleteSliConfigV2Request
*/
func (a *SLISettingsApiService) DeleteSliConfigV2(ctx context.Context, id string) ApiDeleteSliConfigV2Request {
	return ApiDeleteSliConfigV2Request{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *SLISettingsApiService) DeleteSliConfigV2Execute(r ApiDeleteSliConfigV2Request) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SLISettingsApiService.DeleteSliConfigV2")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/settings/v2/sli/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterToString(r.id, "")), -1)
...
type ApiGetAllSliConfigsRequest struct {
	ctx        context.Context
	ApiService *SLISettingsApiService
}

func (r ApiGetAllSliConfigsRequest) Execute() ([]SliConfigurationWithLastUpdated, *http.Response, error) {
	return r.ApiService.GetAllSliConfigsExecute(r)
}

/*
GetAllSliConfigs Get All SLI Configs

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetAllSliConfigsRequest

Deprecated
*/
func (a *SLISettingsApiService) GetAllSliConfigs(ctx context.Context) ApiGetAllSliConfigsRequest {
	return ApiGetAllSliConfigsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
// Deprecated
func (a *SLISettingsApiService) GetAllSliConfigsExecute(r ApiGetAllSliConfigsRequest) ([]SliConfigurationWithLastUpdated, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SLISettingsApiService.GetAllSliConfigs")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetAllSliConfigsV2Request struct {
	ctx        context.Context
	ApiService *SLISettingsApiService
}

func (r ApiGetAllSliConfigsV2Request) Execute() ([]SliConfigurationWithLastUpdated, *http.Response, error) {
	return r.ApiService.GetAllSliConfigsV2Execute(r)
}

/*
GetAllSliConfigsV2 Get All SLI Configs

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetAllSliConfigsV2Request
*/
func (a *SLISettingsApiService) GetAllSliConfigsV2(ctx context.Context) ApiGetAllSliConfigsV2Request {
	return ApiGetAllSliConfigsV2Request{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return []SliConfigurationWithLastUpdated
func (a *SLISettingsApiService) GetAllSliConfigsV2Execute(r ApiGetAllSliConfigsV2Request) ([]SliConfigurationWithLastUpdated, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SLISettingsApiService.GetAllSliConfigsV2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetSliConfigRequest struct {
	ctx        context.Context
	ApiService *SLISettingsApiService
	id         string
}

func (r ApiGetSliConfigRequest) Execute() (*SliConfigurationWithLastUpdated, *http.Response, error) {
	return r.ApiService.GetSliConfigExecute(r)
}

/*
GetSliConfig Get SLI Config

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiGetSliConfigRequest

Deprecated
*/
func (a *SLISettingsApiService) GetSliConfig(ctx context.Context, id string) ApiGetSliConfigRequest {
	return ApiGetSliConfigRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
// Deprecated
func (a *SLISettingsApiService) GetSliConfigExecute(r ApiGetSliConfigRequest) (*SliConfigurationWithLastUpdated, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SLISettingsApiService.GetSliConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetSliConfigV2Request struct {
	ctx        context.Context
	ApiService *SLISettingsApiService
	id         string
}

func (r ApiGetSliConfigV2Request) Execute() (*SliConfigurationWithLastUpdated, *http.Response, error) {
	return r.ApiService.GetSliConfigV2Execute(r)
}

/*
GetSliConfigV2 Get SLI Config

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiGetSliConfigV2Request
*/
func (a *SLISettingsApiService) GetSliConfigV2(ctx context.Context, id string) ApiGetSliConfigV2Request {
	return ApiGetSliConfigV2Request{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return SliConfigurationWithLastUpdated
func (a *SLISettingsApiService) GetSliConfigV2Execute(r ApiGetSliConfigV2Request) (*SliConfigurationWithLastUpdated, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SLISettingsApiService.GetSliConfigV2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateSliConfigRequest struct {
	ctx              context.Context
	ApiService       *SLISettingsApiService
	id               string
	sliConfiguration *SliConfiguration
...
func (r ApiUpdateSliConfigRequest) SliConfiguration(sliConfiguration SliConfiguration) ApiUpdateSliConfigRequest {
	r.sliConfiguration = &sliConfiguration
	return r
}

func (r ApiUpdateSliConfigRequest) Execute() (*SliConfigurationWithLastUpdated, *http.Response, error) {
	return r.ApiService.UpdateSliConfigExecute(r)
}

/*
UpdateSliConfig Update SLI Config

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiUpdateSliConfigRequest

Deprecated
*/
func (a *SLISettingsApiService) UpdateSliConfig(ctx context.Context, id string) ApiUpdateSliConfigRequest {
	return ApiUpdateSliConfigRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
// Deprecated
func (a *SLISettingsApiService) UpdateSliConfigExecute(r ApiUpdateSliConfigRequest) (*SliConfigurationWithLastUpdated, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SLISettingsApiService.UpdateSliConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
