...
// TagFilterAllOf struct for TagFilterAllOf
type TagFilterAllOf struct {
...
func (o *TagFilterAllOf) GetName() string {
...
// SetNumberValue gets a reference to the given int64 and assigns it to the NumberValue field.
...
func (o TagFilterAllOf) MarshalJSON() ([]byte, error) {
...
type NullableTagFilterAllOf struct {
	value *TagFilterAllOf
	isSet bool
}

func (v NullableTagFilterAllOf) Get() *TagFilterAllOf {
	return v.value
}

func (v *NullableTagFilterAllOf) Set(val *TagFilterAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableTagFilterAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableTagFilterAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagFilterAllOf(val *TagFilterAllOf) *NullableTagFilterAllOf {
	return &NullableTagFilterAllOf{value: val, isSet: true}
}

func (v NullableTagFilterAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagFilterAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
