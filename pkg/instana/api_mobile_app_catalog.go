...
// MobileAppCatalogApiService MobileAppCatalogApi service
type MobileAppCatalogApiService service

type ApiGetMobileAppMetricCatalogRequest struct {
	ctx        context.Context
	ApiService *MobileAppCatalogApiService
}

func (r ApiGetMobileAppMetricCatalogRequest) Execute() ([]MobileAppMonitoringMetricDescription, *http.Response, error) {
	return r.ApiService.GetMobileAppMetricCatalogExecute(r)
}

/*
GetMobileAppMetricCatalog Metric catalog

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetMobileAppMetricCatalogRequest
*/
func (a *MobileAppCatalogApiService) GetMobileAppMetricCatalog(ctx context.Context) ApiGetMobileAppMetricCatalogRequest {
	return ApiGetMobileAppMetricCatalogRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *MobileAppCatalogApiService) GetMobileAppMetricCatalogExecute(r ApiGetMobileAppMetricCatalogRequest) ([]MobileAppMonitoringMetricDescription, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue []MobileAppMonitoringMetricDescription
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MobileAppCatalogApiService.GetMobileAppMetricCatalog")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/mobile-app-monitoring/catalog/metrics"
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		var v []MobileAppMonitoringMetricDescription
...
type ApiGetMobileAppTagCatalogRequest struct {
	ctx        context.Context
	ApiService *MobileAppCatalogApiService
	beaconType *string
	useCase    *string
...
func (r ApiGetMobileAppTagCatalogRequest) BeaconType(beaconType string) ApiGetMobileAppTagCatalogRequest {
	r.beaconType = &beaconType
	return r
}

func (r ApiGetMobileAppTagCatalogRequest) UseCase(useCase string) ApiGetMobileAppTagCatalogRequest {
	r.useCase = &useCase
	return r
}

func (r ApiGetMobileAppTagCatalogRequest) Execute() (*TagCatalog, *http.Response, error) {
	return r.ApiService.GetMobileAppTagCatalogExecute(r)
}

/*
GetMobileAppTagCatalog Get mobile app tag catalog

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetMobileAppTagCatalogRequest
*/
func (a *MobileAppCatalogApiService) GetMobileAppTagCatalog(ctx context.Context) ApiGetMobileAppTagCatalogRequest {
	return ApiGetMobileAppTagCatalogRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return TagCatalog
func (a *MobileAppCatalogApiService) GetMobileAppTagCatalogExecute(r ApiGetMobileAppTagCatalogRequest) (*TagCatalog, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MobileAppCatalogApiService.GetMobileAppTagCatalog")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/mobile-app-monitoring/catalog"
