...
// GeoLocationConfiguration struct for GeoLocationConfiguration
type GeoLocationConfiguration struct {
	GeoDetailRemoval string           `json:"geoDetailRemoval"`
	GeoMappingRules  []GeoMappingRule `json:"geoMappingRules,omitempty"`
}
...
func NewGeoLocationConfiguration(geoDetailRemoval string) *GeoLocationConfiguration {
	this := GeoLocationConfiguration{}
	this.GeoDetailRemoval = geoDetailRemoval
	return &this
}
...
// GetGeoDetailRemoval returns the GeoDetailRemoval field value
func (o *GeoLocationConfiguration) GetGeoDetailRemoval() string {
	...
	return o.GeoDetailRemoval
}

// GetGeoDetailRemovalOk returns a tuple with the GeoDetailRemoval field value
// and a boolean to check if the value has been set.
func (o *GeoLocationConfiguration) GetGeoDetailRemovalOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.GeoDetailRemoval, true
}

// SetGeoDetailRemoval sets field value
func (o *GeoLocationConfiguration) SetGeoDetailRemoval(v string) {
	o.GeoDetailRemoval = v
}

// GetGeoMappingRules returns the GeoMappingRules field value if set, zero value otherwise.
func (o *GeoLocationConfiguration) GetGeoMappingRules() []GeoMappingRule {
	if o == nil || isNil(o.GeoMappingRules) {
		var ret []GeoMappingRule
		return ret
	}
	return o.GeoMappingRules
}

// GetGeoMappingRulesOk returns a tuple with the GeoMappingRules field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GeoLocationConfiguration) GetGeoMappingRulesOk() ([]GeoMappingRule, bool) {
	if o == nil || isNil(o.GeoMappingRules) {
		return nil, false
	}
	return o.GeoMappingRules, true
}
...
// SetGeoMappingRules gets a reference to the given []GeoMappingRule and assigns it to the GeoMappingRules field.
func (o *GeoLocationConfiguration) SetGeoMappingRules(v []GeoMappingRule) {
	o.GeoMappingRules = v
}

func (o GeoLocationConfiguration) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["geoDetailRemoval"] = o.GeoDetailRemoval
	}
	if !isNil(o.GeoMappingRules) {
		toSerialize["geoMappingRules"] = o.GeoMappingRules
	}
	return json.Marshal(toSerialize)
}

type NullableGeoLocationConfiguration struct {
	value *GeoLocationConfiguration
	isSet bool
}

func (v NullableGeoLocationConfiguration) Get() *GeoLocationConfiguration {
	return v.value
}

func (v *NullableGeoLocationConfiguration) Set(val *GeoLocationConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableGeoLocationConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableGeoLocationConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGeoLocationConfiguration(val *GeoLocationConfiguration) *NullableGeoLocationConfiguration {
	return &NullableGeoLocationConfiguration{value: val, isSet: true}
}

func (v NullableGeoLocationConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGeoLocationConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
