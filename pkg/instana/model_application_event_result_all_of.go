...
// ApplicationEventResultAllOf struct for ApplicationEventResultAllOf
type ApplicationEventResultAllOf struct {
...
func NewApplicationEventResultAllOf() *ApplicationEventResultAllOf {
	this := ApplicationEventResultAllOf{}
	return &this
}
...
func (o ApplicationEventResultAllOf) MarshalJSON() ([]byte, error) {
...
type NullableApplicationEventResultAllOf struct {
	value *ApplicationEventResultAllOf
	isSet bool
}

func (v NullableApplicationEventResultAllOf) Get() *ApplicationEventResultAllOf {
	return v.value
}

func (v *NullableApplicationEventResultAllOf) Set(val *ApplicationEventResultAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationEventResultAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationEventResultAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationEventResultAllOf(val *ApplicationEventResultAllOf) *NullableApplicationEventResultAllOf {
	return &NullableApplicationEventResultAllOf{value: val, isSet: true}
}

func (v NullableApplicationEventResultAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationEventResultAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
