...
func (r ApiAddCustomDashboardRequest) Execute() (*CustomDashboard, *http.Response, error) {
...
*/
func (a *CustomDashboardsApiService) AddCustomDashboard(ctx context.Context) ApiAddCustomDashboardRequest {
	return ApiAddCustomDashboardRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *CustomDashboardsApiService) AddCustomDashboardExecute(r ApiAddCustomDashboardRequest) (*CustomDashboard, *http.Response, error) {
	var (
...
func (r ApiDeleteCustomDashboardRequest) Execute() (*http.Response, error) {
...
*/
func (a *CustomDashboardsApiService) DeleteCustomDashboard(ctx context.Context, customDashboardId string) ApiDeleteCustomDashboardRequest {
	return ApiDeleteCustomDashboardRequest{
		ApiService:        a,
		ctx:               ctx,
...
// Execute executes the request
func (a *CustomDashboardsApiService) DeleteCustomDashboardExecute(r ApiDeleteCustomDashboardRequest) (*http.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"customDashboardId"+"}", url.PathEscape(parameterToString(r.customDashboardId, "")), -1)
...
func (r ApiGetCustomDashboardRequest) Execute() (*CustomDashboard, *http.Response, error) {
...
*/
func (a *CustomDashboardsApiService) GetCustomDashboard(ctx context.Context, customDashboardId string) ApiGetCustomDashboardRequest {
	return ApiGetCustomDashboardRequest{
		ApiService:        a,
		ctx:               ctx,
		customDashboardId: customDashboardId,
...
//
//	@return CustomDashboard
func (a *CustomDashboardsApiService) GetCustomDashboardExecute(r ApiGetCustomDashboardRequest) (*CustomDashboard, *http.Response, error) {
	var (
...
func (r ApiGetCustomDashboardsRequest) Query(query string) ApiGetCustomDashboardsRequest {
	r.query = &query
	return r
}

func (r ApiGetCustomDashboardsRequest) PageSize(pageSize int32) ApiGetCustomDashboardsRequest {
	r.pageSize = &pageSize
	return r
}

func (r ApiGetCustomDashboardsRequest) Page(page int32) ApiGetCustomDashboardsRequest {
	r.page = &page
	return r
}

func (r ApiGetCustomDashboardsRequest) Execute() ([]CustomDashboardPreview, *http.Response, error) {
...
*/
func (a *CustomDashboardsApiService) GetCustomDashboards(ctx context.Context) ApiGetCustomDashboardsRequest {
	return ApiGetCustomDashboardsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *CustomDashboardsApiService) GetCustomDashboardsExecute(r ApiGetCustomDashboardsRequest) ([]CustomDashboardPreview, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetShareableApiTokensRequest) Execute() ([]ApiToken, *http.Response, error) {
...
*/
func (a *CustomDashboardsApiService) GetShareableApiTokens(ctx context.Context) ApiGetShareableApiTokensRequest {
	return ApiGetShareableApiTokensRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return []ApiToken
func (a *CustomDashboardsApiService) GetShareableApiTokensExecute(r ApiGetShareableApiTokensRequest) ([]ApiToken, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetShareableUsersRequest) Execute() ([]UserResult, *http.Response, error) {
...
*/
func (a *CustomDashboardsApiService) GetShareableUsers(ctx context.Context) ApiGetShareableUsersRequest {
	return ApiGetShareableUsersRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return []UserResult
func (a *CustomDashboardsApiService) GetShareableUsersExecute(r ApiGetShareableUsersRequest) ([]UserResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiUpdateCustomDashboardRequest) Execute() (*CustomDashboard, *http.Response, error) {
...
*/
func (a *CustomDashboardsApiService) UpdateCustomDashboard(ctx context.Context, customDashboardId string) ApiUpdateCustomDashboardRequest {
	return ApiUpdateCustomDashboardRequest{
		ApiService:        a,
		ctx:               ctx,
		customDashboardId: customDashboardId,
...
//
//	@return CustomDashboard
func (a *CustomDashboardsApiService) UpdateCustomDashboardExecute(r ApiUpdateCustomDashboardRequest) (*CustomDashboard, *http.Response, error) {
	var (
