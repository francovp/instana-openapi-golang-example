...
// MobileAppMetricResult struct for MobileAppMetricResult
type MobileAppMetricResult struct {
...
func (o MobileAppMetricResult) MarshalJSON() ([]byte, error) {
...
type NullableMobileAppMetricResult struct {
	value *MobileAppMetricResult
	isSet bool
}

func (v NullableMobileAppMetricResult) Get() *MobileAppMetricResult {
	return v.value
}

func (v *NullableMobileAppMetricResult) Set(val *MobileAppMetricResult) {
	v.value = val
	v.isSet = true
}

func (v NullableMobileAppMetricResult) IsSet() bool {
	return v.isSet
}

func (v *NullableMobileAppMetricResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMobileAppMetricResult(val *MobileAppMetricResult) *NullableMobileAppMetricResult {
	return &NullableMobileAppMetricResult{value: val, isSet: true}
}

func (v NullableMobileAppMetricResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMobileAppMetricResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
