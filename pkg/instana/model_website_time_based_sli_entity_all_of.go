...
// WebsiteTimeBasedSliEntityAllOf struct for WebsiteTimeBasedSliEntityAllOf
type WebsiteTimeBasedSliEntityAllOf struct {
	BeaconType       *string                     `json:"beaconType,omitempty"`
	FilterExpression *TagFilterExpressionElement `json:"filterExpression,omitempty"`
...
func NewWebsiteTimeBasedSliEntityAllOf() *WebsiteTimeBasedSliEntityAllOf {
	this := WebsiteTimeBasedSliEntityAllOf{}
	return &this
}
...
// GetBeaconType returns the BeaconType field value if set, zero value otherwise.
func (o *WebsiteTimeBasedSliEntityAllOf) GetBeaconType() string {
	if o == nil || isNil(o.BeaconType) {
		var ret string
		return ret
	}
	return *o.BeaconType
...
// GetBeaconTypeOk returns a tuple with the BeaconType field value if set, nil otherwise
...
// SetBeaconType gets a reference to the given string and assigns it to the BeaconType field.
...
// SetFilterExpression gets a reference to the given TagFilterExpressionElement and assigns it to the FilterExpression field.
...
func (o WebsiteTimeBasedSliEntityAllOf) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.BeaconType) {
...
type NullableWebsiteTimeBasedSliEntityAllOf struct {
	value *WebsiteTimeBasedSliEntityAllOf
	isSet bool
}

func (v NullableWebsiteTimeBasedSliEntityAllOf) Get() *WebsiteTimeBasedSliEntityAllOf {
	return v.value
}

func (v *NullableWebsiteTimeBasedSliEntityAllOf) Set(val *WebsiteTimeBasedSliEntityAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableWebsiteTimeBasedSliEntityAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableWebsiteTimeBasedSliEntityAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebsiteTimeBasedSliEntityAllOf(val *WebsiteTimeBasedSliEntityAllOf) *NullableWebsiteTimeBasedSliEntityAllOf {
	return &NullableWebsiteTimeBasedSliEntityAllOf{value: val, isSet: true}
}

func (v NullableWebsiteTimeBasedSliEntityAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebsiteTimeBasedSliEntityAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
