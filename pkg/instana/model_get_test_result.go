...
// GetTestResult struct for GetTestResult
type GetTestResult struct {
	ApplicationId       *string                        `json:"applicationId,omitempty"`
	LocationId          []string                       `json:"locationId,omitempty"`
	Metrics             []SyntheticMetricConfiguration `json:"metrics"`
	Order               *Order                         `json:"order,omitempty"`
	Pagination          *Pagination                    `json:"pagination,omitempty"`
	ServiceId           *string                        `json:"serviceId,omitempty"`
	TagFilterExpression *TagFilterExpression           `json:"tagFilterExpression,omitempty"`
...
func (o *GetTestResult) GetMetrics() []SyntheticMetricConfiguration {
	if o == nil {
		var ret []SyntheticMetricConfiguration
		return ret
	}
...
// SetTagFilterExpression gets a reference to the given TagFilterExpression and assigns it to the TagFilterExpression field.
...
func (o GetTestResult) MarshalJSON() ([]byte, error) {
...
type NullableGetTestResult struct {
	value *GetTestResult
	isSet bool
}

func (v NullableGetTestResult) Get() *GetTestResult {
	return v.value
}

func (v *NullableGetTestResult) Set(val *GetTestResult) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTestResult) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTestResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTestResult(val *GetTestResult) *NullableGetTestResult {
	return &NullableGetTestResult{value: val, isSet: true}
}

func (v NullableGetTestResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTestResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
