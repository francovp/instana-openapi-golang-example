...
type EventFilteringConfiguration struct {
	ApplicationAlertConfigIds []string `json:"applicationAlertConfigIds,omitempty"`
...
// GetApplicationAlertConfigIds returns the ApplicationAlertConfigIds field value if set, zero value otherwise.
func (o *EventFilteringConfiguration) GetApplicationAlertConfigIds() []string {
	if o == nil || isNil(o.ApplicationAlertConfigIds) {
		var ret []string
		return ret
	}
	return o.ApplicationAlertConfigIds
}

// GetApplicationAlertConfigIdsOk returns a tuple with the ApplicationAlertConfigIds field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EventFilteringConfiguration) GetApplicationAlertConfigIdsOk() ([]string, bool) {
	if o == nil || isNil(o.ApplicationAlertConfigIds) {
		return nil, false
	}
	return o.ApplicationAlertConfigIds, true
}
...
// SetApplicationAlertConfigIds gets a reference to the given []string and assigns it to the ApplicationAlertConfigIds field.
func (o *EventFilteringConfiguration) SetApplicationAlertConfigIds(v []string) {
	o.ApplicationAlertConfigIds = v
}
...
func (o EventFilteringConfiguration) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.ApplicationAlertConfigIds) {
		toSerialize["applicationAlertConfigIds"] = o.ApplicationAlertConfigIds
	}
