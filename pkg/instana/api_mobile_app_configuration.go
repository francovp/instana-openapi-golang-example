...
// MobileAppConfigurationApiService MobileAppConfigurationApi service
type MobileAppConfigurationApiService service

type ApiDeleteMobileAppConfigRequest struct {
	ctx         context.Context
	ApiService  *MobileAppConfigurationApiService
	mobileAppId string
}

func (r ApiDeleteMobileAppConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteMobileAppConfigExecute(r)
}

/*
DeleteMobileAppConfig Remove mobile app

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param mobileAppId
	@return ApiDeleteMobileAppConfigRequest
*/
func (a *MobileAppConfigurationApiService) DeleteMobileAppConfig(ctx context.Context, mobileAppId string) ApiDeleteMobileAppConfigRequest {
	return ApiDeleteMobileAppConfigRequest{
		ApiService:  a,
		ctx:         ctx,
...
func (a *MobileAppConfigurationApiService) DeleteMobileAppConfigExecute(r ApiDeleteMobileAppConfigRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MobileAppConfigurationApiService.DeleteMobileAppConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/mobile-app-monitoring/config/{mobileAppId}"
...
type ApiGetMobileAppConfigRequest struct {
	ctx        context.Context
	ApiService *MobileAppConfigurationApiService
}

func (r ApiGetMobileAppConfigRequest) Execute() ([]MobileApp, *http.Response, error) {
	return r.ApiService.GetMobileAppConfigExecute(r)
}

/*
GetMobileAppConfig Get configured mobile apps

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetMobileAppConfigRequest
*/
func (a *MobileAppConfigurationApiService) GetMobileAppConfig(ctx context.Context) ApiGetMobileAppConfigRequest {
	return ApiGetMobileAppConfigRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return []MobileApp
func (a *MobileAppConfigurationApiService) GetMobileAppConfigExecute(r ApiGetMobileAppConfigRequest) ([]MobileApp, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue []MobileApp
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MobileAppConfigurationApiService.GetMobileAppConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/mobile-app-monitoring/config"
...
type ApiGetMobileAppGeoLocationConfigurationRequest struct {
	ctx         context.Context
	ApiService  *MobileAppConfigurationApiService
	mobileAppId string
}

func (r ApiGetMobileAppGeoLocationConfigurationRequest) Execute() (*GeoLocationConfiguration, *http.Response, error) {
	return r.ApiService.GetMobileAppGeoLocationConfigurationExecute(r)
}

/*
GetMobileAppGeoLocationConfiguration Get geo location configuration for mobile app

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param mobileAppId
	@return ApiGetMobileAppGeoLocationConfigurationRequest
*/
func (a *MobileAppConfigurationApiService) GetMobileAppGeoLocationConfiguration(ctx context.Context, mobileAppId string) ApiGetMobileAppGeoLocationConfigurationRequest {
	return ApiGetMobileAppGeoLocationConfigurationRequest{
		ApiService:  a,
		ctx:         ctx,
		mobileAppId: mobileAppId,
...
func (a *MobileAppConfigurationApiService) GetMobileAppGeoLocationConfigurationExecute(r ApiGetMobileAppGeoLocationConfigurationRequest) (*GeoLocationConfiguration, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MobileAppConfigurationApiService.GetMobileAppGeoLocationConfiguration")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/mobile-app-monitoring/config/{mobileAppId}/geo-location"
	localVarPath = strings.Replace(localVarPath, "{"+"mobileAppId"+"}", url.PathEscape(parameterToString(r.mobileAppId, "")), -1)
...
type ApiGetMobileAppIpMaskingConfigurationRequest struct {
	ctx         context.Context
	ApiService  *MobileAppConfigurationApiService
	mobileAppId string
}

func (r ApiGetMobileAppIpMaskingConfigurationRequest) Execute() (*IpMaskingConfiguration, *http.Response, error) {
	return r.ApiService.GetMobileAppIpMaskingConfigurationExecute(r)
}

/*
GetMobileAppIpMaskingConfiguration Get IP masking configuration for mobile app

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param mobileAppId
	@return ApiGetMobileAppIpMaskingConfigurationRequest
*/
func (a *MobileAppConfigurationApiService) GetMobileAppIpMaskingConfiguration(ctx context.Context, mobileAppId string) ApiGetMobileAppIpMaskingConfigurationRequest {
	return ApiGetMobileAppIpMaskingConfigurationRequest{
		ApiService:  a,
		ctx:         ctx,
		mobileAppId: mobileAppId,
...
func (a *MobileAppConfigurationApiService) GetMobileAppIpMaskingConfigurationExecute(r ApiGetMobileAppIpMaskingConfigurationRequest) (*IpMaskingConfiguration, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MobileAppConfigurationApiService.GetMobileAppIpMaskingConfiguration")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/mobile-app-monitoring/config/{mobileAppId}/ip-masking"
	localVarPath = strings.Replace(localVarPath, "{"+"mobileAppId"+"}", url.PathEscape(parameterToString(r.mobileAppId, "")), -1)
...
type ApiPostMobileAppConfigRequest struct {
	ctx        context.Context
	ApiService *MobileAppConfigurationApiService
	name       *string
}

func (r ApiPostMobileAppConfigRequest) Name(name string) ApiPostMobileAppConfigRequest {
	r.name = &name
	return r
}

func (r ApiPostMobileAppConfigRequest) Execute() (*MobileApp, *http.Response, error) {
	return r.ApiService.PostMobileAppConfigExecute(r)
}

/*
PostMobileAppConfig Configure new mobile app

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiPostMobileAppConfigRequest
*/
func (a *MobileAppConfigurationApiService) PostMobileAppConfig(ctx context.Context) ApiPostMobileAppConfigRequest {
	return ApiPostMobileAppConfigRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return MobileApp
func (a *MobileAppConfigurationApiService) PostMobileAppConfigExecute(r ApiPostMobileAppConfigRequest) (*MobileApp, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MobileAppConfigurationApiService.PostMobileAppConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiRenameMobileAppConfigRequest struct {
	ctx         context.Context
	ApiService  *MobileAppConfigurationApiService
	mobileAppId string
	name        *string
...
func (r ApiRenameMobileAppConfigRequest) Name(name string) ApiRenameMobileAppConfigRequest {
	r.name = &name
	return r
}

func (r ApiRenameMobileAppConfigRequest) Execute() (*MobileApp, *http.Response, error) {
	return r.ApiService.RenameMobileAppConfigExecute(r)
}

/*
RenameMobileAppConfig Rename mobile app

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param mobileAppId
	@return ApiRenameMobileAppConfigRequest
*/
func (a *MobileAppConfigurationApiService) RenameMobileAppConfig(ctx context.Context, mobileAppId string) ApiRenameMobileAppConfigRequest {
	return ApiRenameMobileAppConfigRequest{
		ApiService:  a,
		ctx:         ctx,
		mobileAppId: mobileAppId,
...
//
//	@return MobileApp
func (a *MobileAppConfigurationApiService) RenameMobileAppConfigExecute(r ApiRenameMobileAppConfigRequest) (*MobileApp, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MobileAppConfigurationApiService.RenameMobileAppConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateMobileAppGeoLocationConfigurationRequest struct {
	ctx                      context.Context
	ApiService               *MobileAppConfigurationApiService
	mobileAppId              string
...
func (r ApiUpdateMobileAppGeoLocationConfigurationRequest) GeoLocationConfiguration(geoLocationConfiguration GeoLocationConfiguration) ApiUpdateMobileAppGeoLocationConfigurationRequest {
	r.geoLocationConfiguration = &geoLocationConfiguration
	return r
}

func (r ApiUpdateMobileAppGeoLocationConfigurationRequest) Execute() (*GeoLocationConfiguration, *http.Response, error) {
	return r.ApiService.UpdateMobileAppGeoLocationConfigurationExecute(r)
}

/*
UpdateMobileAppGeoLocationConfiguration Update geo location configuration for mobile app

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param mobileAppId
	@return ApiUpdateMobileAppGeoLocationConfigurationRequest
*/
func (a *MobileAppConfigurationApiService) UpdateMobileAppGeoLocationConfiguration(ctx context.Context, mobileAppId string) ApiUpdateMobileAppGeoLocationConfigurationRequest {
	return ApiUpdateMobileAppGeoLocationConfigurationRequest{
		ApiService:  a,
		ctx:         ctx,
		mobileAppId: mobileAppId,
...
//
//	@return GeoLocationConfiguration
func (a *MobileAppConfigurationApiService) UpdateMobileAppGeoLocationConfigurationExecute(r ApiUpdateMobileAppGeoLocationConfigurationRequest) (*GeoLocationConfiguration, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MobileAppConfigurationApiService.UpdateMobileAppGeoLocationConfiguration")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateMobileAppIpMaskingConfigurationRequest struct {
	ctx                    context.Context
	ApiService             *MobileAppConfigurationApiService
	mobileAppId            string
...
func (r ApiUpdateMobileAppIpMaskingConfigurationRequest) IpMaskingConfiguration(ipMaskingConfiguration IpMaskingConfiguration) ApiUpdateMobileAppIpMaskingConfigurationRequest {
	r.ipMaskingConfiguration = &ipMaskingConfiguration
	return r
}

func (r ApiUpdateMobileAppIpMaskingConfigurationRequest) Execute() (*IpMaskingConfiguration, *http.Response, error) {
	return r.ApiService.UpdateMobileAppIpMaskingConfigurationExecute(r)
}

/*
UpdateMobileAppIpMaskingConfiguration Update IP masking configuration for mobile app

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param mobileAppId
	@return ApiUpdateMobileAppIpMaskingConfigurationRequest
*/
func (a *MobileAppConfigurationApiService) UpdateMobileAppIpMaskingConfiguration(ctx context.Context, mobileAppId string) ApiUpdateMobileAppIpMaskingConfigurationRequest {
	return ApiUpdateMobileAppIpMaskingConfigurationRequest{
		ApiService:  a,
		ctx:         ctx,
		mobileAppId: mobileAppId,
...
//
//	@return IpMaskingConfiguration
func (a *MobileAppConfigurationApiService) UpdateMobileAppIpMaskingConfigurationExecute(r ApiUpdateMobileAppIpMaskingConfigurationRequest) (*IpMaskingConfiguration, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MobileAppConfigurationApiService.UpdateMobileAppIpMaskingConfiguration")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
