...
// EndpointNode struct for EndpointNode
...
func (o EndpointNode) MarshalJSON() ([]byte, error) {
...
type NullableEndpointNode struct {
	value *EndpointNode
	isSet bool
}

func (v NullableEndpointNode) Get() *EndpointNode {
	return v.value
}

func (v *NullableEndpointNode) Set(val *EndpointNode) {
	v.value = val
	v.isSet = true
}

func (v NullableEndpointNode) IsSet() bool {
	return v.isSet
}

func (v *NullableEndpointNode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEndpointNode(val *EndpointNode) *NullableEndpointNode {
	return &NullableEndpointNode{value: val, isSet: true}
}

func (v NullableEndpointNode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEndpointNode) UnmarshalJSON(src []byte) error {
	v.isSet = true
