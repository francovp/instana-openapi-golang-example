...
// GetHasEntities returns the HasEntities field value if set, zero value otherwise.
func (o *MonitoringState) GetHasEntities() bool {
	if o == nil || isNil(o.HasEntities) {
		var ret bool
		return ret
	}
	return *o.HasEntities
}

// GetHasEntitiesOk returns a tuple with the HasEntities field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MonitoringState) GetHasEntitiesOk() (*bool, bool) {
	if o == nil || isNil(o.HasEntities) {
		return nil, false
	}
	return o.HasEntities, true
}
...
// SetHasEntities gets a reference to the given bool and assigns it to the HasEntities field.
...
func (o *MonitoringState) GetServerlessCount() int32 {
	if o == nil || isNil(o.ServerlessCount) {
		var ret int32
		return ret
	}
...
func (o MonitoringState) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.HasEntities) {
		toSerialize["hasEntities"] = o.HasEntities
	}
	if !isNil(o.HostCount) {
		toSerialize["hostCount"] = o.HostCount
	}
	if !isNil(o.ServerlessCount) {
