...
// RequestImpactApplicationTimeThreshold struct for RequestImpactApplicationTimeThreshold
type RequestImpactApplicationTimeThreshold struct {
...
func NewRequestImpactApplicationTimeThreshold(type_ string) *RequestImpactApplicationTimeThreshold {
	this := RequestImpactApplicationTimeThreshold{}
	this.Type = type_
	return &this
}
...
func (o RequestImpactApplicationTimeThreshold) MarshalJSON() ([]byte, error) {
...
type NullableRequestImpactApplicationTimeThreshold struct {
	value *RequestImpactApplicationTimeThreshold
	isSet bool
}

func (v NullableRequestImpactApplicationTimeThreshold) Get() *RequestImpactApplicationTimeThreshold {
	return v.value
}

func (v *NullableRequestImpactApplicationTimeThreshold) Set(val *RequestImpactApplicationTimeThreshold) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestImpactApplicationTimeThreshold) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestImpactApplicationTimeThreshold) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestImpactApplicationTimeThreshold(val *RequestImpactApplicationTimeThreshold) *NullableRequestImpactApplicationTimeThreshold {
	return &NullableRequestImpactApplicationTimeThreshold{value: val, isSet: true}
}

func (v NullableRequestImpactApplicationTimeThreshold) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestImpactApplicationTimeThreshold) UnmarshalJSON(src []byte) error {
	v.isSet = true
