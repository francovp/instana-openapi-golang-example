...
// ScopeBinding struct for ScopeBinding
type ScopeBinding struct {
	ScopeId     *string `json:"scopeId,omitempty"`
	ScopeRoleId *string `json:"scopeRoleId,omitempty"`
}
...
// GetScopeRoleId returns the ScopeRoleId field value if set, zero value otherwise.
func (o *ScopeBinding) GetScopeRoleId() string {
	if o == nil || isNil(o.ScopeRoleId) {
		var ret string
		return ret
	}
	return *o.ScopeRoleId
}

// GetScopeRoleIdOk returns a tuple with the ScopeRoleId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ScopeBinding) GetScopeRoleIdOk() (*string, bool) {
	if o == nil || isNil(o.ScopeRoleId) {
		return nil, false
	}
	return o.ScopeRoleId, true
}
...
// SetScopeRoleId gets a reference to the given string and assigns it to the ScopeRoleId field.
func (o *ScopeBinding) SetScopeRoleId(v string) {
	o.ScopeRoleId = &v
}

func (o ScopeBinding) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.ScopeId) {
		toSerialize["scopeId"] = o.ScopeId
	}
	if !isNil(o.ScopeRoleId) {
		toSerialize["scopeRoleId"] = o.ScopeRoleId
	}
	return json.Marshal(toSerialize)
}

type NullableScopeBinding struct {
	value *ScopeBinding
	isSet bool
}

func (v NullableScopeBinding) Get() *ScopeBinding {
	return v.value
}

func (v *NullableScopeBinding) Set(val *ScopeBinding) {
	v.value = val
	v.isSet = true
}

func (v NullableScopeBinding) IsSet() bool {
	return v.isSet
}

func (v *NullableScopeBinding) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScopeBinding(val *ScopeBinding) *NullableScopeBinding {
	return &NullableScopeBinding{value: val, isSet: true}
}

func (v NullableScopeBinding) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScopeBinding) UnmarshalJSON(src []byte) error {
	v.isSet = true
