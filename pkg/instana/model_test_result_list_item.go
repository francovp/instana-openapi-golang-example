...
// TestResultListItem struct for TestResultListItem
type TestResultListItem struct {
	Metrics                    map[string][][]float32     `json:"metrics"`
	TestResultCommonProperties TestResultCommonProperties `json:"testResultCommonProperties"`
}
...
func NewTestResultListItem(metrics map[string][][]float32, testResultCommonProperties TestResultCommonProperties) *TestResultListItem {
	this := TestResultListItem{}
	this.Metrics = metrics
	this.TestResultCommonProperties = testResultCommonProperties
	return &this
}
...
// GetTestResultCommonProperties returns the TestResultCommonProperties field value
func (o *TestResultListItem) GetTestResultCommonProperties() TestResultCommonProperties {
	if o == nil {
		var ret TestResultCommonProperties
		return ret
	}

	return o.TestResultCommonProperties
}

// GetTestResultCommonPropertiesOk returns a tuple with the TestResultCommonProperties field value
// and a boolean to check if the value has been set.
func (o *TestResultListItem) GetTestResultCommonPropertiesOk() (*TestResultCommonProperties, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TestResultCommonProperties, true
}

// SetTestResultCommonProperties sets field value
func (o *TestResultListItem) SetTestResultCommonProperties(v TestResultCommonProperties) {
	o.TestResultCommonProperties = v
}

func (o TestResultListItem) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["metrics"] = o.Metrics
	}
	if true {
		toSerialize["testResultCommonProperties"] = o.TestResultCommonProperties
	}
	return json.Marshal(toSerialize)
}

type NullableTestResultListItem struct {
	value *TestResultListItem
	isSet bool
}

func (v NullableTestResultListItem) Get() *TestResultListItem {
	return v.value
}

func (v *NullableTestResultListItem) Set(val *TestResultListItem) {
	v.value = val
	v.isSet = true
}

func (v NullableTestResultListItem) IsSet() bool {
	return v.isSet
}

func (v *NullableTestResultListItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTestResultListItem(val *TestResultListItem) *NullableTestResultListItem {
	return &NullableTestResultListItem{value: val, isSet: true}
}

func (v NullableTestResultListItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTestResultListItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
