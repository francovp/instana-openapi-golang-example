...
type ApiGetAgentLogsRequest struct {
	ctx        context.Context
...
func (r ApiGetAgentLogsRequest) File(file []string) ApiGetAgentLogsRequest {
	r.file = &file
	return r
}

func (r ApiGetAgentLogsRequest) Download(download bool) ApiGetAgentLogsRequest {
	r.download = &download
	return r
}

func (r ApiGetAgentLogsRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetAgentLogsExecute(r)
}

/*
GetAgentLogs Agent download logs

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param hostId
	@return ApiGetAgentLogsRequest
*/
func (a *HostAgentApiService) GetAgentLogs(ctx context.Context, hostId string) ApiGetAgentLogsRequest {
	return ApiGetAgentLogsRequest{
		ApiService: a,
		ctx:        ctx,
		hostId:     hostId,
...
func (a *HostAgentApiService) GetAgentLogsExecute(r ApiGetAgentLogsRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HostAgentApiService.GetAgentLogs")
	if err != nil {
...
func (r ApiGetAgentSnapshotRequest) Execute() (*SnapshotItem, *http.Response, error) {
...
*/
func (a *HostAgentApiService) GetAgentSnapshot(ctx context.Context, id string) ApiGetAgentSnapshotRequest {
	return ApiGetAgentSnapshotRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return SnapshotItem
func (a *HostAgentApiService) GetAgentSnapshotExecute(r ApiGetAgentSnapshotRequest) (*SnapshotItem, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
type ApiSearchHostAgentsRequest struct {
	ctx        context.Context
	ApiService *HostAgentApiService
	query      *string
	to         *int64
...
func (r ApiSearchHostAgentsRequest) Query(query string) ApiSearchHostAgentsRequest {
	r.query = &query
	return r
}

func (r ApiSearchHostAgentsRequest) To(to int64) ApiSearchHostAgentsRequest {
	r.to = &to
	return r
}

func (r ApiSearchHostAgentsRequest) WindowSize(windowSize int64) ApiSearchHostAgentsRequest {
	r.windowSize = &windowSize
	return r
}

func (r ApiSearchHostAgentsRequest) Size(size int32) ApiSearchHostAgentsRequest {
	r.size = &size
	return r
}

func (r ApiSearchHostAgentsRequest) Offline(offline bool) ApiSearchHostAgentsRequest {
	r.offline = &offline
	return r
}

func (r ApiSearchHostAgentsRequest) Execute() (*SnapshotResult, *http.Response, error) {
	return r.ApiService.SearchHostAgentsExecute(r)
}

/*
SearchHostAgents Query host agent snapshots

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiSearchHostAgentsRequest
*/
func (a *HostAgentApiService) SearchHostAgents(ctx context.Context) ApiSearchHostAgentsRequest {
	return ApiSearchHostAgentsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *HostAgentApiService) SearchHostAgentsExecute(r ApiSearchHostAgentsRequest) (*SnapshotResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HostAgentApiService.SearchHostAgents")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *HostAgentApiService) UpdateAgent(ctx context.Context, hostId string) ApiUpdateAgentRequest {
	return ApiUpdateAgentRequest{
		ApiService: a,
		ctx:        ctx,
		hostId:     hostId,
...
// Execute executes the request
func (a *HostAgentApiService) UpdateAgentExecute(r ApiUpdateAgentRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HostAgentApiService.UpdateAgent")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateConfigurationByHostRequest) Execute() (*http.Response, error) {
...
*/
func (a *HostAgentApiService) UpdateConfigurationByHost(ctx context.Context, hostId string) ApiUpdateConfigurationByHostRequest {
	return ApiUpdateConfigurationByHostRequest{
		ApiService: a,
		ctx:        ctx,
		hostId:     hostId,
...
// Execute executes the request
func (a *HostAgentApiService) UpdateConfigurationByHostExecute(r ApiUpdateConfigurationByHostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
...
func (r ApiUpdateConfigurationByQueryRequest) Execute() (*http.Response, error) {
...
*/
func (a *HostAgentApiService) UpdateConfigurationByQuery(ctx context.Context) ApiUpdateConfigurationByQueryRequest {
	return ApiUpdateConfigurationByQueryRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *HostAgentApiService) UpdateConfigurationByQueryExecute(r ApiUpdateConfigurationByQueryRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
