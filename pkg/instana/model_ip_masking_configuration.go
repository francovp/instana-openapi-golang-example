...
// IpMaskingConfiguration struct for IpMaskingConfiguration
type IpMaskingConfiguration struct {
	IpMasking string `json:"ipMasking"`
}
...
// GetIpMasking returns the IpMasking field value
...
// GetIpMaskingOk returns a tuple with the IpMasking field value
// and a boolean to check if the value has been set.
func (o *IpMaskingConfiguration) GetIpMaskingOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.IpMasking, true
}

// SetIpMasking sets field value
func (o *IpMaskingConfiguration) SetIpMasking(v string) {
	o.IpMasking = v
}

func (o IpMaskingConfiguration) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["ipMasking"] = o.IpMasking
	}
	return json.Marshal(toSerialize)
}

type NullableIpMaskingConfiguration struct {
	value *IpMaskingConfiguration
	isSet bool
}

func (v NullableIpMaskingConfiguration) Get() *IpMaskingConfiguration {
	return v.value
}

func (v *NullableIpMaskingConfiguration) Set(val *IpMaskingConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableIpMaskingConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableIpMaskingConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpMaskingConfiguration(val *IpMaskingConfiguration) *NullableIpMaskingConfiguration {
	return &NullableIpMaskingConfiguration{value: val, isSet: true}
}

func (v NullableIpMaskingConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpMaskingConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
