...
// HttpScriptConfiguration struct for HttpScriptConfiguration
type HttpScriptConfiguration struct {
...
func NewHttpScriptConfiguration(markSyntheticCall bool, syntheticType string) *HttpScriptConfiguration {
	this := HttpScriptConfiguration{}
...
func (o HttpScriptConfiguration) MarshalJSON() ([]byte, error) {
...
type NullableHttpScriptConfiguration struct {
	value *HttpScriptConfiguration
	isSet bool
}

func (v NullableHttpScriptConfiguration) Get() *HttpScriptConfiguration {
	return v.value
}

func (v *NullableHttpScriptConfiguration) Set(val *HttpScriptConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableHttpScriptConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableHttpScriptConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHttpScriptConfiguration(val *HttpScriptConfiguration) *NullableHttpScriptConfiguration {
	return &NullableHttpScriptConfiguration{value: val, isSet: true}
}

func (v NullableHttpScriptConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHttpScriptConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
