...
// WebpageActionConfiguration struct for WebpageActionConfiguration
type WebpageActionConfiguration struct {
...
func NewWebpageActionConfiguration(url string, markSyntheticCall bool, syntheticType string) *WebpageActionConfiguration {
	this := WebpageActionConfiguration{}
...
func (o WebpageActionConfiguration) MarshalJSON() ([]byte, error) {
...
type NullableWebpageActionConfiguration struct {
	value *WebpageActionConfiguration
	isSet bool
}

func (v NullableWebpageActionConfiguration) Get() *WebpageActionConfiguration {
	return v.value
}

func (v *NullableWebpageActionConfiguration) Set(val *WebpageActionConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableWebpageActionConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableWebpageActionConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebpageActionConfiguration(val *WebpageActionConfiguration) *NullableWebpageActionConfiguration {
	return &NullableWebpageActionConfiguration{value: val, isSet: true}
}

func (v NullableWebpageActionConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebpageActionConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
