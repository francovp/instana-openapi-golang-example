...
// HttpScriptConfigurationAllOf struct for HttpScriptConfigurationAllOf
type HttpScriptConfigurationAllOf struct {
...
func NewHttpScriptConfigurationAllOf() *HttpScriptConfigurationAllOf {
	this := HttpScriptConfigurationAllOf{}
	return &this
}
...
func (o HttpScriptConfigurationAllOf) MarshalJSON() ([]byte, error) {
...
type NullableHttpScriptConfigurationAllOf struct {
	value *HttpScriptConfigurationAllOf
	isSet bool
}

func (v NullableHttpScriptConfigurationAllOf) Get() *HttpScriptConfigurationAllOf {
	return v.value
}

func (v *NullableHttpScriptConfigurationAllOf) Set(val *HttpScriptConfigurationAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableHttpScriptConfigurationAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableHttpScriptConfigurationAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHttpScriptConfigurationAllOf(val *HttpScriptConfigurationAllOf) *NullableHttpScriptConfigurationAllOf {
	return &NullableHttpScriptConfigurationAllOf{value: val, isSet: true}
}

func (v NullableHttpScriptConfigurationAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHttpScriptConfigurationAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
