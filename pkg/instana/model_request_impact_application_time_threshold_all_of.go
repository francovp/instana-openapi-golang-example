...
// RequestImpactApplicationTimeThresholdAllOf struct for RequestImpactApplicationTimeThresholdAllOf
type RequestImpactApplicationTimeThresholdAllOf struct {
...
func NewRequestImpactApplicationTimeThresholdAllOf() *RequestImpactApplicationTimeThresholdAllOf {
	this := RequestImpactApplicationTimeThresholdAllOf{}
	return &this
}
...
func (o RequestImpactApplicationTimeThresholdAllOf) MarshalJSON() ([]byte, error) {
...
type NullableRequestImpactApplicationTimeThresholdAllOf struct {
	value *RequestImpactApplicationTimeThresholdAllOf
	isSet bool
}

func (v NullableRequestImpactApplicationTimeThresholdAllOf) Get() *RequestImpactApplicationTimeThresholdAllOf {
	return v.value
}

func (v *NullableRequestImpactApplicationTimeThresholdAllOf) Set(val *RequestImpactApplicationTimeThresholdAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestImpactApplicationTimeThresholdAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestImpactApplicationTimeThresholdAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestImpactApplicationTimeThresholdAllOf(val *RequestImpactApplicationTimeThresholdAllOf) *NullableRequestImpactApplicationTimeThresholdAllOf {
	return &NullableRequestImpactApplicationTimeThresholdAllOf{value: val, isSet: true}
}

func (v NullableRequestImpactApplicationTimeThresholdAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestImpactApplicationTimeThresholdAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
