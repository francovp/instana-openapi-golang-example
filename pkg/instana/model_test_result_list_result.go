...
// TestResultListResult struct for TestResultListResult
type TestResultListResult struct {
	Items     []TestResultListItem `json:"items"`
...
func (o TestResultListResult) MarshalJSON() ([]byte, error) {
...
type NullableTestResultListResult struct {
	value *TestResultListResult
	isSet bool
}

func (v NullableTestResultListResult) Get() *TestResultListResult {
	return v.value
}

func (v *NullableTestResultListResult) Set(val *TestResultListResult) {
	v.value = val
	v.isSet = true
}

func (v NullableTestResultListResult) IsSet() bool {
	return v.isSet
}

func (v *NullableTestResultListResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTestResultListResult(val *TestResultListResult) *NullableTestResultListResult {
	return &NullableTestResultListResult{value: val, isSet: true}
}

func (v NullableTestResultListResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTestResultListResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
