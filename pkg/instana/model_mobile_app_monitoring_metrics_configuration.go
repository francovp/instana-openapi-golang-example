...
// MobileAppMonitoringMetricsConfiguration struct for MobileAppMonitoringMetricsConfiguration
type MobileAppMonitoringMetricsConfiguration struct {
...
func NewMobileAppMonitoringMetricsConfiguration(aggregation string, metric string) *MobileAppMonitoringMetricsConfiguration {
	this := MobileAppMonitoringMetricsConfiguration{}
...
func (o MobileAppMonitoringMetricsConfiguration) MarshalJSON() ([]byte, error) {
...
type NullableMobileAppMonitoringMetricsConfiguration struct {
	value *MobileAppMonitoringMetricsConfiguration
	isSet bool
}

func (v NullableMobileAppMonitoringMetricsConfiguration) Get() *MobileAppMonitoringMetricsConfiguration {
	return v.value
}

func (v *NullableMobileAppMonitoringMetricsConfiguration) Set(val *MobileAppMonitoringMetricsConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableMobileAppMonitoringMetricsConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableMobileAppMonitoringMetricsConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMobileAppMonitoringMetricsConfiguration(val *MobileAppMonitoringMetricsConfiguration) *NullableMobileAppMonitoringMetricsConfiguration {
	return &NullableMobileAppMonitoringMetricsConfiguration{value: val, isSet: true}
}

func (v NullableMobileAppMonitoringMetricsConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMobileAppMonitoringMetricsConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
