...
// ViolationsInPeriodApplicationTimeThresholdAllOf struct for ViolationsInPeriodApplicationTimeThresholdAllOf
type ViolationsInPeriodApplicationTimeThresholdAllOf struct {
...
func NewViolationsInPeriodApplicationTimeThresholdAllOf() *ViolationsInPeriodApplicationTimeThresholdAllOf {
	this := ViolationsInPeriodApplicationTimeThresholdAllOf{}
	return &this
}
...
func (o ViolationsInPeriodApplicationTimeThresholdAllOf) MarshalJSON() ([]byte, error) {
...
type NullableViolationsInPeriodApplicationTimeThresholdAllOf struct {
	value *ViolationsInPeriodApplicationTimeThresholdAllOf
	isSet bool
}

func (v NullableViolationsInPeriodApplicationTimeThresholdAllOf) Get() *ViolationsInPeriodApplicationTimeThresholdAllOf {
	return v.value
}

func (v *NullableViolationsInPeriodApplicationTimeThresholdAllOf) Set(val *ViolationsInPeriodApplicationTimeThresholdAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableViolationsInPeriodApplicationTimeThresholdAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableViolationsInPeriodApplicationTimeThresholdAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViolationsInPeriodApplicationTimeThresholdAllOf(val *ViolationsInPeriodApplicationTimeThresholdAllOf) *NullableViolationsInPeriodApplicationTimeThresholdAllOf {
	return &NullableViolationsInPeriodApplicationTimeThresholdAllOf{value: val, isSet: true}
}

func (v NullableViolationsInPeriodApplicationTimeThresholdAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViolationsInPeriodApplicationTimeThresholdAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
