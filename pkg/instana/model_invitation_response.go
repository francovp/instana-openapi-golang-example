...
type InvitationResponse struct {
	InvitationResults []InvitationResult `json:"invitationResults,omitempty"`
}
...
// GetInvitationResults returns the InvitationResults field value if set, zero value otherwise.
func (o *InvitationResponse) GetInvitationResults() []InvitationResult {
	if o == nil || isNil(o.InvitationResults) {
		var ret []InvitationResult
		return ret
	}
	return o.InvitationResults
}

// GetInvitationResultsOk returns a tuple with the InvitationResults field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InvitationResponse) GetInvitationResultsOk() ([]InvitationResult, bool) {
	if o == nil || isNil(o.InvitationResults) {
		return nil, false
	}
	return o.InvitationResults, true
}
...
// SetInvitationResults gets a reference to the given []InvitationResult and assigns it to the InvitationResults field.
func (o *InvitationResponse) SetInvitationResults(v []InvitationResult) {
	o.InvitationResults = v
}

func (o InvitationResponse) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.InvitationResults) {
		toSerialize["invitationResults"] = o.InvitationResults
	}
