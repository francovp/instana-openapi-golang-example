...
// SyntheticPlaybackCapabilities struct for SyntheticPlaybackCapabilities
type SyntheticPlaybackCapabilities struct {
...
func NewSyntheticPlaybackCapabilities(browserType []string, syntheticType []string) *SyntheticPlaybackCapabilities {
	this := SyntheticPlaybackCapabilities{}
...
func (o SyntheticPlaybackCapabilities) MarshalJSON() ([]byte, error) {
...
type NullableSyntheticPlaybackCapabilities struct {
	value *SyntheticPlaybackCapabilities
	isSet bool
}

func (v NullableSyntheticPlaybackCapabilities) Get() *SyntheticPlaybackCapabilities {
	return v.value
}

func (v *NullableSyntheticPlaybackCapabilities) Set(val *SyntheticPlaybackCapabilities) {
	v.value = val
	v.isSet = true
}

func (v NullableSyntheticPlaybackCapabilities) IsSet() bool {
	return v.isSet
}

func (v *NullableSyntheticPlaybackCapabilities) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyntheticPlaybackCapabilities(val *SyntheticPlaybackCapabilities) *NullableSyntheticPlaybackCapabilities {
	return &NullableSyntheticPlaybackCapabilities{value: val, isSet: true}
}

func (v NullableSyntheticPlaybackCapabilities) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyntheticPlaybackCapabilities) UnmarshalJSON(src []byte) error {
	v.isSet = true
