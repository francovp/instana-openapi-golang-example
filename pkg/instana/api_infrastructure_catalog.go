...
type ApiGetInfrastructureCatalogMetricsRequest struct {
	ctx        context.Context
	ApiService *InfrastructureCatalogApiService
	plugin     string
	filter     *string
}

func (r ApiGetInfrastructureCatalogMetricsRequest) Filter(filter string) ApiGetInfrastructureCatalogMetricsRequest {
	r.filter = &filter
	return r
}

func (r ApiGetInfrastructureCatalogMetricsRequest) Execute() ([]MetricInstance, *http.Response, error) {
	return r.ApiService.GetInfrastructureCatalogMetricsExecute(r)
}
...
* `builtin` to retrieve built-in metric definitions only.
	...
	@param plugin
	@return ApiGetInfrastructureCatalogMetricsRequest
*/
func (a *InfrastructureCatalogApiService) GetInfrastructureCatalogMetrics(ctx context.Context, plugin string) ApiGetInfrastructureCatalogMetricsRequest {
	return ApiGetInfrastructureCatalogMetricsRequest{
		ApiService: a,
		ctx:        ctx,
		plugin:     plugin,
...
func (a *InfrastructureCatalogApiService) GetInfrastructureCatalogMetricsExecute(r ApiGetInfrastructureCatalogMetricsRequest) ([]MetricInstance, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InfrastructureCatalogApiService.GetInfrastructureCatalogMetrics")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/infrastructure-monitoring/catalog/metrics/{plugin}"
	localVarPath = strings.Replace(localVarPath, "{"+"plugin"+"}", url.PathEscape(parameterToString(r.plugin, "")), -1)
...
type ApiGetInfrastructureCatalogPluginsRequest struct {
	ctx        context.Context
	ApiService *InfrastructureCatalogApiService
}

func (r ApiGetInfrastructureCatalogPluginsRequest) Execute() ([]PluginResult, *http.Response, error) {
	return r.ApiService.GetInfrastructureCatalogPluginsExecute(r)
}
...
This endpoint retrieves all available plugin ids for your monitored system.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetInfrastructureCatalogPluginsRequest
*/
func (a *InfrastructureCatalogApiService) GetInfrastructureCatalogPlugins(ctx context.Context) ApiGetInfrastructureCatalogPluginsRequest {
	return ApiGetInfrastructureCatalogPluginsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return []PluginResult
func (a *InfrastructureCatalogApiService) GetInfrastructureCatalogPluginsExecute(r ApiGetInfrastructureCatalogPluginsRequest) ([]PluginResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InfrastructureCatalogApiService.GetInfrastructureCatalogPlugins")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/infrastructure-monitoring/catalog/plugins"
...
type ApiGetInfrastructureCatalogPluginsWithCustomMetricsRequest struct {
	ctx        context.Context
	ApiService *InfrastructureCatalogApiService
}

func (r ApiGetInfrastructureCatalogPluginsWithCustomMetricsRequest) Execute() ([]PluginResult, *http.Response, error) {
	return r.ApiService.GetInfrastructureCatalogPluginsWithCustomMetricsExecute(r)
}
...
GetInfrastructureCatalogPluginsWithCustomMetrics Get all plugins with custom metrics catalog
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetInfrastructureCatalogPluginsWithCustomMetricsRequest
*/
func (a *InfrastructureCatalogApiService) GetInfrastructureCatalogPluginsWithCustomMetrics(ctx context.Context) ApiGetInfrastructureCatalogPluginsWithCustomMetricsRequest {
	return ApiGetInfrastructureCatalogPluginsWithCustomMetricsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return []PluginResult
func (a *InfrastructureCatalogApiService) GetInfrastructureCatalogPluginsWithCustomMetricsExecute(r ApiGetInfrastructureCatalogPluginsWithCustomMetricsRequest) ([]PluginResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InfrastructureCatalogApiService.GetInfrastructureCatalogPluginsWithCustomMetrics")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/infrastructure-monitoring/catalog/plugins-with-custom-metrics"
...
type ApiGetInfrastructureCatalogSearchFieldsRequest struct {
	ctx        context.Context
	ApiService *InfrastructureCatalogApiService
}

func (r ApiGetInfrastructureCatalogSearchFieldsRequest) Execute() ([]SearchFieldResult, *http.Response, error) {
	return r.ApiService.GetInfrastructureCatalogSearchFieldsExecute(r)
}
...
```
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetInfrastructureCatalogSearchFieldsRequest
*/
func (a *InfrastructureCatalogApiService) GetInfrastructureCatalogSearchFields(ctx context.Context) ApiGetInfrastructureCatalogSearchFieldsRequest {
	return ApiGetInfrastructureCatalogSearchFieldsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *InfrastructureCatalogApiService) GetInfrastructureCatalogSearchFieldsExecute(r ApiGetInfrastructureCatalogSearchFieldsRequest) ([]SearchFieldResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InfrastructureCatalogApiService.GetInfrastructureCatalogSearchFields")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/infrastructure-monitoring/catalog/search"
