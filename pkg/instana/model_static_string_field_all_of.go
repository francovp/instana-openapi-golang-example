...
// StaticStringFieldAllOf struct for StaticStringFieldAllOf
type StaticStringFieldAllOf struct {
...
func (o StaticStringFieldAllOf) MarshalJSON() ([]byte, error) {
...
type NullableStaticStringFieldAllOf struct {
	value *StaticStringFieldAllOf
	isSet bool
}

func (v NullableStaticStringFieldAllOf) Get() *StaticStringFieldAllOf {
	return v.value
}

func (v *NullableStaticStringFieldAllOf) Set(val *StaticStringFieldAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStaticStringFieldAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStaticStringFieldAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStaticStringFieldAllOf(val *StaticStringFieldAllOf) *NullableStaticStringFieldAllOf {
	return &NullableStaticStringFieldAllOf{value: val, isSet: true}
}

func (v NullableStaticStringFieldAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStaticStringFieldAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
