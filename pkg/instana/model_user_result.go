...
// GetLastLoggedIn returns the LastLoggedIn field value if set, zero value otherwise.
func (o *UserResult) GetLastLoggedIn() int64 {
	if o == nil || isNil(o.LastLoggedIn) {
		var ret int64
		return ret
	}
	return *o.LastLoggedIn
}

// GetLastLoggedInOk returns a tuple with the LastLoggedIn field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserResult) GetLastLoggedInOk() (*int64, bool) {
	if o == nil || isNil(o.LastLoggedIn) {
		return nil, false
	}
	return o.LastLoggedIn, true
}
...
// SetLastLoggedIn gets a reference to the given int64 and assigns it to the LastLoggedIn field.
...
func (o UserResult) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.LastLoggedIn) {
		toSerialize["lastLoggedIn"] = o.LastLoggedIn
	}
