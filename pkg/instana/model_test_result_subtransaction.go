...
// TestResultSubtransaction struct for TestResultSubtransaction
type TestResultSubtransaction struct {
...
func (o TestResultSubtransaction) MarshalJSON() ([]byte, error) {
...
type NullableTestResultSubtransaction struct {
	value *TestResultSubtransaction
	isSet bool
}

func (v NullableTestResultSubtransaction) Get() *TestResultSubtransaction {
	return v.value
}

func (v *NullableTestResultSubtransaction) Set(val *TestResultSubtransaction) {
	v.value = val
	v.isSet = true
}

func (v NullableTestResultSubtransaction) IsSet() bool {
	return v.isSet
}

func (v *NullableTestResultSubtransaction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTestResultSubtransaction(val *TestResultSubtransaction) *NullableTestResultSubtransaction {
	return &NullableTestResultSubtransaction{value: val, isSet: true}
}

func (v NullableTestResultSubtransaction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTestResultSubtransaction) UnmarshalJSON(src []byte) error {
	v.isSet = true
