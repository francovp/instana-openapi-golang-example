...
// ServiceMapConnection struct for ServiceMapConnection
type ServiceMapConnection struct {
...
func (o ServiceMapConnection) MarshalJSON() ([]byte, error) {
...
type NullableServiceMapConnection struct {
	value *ServiceMapConnection
	isSet bool
}

func (v NullableServiceMapConnection) Get() *ServiceMapConnection {
	return v.value
}

func (v *NullableServiceMapConnection) Set(val *ServiceMapConnection) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceMapConnection) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceMapConnection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceMapConnection(val *ServiceMapConnection) *NullableServiceMapConnection {
	return &NullableServiceMapConnection{value: val, isSet: true}
}

func (v NullableServiceMapConnection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceMapConnection) UnmarshalJSON(src []byte) error {
	v.isSet = true
