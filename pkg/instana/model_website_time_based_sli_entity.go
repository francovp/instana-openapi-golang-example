...
// WebsiteTimeBasedSliEntity struct for WebsiteTimeBasedSliEntity
type WebsiteTimeBasedSliEntity struct {
...
func NewWebsiteTimeBasedSliEntity(beaconType string, sliType string) *WebsiteTimeBasedSliEntity {
	this := WebsiteTimeBasedSliEntity{}
...
func (o WebsiteTimeBasedSliEntity) MarshalJSON() ([]byte, error) {
...
type NullableWebsiteTimeBasedSliEntity struct {
	value *WebsiteTimeBasedSliEntity
	isSet bool
}

func (v NullableWebsiteTimeBasedSliEntity) Get() *WebsiteTimeBasedSliEntity {
	return v.value
}

func (v *NullableWebsiteTimeBasedSliEntity) Set(val *WebsiteTimeBasedSliEntity) {
	v.value = val
	v.isSet = true
}

func (v NullableWebsiteTimeBasedSliEntity) IsSet() bool {
	return v.isSet
}

func (v *NullableWebsiteTimeBasedSliEntity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebsiteTimeBasedSliEntity(val *WebsiteTimeBasedSliEntity) *NullableWebsiteTimeBasedSliEntity {
	return &NullableWebsiteTimeBasedSliEntity{value: val, isSet: true}
}

func (v NullableWebsiteTimeBasedSliEntity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebsiteTimeBasedSliEntity) UnmarshalJSON(src []byte) error {
	v.isSet = true
