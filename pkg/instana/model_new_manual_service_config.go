...
// NewManualServiceConfig struct for NewManualServiceConfig
type NewManualServiceConfig struct {
	Description            *string                    `json:"description,omitempty"`
	Enabled                *bool                      `json:"enabled,omitempty"`
	ExistingServiceId      *string                    `json:"existingServiceId,omitempty"`
	TagFilterExpression    TagFilterExpressionElement `json:"tagFilterExpression"`
	UnmonitoredServiceName *string                    `json:"unmonitoredServiceName,omitempty"`
}
...
// GetExistingServiceId returns the ExistingServiceId field value if set, zero value otherwise.
func (o *NewManualServiceConfig) GetExistingServiceId() string {
	if o == nil || isNil(o.ExistingServiceId) {
		var ret string
		return ret
	}
	return *o.ExistingServiceId
}

// GetExistingServiceIdOk returns a tuple with the ExistingServiceId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NewManualServiceConfig) GetExistingServiceIdOk() (*string, bool) {
	if o == nil || isNil(o.ExistingServiceId) {
		return nil, false
	}
	return o.ExistingServiceId, true
}
...
// SetExistingServiceId gets a reference to the given string and assigns it to the ExistingServiceId field.
func (o *NewManualServiceConfig) SetExistingServiceId(v string) {
	o.ExistingServiceId = &v
}
...
// GetUnmonitoredServiceName returns the UnmonitoredServiceName field value if set, zero value otherwise.
func (o *NewManualServiceConfig) GetUnmonitoredServiceName() string {
	if o == nil || isNil(o.UnmonitoredServiceName) {
		var ret string
		return ret
	}
	return *o.UnmonitoredServiceName
}

// GetUnmonitoredServiceNameOk returns a tuple with the UnmonitoredServiceName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NewManualServiceConfig) GetUnmonitoredServiceNameOk() (*string, bool) {
	if o == nil || isNil(o.UnmonitoredServiceName) {
		return nil, false
	}
	return o.UnmonitoredServiceName, true
}
...
// SetUnmonitoredServiceName gets a reference to the given string and assigns it to the UnmonitoredServiceName field.
func (o *NewManualServiceConfig) SetUnmonitoredServiceName(v string) {
	o.UnmonitoredServiceName = &v
}

func (o NewManualServiceConfig) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.ExistingServiceId) {
		toSerialize["existingServiceId"] = o.ExistingServiceId
	}
	if true {
		toSerialize["tagFilterExpression"] = o.TagFilterExpression
	}
	if !isNil(o.UnmonitoredServiceName) {
		toSerialize["unmonitoredServiceName"] = o.UnmonitoredServiceName
	}
	return json.Marshal(toSerialize)
}

type NullableNewManualServiceConfig struct {
	value *NewManualServiceConfig
	isSet bool
}

func (v NullableNewManualServiceConfig) Get() *NewManualServiceConfig {
	return v.value
}

func (v *NullableNewManualServiceConfig) Set(val *NewManualServiceConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableNewManualServiceConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableNewManualServiceConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewManualServiceConfig(val *NewManualServiceConfig) *NullableNewManualServiceConfig {
	return &NullableNewManualServiceConfig{value: val, isSet: true}
}

func (v NullableNewManualServiceConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewManualServiceConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
