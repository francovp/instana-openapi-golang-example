...
func NewUnsupportedHttpPathSegmentMatchingRule(type_ string) *UnsupportedHttpPathSegmentMatchingRule {
...
func (o *UnsupportedHttpPathSegmentMatchingRule) GetUnsupportedType() string {
	if o == nil || isNil(o.UnsupportedType) {
		var ret string
		return ret
	}
