...
// WebpageScriptConfiguration struct for WebpageScriptConfiguration
type WebpageScriptConfiguration struct {
...
func NewWebpageScriptConfiguration(script string, markSyntheticCall bool, syntheticType string) *WebpageScriptConfiguration {
	this := WebpageScriptConfiguration{}
...
func (o WebpageScriptConfiguration) MarshalJSON() ([]byte, error) {
...
type NullableWebpageScriptConfiguration struct {
	value *WebpageScriptConfiguration
	isSet bool
}

func (v NullableWebpageScriptConfiguration) Get() *WebpageScriptConfiguration {
	return v.value
}

func (v *NullableWebpageScriptConfiguration) Set(val *WebpageScriptConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableWebpageScriptConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableWebpageScriptConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebpageScriptConfiguration(val *WebpageScriptConfiguration) *NullableWebpageScriptConfiguration {
	return &NullableWebpageScriptConfiguration{value: val, isSet: true}
}

func (v NullableWebpageScriptConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebpageScriptConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
