...
// TagFilterExpressionAllOf struct for TagFilterExpressionAllOf
type TagFilterExpressionAllOf struct {
	Elements        []TagFilterExpressionElement `json:"elements,omitempty"`
...
// SetElements gets a reference to the given []TagFilterExpressionElement and assigns it to the Elements field.
...
func (o TagFilterExpressionAllOf) MarshalJSON() ([]byte, error) {
...
type NullableTagFilterExpressionAllOf struct {
	value *TagFilterExpressionAllOf
	isSet bool
}

func (v NullableTagFilterExpressionAllOf) Get() *TagFilterExpressionAllOf {
	return v.value
}

func (v *NullableTagFilterExpressionAllOf) Set(val *TagFilterExpressionAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableTagFilterExpressionAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableTagFilterExpressionAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagFilterExpressionAllOf(val *TagFilterExpressionAllOf) *NullableTagFilterExpressionAllOf {
	return &NullableTagFilterExpressionAllOf{value: val, isSet: true}
}

func (v NullableTagFilterExpressionAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagFilterExpressionAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
