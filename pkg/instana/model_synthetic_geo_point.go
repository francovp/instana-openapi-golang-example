...
// SyntheticGeoPoint struct for SyntheticGeoPoint
type SyntheticGeoPoint struct {
...
func (o SyntheticGeoPoint) MarshalJSON() ([]byte, error) {
...
type NullableSyntheticGeoPoint struct {
	value *SyntheticGeoPoint
	isSet bool
}

func (v NullableSyntheticGeoPoint) Get() *SyntheticGeoPoint {
	return v.value
}

func (v *NullableSyntheticGeoPoint) Set(val *SyntheticGeoPoint) {
	v.value = val
	v.isSet = true
}

func (v NullableSyntheticGeoPoint) IsSet() bool {
	return v.isSet
}

func (v *NullableSyntheticGeoPoint) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyntheticGeoPoint(val *SyntheticGeoPoint) *NullableSyntheticGeoPoint {
	return &NullableSyntheticGeoPoint{value: val, isSet: true}
}

func (v NullableSyntheticGeoPoint) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyntheticGeoPoint) UnmarshalJSON(src []byte) error {
	v.isSet = true
