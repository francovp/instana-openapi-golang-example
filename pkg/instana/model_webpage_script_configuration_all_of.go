...
// WebpageScriptConfigurationAllOf struct for WebpageScriptConfigurationAllOf
type WebpageScriptConfigurationAllOf struct {
...
func NewWebpageScriptConfigurationAllOf() *WebpageScriptConfigurationAllOf {
	this := WebpageScriptConfigurationAllOf{}
	return &this
}
...
func (o WebpageScriptConfigurationAllOf) MarshalJSON() ([]byte, error) {
...
type NullableWebpageScriptConfigurationAllOf struct {
	value *WebpageScriptConfigurationAllOf
	isSet bool
}

func (v NullableWebpageScriptConfigurationAllOf) Get() *WebpageScriptConfigurationAllOf {
	return v.value
}

func (v *NullableWebpageScriptConfigurationAllOf) Set(val *WebpageScriptConfigurationAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableWebpageScriptConfigurationAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableWebpageScriptConfigurationAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebpageScriptConfigurationAllOf(val *WebpageScriptConfigurationAllOf) *NullableWebpageScriptConfigurationAllOf {
	return &NullableWebpageScriptConfigurationAllOf{value: val, isSet: true}
}

func (v NullableWebpageScriptConfigurationAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebpageScriptConfigurationAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
