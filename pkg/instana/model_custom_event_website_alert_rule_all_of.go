...
// CustomEventWebsiteAlertRuleAllOf struct for CustomEventWebsiteAlertRuleAllOf
type CustomEventWebsiteAlertRuleAllOf struct {
...
func NewCustomEventWebsiteAlertRuleAllOf() *CustomEventWebsiteAlertRuleAllOf {
	this := CustomEventWebsiteAlertRuleAllOf{}
	return &this
}
...
func (o CustomEventWebsiteAlertRuleAllOf) MarshalJSON() ([]byte, error) {
...
type NullableCustomEventWebsiteAlertRuleAllOf struct {
	value *CustomEventWebsiteAlertRuleAllOf
	isSet bool
}

func (v NullableCustomEventWebsiteAlertRuleAllOf) Get() *CustomEventWebsiteAlertRuleAllOf {
	return v.value
}

func (v *NullableCustomEventWebsiteAlertRuleAllOf) Set(val *CustomEventWebsiteAlertRuleAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomEventWebsiteAlertRuleAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomEventWebsiteAlertRuleAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomEventWebsiteAlertRuleAllOf(val *CustomEventWebsiteAlertRuleAllOf) *NullableCustomEventWebsiteAlertRuleAllOf {
	return &NullableCustomEventWebsiteAlertRuleAllOf{value: val, isSet: true}
}

func (v NullableCustomEventWebsiteAlertRuleAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomEventWebsiteAlertRuleAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
