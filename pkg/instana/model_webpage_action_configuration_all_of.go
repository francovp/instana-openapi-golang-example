...
// WebpageActionConfigurationAllOf struct for WebpageActionConfigurationAllOf
type WebpageActionConfigurationAllOf struct {
...
func NewWebpageActionConfigurationAllOf() *WebpageActionConfigurationAllOf {
	this := WebpageActionConfigurationAllOf{}
	return &this
}
...
func (o WebpageActionConfigurationAllOf) MarshalJSON() ([]byte, error) {
...
type NullableWebpageActionConfigurationAllOf struct {
	value *WebpageActionConfigurationAllOf
	isSet bool
}

func (v NullableWebpageActionConfigurationAllOf) Get() *WebpageActionConfigurationAllOf {
	return v.value
}

func (v *NullableWebpageActionConfigurationAllOf) Set(val *WebpageActionConfigurationAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableWebpageActionConfigurationAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableWebpageActionConfigurationAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebpageActionConfigurationAllOf(val *WebpageActionConfigurationAllOf) *NullableWebpageActionConfigurationAllOf {
	return &NullableWebpageActionConfigurationAllOf{value: val, isSet: true}
}

func (v NullableWebpageActionConfigurationAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebpageActionConfigurationAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
