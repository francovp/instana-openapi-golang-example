...
// AccessLogEntry struct for AccessLogEntry
type AccessLogEntry struct {
	Action       string  `json:"action"`
	Email        string  `json:"email"`
	FullName     string  `json:"fullName"`
	TenantId     string  `json:"tenantId"`
	TenantUnitId *string `json:"tenantUnitId,omitempty"`
...
// GetTenantUnitId returns the TenantUnitId field value if set, zero value otherwise.
func (o *AccessLogEntry) GetTenantUnitId() string {
	if o == nil || isNil(o.TenantUnitId) {
		var ret string
		return ret
	}
	return *o.TenantUnitId
}

// GetTenantUnitIdOk returns a tuple with the TenantUnitId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AccessLogEntry) GetTenantUnitIdOk() (*string, bool) {
	if o == nil || isNil(o.TenantUnitId) {
		return nil, false
	}
	return o.TenantUnitId, true
}
...
// SetTenantUnitId gets a reference to the given string and assigns it to the TenantUnitId field.
...
func (o AccessLogEntry) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.TenantUnitId) {
		toSerialize["tenantUnitId"] = o.TenantUnitId
	}
	if true {
