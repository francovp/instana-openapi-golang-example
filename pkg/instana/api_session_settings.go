...
func (r ApiDeleteSessionSettingsRequest) Execute() (*http.Response, error) {
...
*/
func (a *SessionSettingsApiService) DeleteSessionSettings(ctx context.Context) ApiDeleteSessionSettingsRequest {
	return ApiDeleteSessionSettingsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *SessionSettingsApiService) DeleteSessionSettingsExecute(r ApiDeleteSessionSettingsRequest) (*http.Response, error) {
	var (
...
*/
func (a *SessionSettingsApiService) GetSessionSettings(ctx context.Context) ApiGetSessionSettingsRequest {
	return ApiGetSessionSettingsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *SessionSettingsApiService) GetSessionSettingsExecute(r ApiGetSessionSettingsRequest) (*SessionSettings, *http.Response, error) {
	var (
...
func (r ApiSetSessionSettingsRequest) Execute() (*SessionSettings, *http.Response, error) {
...
*/
func (a *SessionSettingsApiService) SetSessionSettings(ctx context.Context) ApiSetSessionSettingsRequest {
	return ApiSetSessionSettingsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return SessionSettings
func (a *SessionSettingsApiService) SetSessionSettingsExecute(r ApiSetSessionSettingsRequest) (*SessionSettings, *http.Response, error) {
	var (
