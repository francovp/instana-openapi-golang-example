...
// GetSteadyId returns the SteadyId field value
...
// GetSteadyIdOk returns a tuple with the SteadyId field value
// and a boolean to check if the value has been set.
func (o *EntityId) GetSteadyIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.SteadyId, true
}

// SetSteadyId sets field value
...
func (o EntityId) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["steadyId"] = o.SteadyId
	}
