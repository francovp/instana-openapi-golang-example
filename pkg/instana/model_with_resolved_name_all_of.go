...
// WithResolvedNameAllOf struct for WithResolvedNameAllOf
type WithResolvedNameAllOf struct {
...
func (o WithResolvedNameAllOf) MarshalJSON() ([]byte, error) {
...
type NullableWithResolvedNameAllOf struct {
	value *WithResolvedNameAllOf
	isSet bool
}

func (v NullableWithResolvedNameAllOf) Get() *WithResolvedNameAllOf {
	return v.value
}

func (v *NullableWithResolvedNameAllOf) Set(val *WithResolvedNameAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableWithResolvedNameAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableWithResolvedNameAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWithResolvedNameAllOf(val *WithResolvedNameAllOf) *NullableWithResolvedNameAllOf {
	return &NullableWithResolvedNameAllOf{value: val, isSet: true}
}

func (v NullableWithResolvedNameAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWithResolvedNameAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
