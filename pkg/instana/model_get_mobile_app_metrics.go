...
// GetMobileAppMetrics struct for GetMobileAppMetrics
type GetMobileAppMetrics struct {
...
func (o GetMobileAppMetrics) MarshalJSON() ([]byte, error) {
...
type NullableGetMobileAppMetrics struct {
	value *GetMobileAppMetrics
	isSet bool
}

func (v NullableGetMobileAppMetrics) Get() *GetMobileAppMetrics {
	return v.value
}

func (v *NullableGetMobileAppMetrics) Set(val *GetMobileAppMetrics) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMobileAppMetrics) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMobileAppMetrics) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMobileAppMetrics(val *GetMobileAppMetrics) *NullableGetMobileAppMetrics {
	return &NullableGetMobileAppMetrics{value: val, isSet: true}
}

func (v NullableGetMobileAppMetrics) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMobileAppMetrics) UnmarshalJSON(src []byte) error {
	v.isSet = true
