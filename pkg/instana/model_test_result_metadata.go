...
// TestResultMetadata struct for TestResultMetadata
...
func (o TestResultMetadata) MarshalJSON() ([]byte, error) {
...
type NullableTestResultMetadata struct {
	value *TestResultMetadata
	isSet bool
}

func (v NullableTestResultMetadata) Get() *TestResultMetadata {
	return v.value
}

func (v *NullableTestResultMetadata) Set(val *TestResultMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableTestResultMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableTestResultMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTestResultMetadata(val *TestResultMetadata) *NullableTestResultMetadata {
	return &NullableTestResultMetadata{value: val, isSet: true}
}

func (v NullableTestResultMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTestResultMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
