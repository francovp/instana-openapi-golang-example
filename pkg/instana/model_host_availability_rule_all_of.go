...
// HostAvailabilityRuleAllOf struct for HostAvailabilityRuleAllOf
type HostAvailabilityRuleAllOf struct {
	CloseAfter      *int64     `json:"closeAfter,omitempty"`
...
func NewHostAvailabilityRuleAllOf() *HostAvailabilityRuleAllOf {
	this := HostAvailabilityRuleAllOf{}
	return &this
}
...
// GetCloseAfter returns the CloseAfter field value if set, zero value otherwise.
func (o *HostAvailabilityRuleAllOf) GetCloseAfter() int64 {
	if o == nil || isNil(o.CloseAfter) {
		var ret int64
		return ret
	}
	return *o.CloseAfter
...
// GetCloseAfterOk returns a tuple with the CloseAfter field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HostAvailabilityRuleAllOf) GetCloseAfterOk() (*int64, bool) {
	if o == nil || isNil(o.CloseAfter) {
		return nil, false
	}
	return o.CloseAfter, true
}
...
// SetCloseAfter gets a reference to the given int64 and assigns it to the CloseAfter field.
...
func (o *HostAvailabilityRuleAllOf) GetOfflineDuration() int64 {
	if o == nil || isNil(o.OfflineDuration) {
		var ret int64
		return ret
	}
...
func (o HostAvailabilityRuleAllOf) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.CloseAfter) {
		toSerialize["closeAfter"] = o.CloseAfter
	}
	if !isNil(o.OfflineDuration) {
...
type NullableHostAvailabilityRuleAllOf struct {
	value *HostAvailabilityRuleAllOf
	isSet bool
}

func (v NullableHostAvailabilityRuleAllOf) Get() *HostAvailabilityRuleAllOf {
	return v.value
}

func (v *NullableHostAvailabilityRuleAllOf) Set(val *HostAvailabilityRuleAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableHostAvailabilityRuleAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableHostAvailabilityRuleAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostAvailabilityRuleAllOf(val *HostAvailabilityRuleAllOf) *NullableHostAvailabilityRuleAllOf {
	return &NullableHostAvailabilityRuleAllOf{value: val, isSet: true}
}

func (v NullableHostAvailabilityRuleAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostAvailabilityRuleAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
