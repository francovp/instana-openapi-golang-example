...
// WebsiteBeaconResult struct for WebsiteBeaconResult
type WebsiteBeaconResult struct {
...
func (o WebsiteBeaconResult) MarshalJSON() ([]byte, error) {
...
type NullableWebsiteBeaconResult struct {
	value *WebsiteBeaconResult
	isSet bool
}

func (v NullableWebsiteBeaconResult) Get() *WebsiteBeaconResult {
	return v.value
}

func (v *NullableWebsiteBeaconResult) Set(val *WebsiteBeaconResult) {
	v.value = val
	v.isSet = true
}

func (v NullableWebsiteBeaconResult) IsSet() bool {
	return v.isSet
}

func (v *NullableWebsiteBeaconResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebsiteBeaconResult(val *WebsiteBeaconResult) *NullableWebsiteBeaconResult {
	return &NullableWebsiteBeaconResult{value: val, isSet: true}
}

func (v NullableWebsiteBeaconResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebsiteBeaconResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
