...
*/
func (a *APITokenApiService) DeleteApiToken(ctx context.Context, internalId string) ApiDeleteApiTokenRequest {
	return ApiDeleteApiTokenRequest{
		ApiService: a,
		ctx:        ctx,
...
func (a *APITokenApiService) DeleteApiTokenExecute(r ApiDeleteApiTokenRequest) (*http.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"internalId"+"}", url.PathEscape(parameterToString(r.internalId, "")), -1)
...
*/
func (a *APITokenApiService) GetApiToken(ctx context.Context, internalId string) ApiGetApiTokenRequest {
	return ApiGetApiTokenRequest{
		ApiService: a,
		ctx:        ctx,
		internalId: internalId,
...
//
//	@return ApiToken
func (a *APITokenApiService) GetApiTokenExecute(r ApiGetApiTokenRequest) (*ApiToken, *http.Response, error) {
	var (
...
func (r ApiGetApiTokensRequest) Execute() ([]ApiToken, *http.Response, error) {
...
*/
func (a *APITokenApiService) GetApiTokens(ctx context.Context) ApiGetApiTokensRequest {
	return ApiGetApiTokensRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return []ApiToken
func (a *APITokenApiService) GetApiTokensExecute(r ApiGetApiTokensRequest) ([]ApiToken, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiPostApiTokenRequest) Execute() (*ApiToken, *http.Response, error) {
...
*/
func (a *APITokenApiService) PostApiToken(ctx context.Context) ApiPostApiTokenRequest {
	return ApiPostApiTokenRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return ApiToken
func (a *APITokenApiService) PostApiTokenExecute(r ApiPostApiTokenRequest) (*ApiToken, *http.Response, error) {
	var (
...
func (r ApiPutApiTokenRequest) Execute() (*ApiToken, *http.Response, error) {
...
*/
func (a *APITokenApiService) PutApiToken(ctx context.Context, internalId string) ApiPutApiTokenRequest {
	return ApiPutApiTokenRequest{
		ApiService: a,
		ctx:        ctx,
		internalId: internalId,
...
//
//	@return ApiToken
func (a *APITokenApiService) PutApiTokenExecute(r ApiPutApiTokenRequest) (*ApiToken, *http.Response, error) {
	var (
