...
// StatusCodeApplicationAlertRule struct for StatusCodeApplicationAlertRule
type StatusCodeApplicationAlertRule struct {
	StatusCodeEnd   *int32 `json:"statusCodeEnd,omitempty"`
	StatusCodeStart *int32 `json:"statusCodeStart,omitempty"`
}
...
func NewStatusCodeApplicationAlertRule(alertType string, metricName string) *StatusCodeApplicationAlertRule {
	this := StatusCodeApplicationAlertRule{}
...
// GetStatusCodeEnd returns the StatusCodeEnd field value if set, zero value otherwise.
func (o *StatusCodeApplicationAlertRule) GetStatusCodeEnd() int32 {
	if o == nil || isNil(o.StatusCodeEnd) {
		var ret int32
		return ret
	}
	return *o.StatusCodeEnd
}

// GetStatusCodeEndOk returns a tuple with the StatusCodeEnd field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StatusCodeApplicationAlertRule) GetStatusCodeEndOk() (*int32, bool) {
	if o == nil || isNil(o.StatusCodeEnd) {
		return nil, false
	}
	return o.StatusCodeEnd, true
}
...
// SetStatusCodeEnd gets a reference to the given int32 and assigns it to the StatusCodeEnd field.
func (o *StatusCodeApplicationAlertRule) SetStatusCodeEnd(v int32) {
	o.StatusCodeEnd = &v
}

// GetStatusCodeStart returns the StatusCodeStart field value if set, zero value otherwise.
func (o *StatusCodeApplicationAlertRule) GetStatusCodeStart() int32 {
	if o == nil || isNil(o.StatusCodeStart) {
		var ret int32
		return ret
	}
	return *o.StatusCodeStart
}

// GetStatusCodeStartOk returns a tuple with the StatusCodeStart field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StatusCodeApplicationAlertRule) GetStatusCodeStartOk() (*int32, bool) {
	if o == nil || isNil(o.StatusCodeStart) {
		return nil, false
	}
	return o.StatusCodeStart, true
}
...
// SetStatusCodeStart gets a reference to the given int32 and assigns it to the StatusCodeStart field.
func (o *StatusCodeApplicationAlertRule) SetStatusCodeStart(v int32) {
	o.StatusCodeStart = &v
}

func (o StatusCodeApplicationAlertRule) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.StatusCodeEnd) {
		toSerialize["statusCodeEnd"] = o.StatusCodeEnd
	}
	if !isNil(o.StatusCodeStart) {
		toSerialize["statusCodeStart"] = o.StatusCodeStart
	}
	return json.Marshal(toSerialize)
}

type NullableStatusCodeApplicationAlertRule struct {
	value *StatusCodeApplicationAlertRule
	isSet bool
}

func (v NullableStatusCodeApplicationAlertRule) Get() *StatusCodeApplicationAlertRule {
	return v.value
}

func (v *NullableStatusCodeApplicationAlertRule) Set(val *StatusCodeApplicationAlertRule) {
	v.value = val
	v.isSet = true
}

func (v NullableStatusCodeApplicationAlertRule) IsSet() bool {
	return v.isSet
}

func (v *NullableStatusCodeApplicationAlertRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStatusCodeApplicationAlertRule(val *StatusCodeApplicationAlertRule) *NullableStatusCodeApplicationAlertRule {
	return &NullableStatusCodeApplicationAlertRule{value: val, isSet: true}
}

func (v NullableStatusCodeApplicationAlertRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStatusCodeApplicationAlertRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
