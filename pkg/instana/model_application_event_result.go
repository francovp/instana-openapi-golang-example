...
// ApplicationEventResult struct for ApplicationEventResult
...
func (o ApplicationEventResult) MarshalJSON() ([]byte, error) {
...
type NullableApplicationEventResult struct {
	value *ApplicationEventResult
	isSet bool
}

func (v NullableApplicationEventResult) Get() *ApplicationEventResult {
	return v.value
}

func (v *NullableApplicationEventResult) Set(val *ApplicationEventResult) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationEventResult) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationEventResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationEventResult(val *ApplicationEventResult) *NullableApplicationEventResult {
	return &NullableApplicationEventResult{value: val, isSet: true}
}

func (v NullableApplicationEventResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationEventResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
