...
// AdjustedTimeframe struct for AdjustedTimeframe
type AdjustedTimeframe struct {
	To         int64  `json:"to"`
...
func (o AdjustedTimeframe) MarshalJSON() ([]byte, error) {
...
type NullableAdjustedTimeframe struct {
	value *AdjustedTimeframe
	isSet bool
}

func (v NullableAdjustedTimeframe) Get() *AdjustedTimeframe {
	return v.value
}

func (v *NullableAdjustedTimeframe) Set(val *AdjustedTimeframe) {
	v.value = val
	v.isSet = true
}

func (v NullableAdjustedTimeframe) IsSet() bool {
	return v.isSet
}

func (v *NullableAdjustedTimeframe) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdjustedTimeframe(val *AdjustedTimeframe) *NullableAdjustedTimeframe {
	return &NullableAdjustedTimeframe{value: val, isSet: true}
}

func (v NullableAdjustedTimeframe) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdjustedTimeframe) UnmarshalJSON(src []byte) error {
	v.isSet = true
