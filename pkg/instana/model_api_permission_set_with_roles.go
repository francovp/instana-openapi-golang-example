...
// ApiPermissionSetWithRoles struct for ApiPermissionSetWithRoles
type ApiPermissionSetWithRoles struct {
	ApplicationIds          []ScopeBinding `json:"applicationIds"`
	InfraDfqFilter          *ScopeBinding  `json:"infraDfqFilter,omitempty"`
...
func NewApiPermissionSetWithRoles(applicationIds []ScopeBinding, kubernetesClusterUUIDs []ScopeBinding, kubernetesNamespaceUIDs []ScopeBinding, mobileAppIds []ScopeBinding, permissions []string, websiteIds []ScopeBinding) *ApiPermissionSetWithRoles {
	this := ApiPermissionSetWithRoles{}
...
func (o *ApiPermissionSetWithRoles) GetInfraDfqFilter() ScopeBinding {
	if o == nil || isNil(o.InfraDfqFilter) {
		var ret ScopeBinding
		return ret
	}
...
// SetInfraDfqFilter gets a reference to the given ScopeBinding and assigns it to the InfraDfqFilter field.
...
func (o ApiPermissionSetWithRoles) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["applicationIds"] = o.ApplicationIds
	}
	if !isNil(o.InfraDfqFilter) {
...
type NullableApiPermissionSetWithRoles struct {
	value *ApiPermissionSetWithRoles
	isSet bool
}

func (v NullableApiPermissionSetWithRoles) Get() *ApiPermissionSetWithRoles {
	return v.value
}

func (v *NullableApiPermissionSetWithRoles) Set(val *ApiPermissionSetWithRoles) {
	v.value = val
	v.isSet = true
}

func (v NullableApiPermissionSetWithRoles) IsSet() bool {
	return v.isSet
}

func (v *NullableApiPermissionSetWithRoles) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiPermissionSetWithRoles(val *ApiPermissionSetWithRoles) *NullableApiPermissionSetWithRoles {
	return &NullableApiPermissionSetWithRoles{value: val, isSet: true}
}

func (v NullableApiPermissionSetWithRoles) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiPermissionSetWithRoles) UnmarshalJSON(src []byte) error {
	v.isSet = true
