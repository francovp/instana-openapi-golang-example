...
// SyntheticTestPlaybackResultsApiService SyntheticTestPlaybackResultsApi service
type SyntheticTestPlaybackResultsApiService service

type ApiGetSyntheticResultRequest struct {
	ctx           context.Context
	ApiService    *SyntheticTestPlaybackResultsApiService
	getTestResult *GetTestResult
}

func (r ApiGetSyntheticResultRequest) GetTestResult(getTestResult GetTestResult) ApiGetSyntheticResultRequest {
	r.getTestResult = &getTestResult
	return r
}

func (r ApiGetSyntheticResultRequest) Execute() (*TestResult, *http.Response, error) {
	return r.ApiService.GetSyntheticResultExecute(r)
}

/*
GetSyntheticResult Experimental - Get Synthetic test playback results

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetSyntheticResultRequest
*/
func (a *SyntheticTestPlaybackResultsApiService) GetSyntheticResult(ctx context.Context) ApiGetSyntheticResultRequest {
	return ApiGetSyntheticResultRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return TestResult
func (a *SyntheticTestPlaybackResultsApiService) GetSyntheticResultExecute(r ApiGetSyntheticResultRequest) (*TestResult, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SyntheticTestPlaybackResultsApiService.GetSyntheticResult")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/synthetics/results"
	...
	// body params
	localVarPostBody = r.getTestResult
	if r.ctx != nil {
...
type ApiGetSyntheticResultDetailDataRequest struct {
	ctx          context.Context
	ApiService   *SyntheticTestPlaybackResultsApiService
	testid       string
	testresultid string
...
func (r ApiGetSyntheticResultDetailDataRequest) Type_(type_ string) ApiGetSyntheticResultDetailDataRequest {
	r.type_ = &type_
	return r
}

func (r ApiGetSyntheticResultDetailDataRequest) Name(name string) ApiGetSyntheticResultDetailDataRequest {
	r.name = &name
	return r
}

func (r ApiGetSyntheticResultDetailDataRequest) Execute() (*TestResultDetailData, *http.Response, error) {
	return r.ApiService.GetSyntheticResultDetailDataExecute(r)
}

/*
GetSyntheticResultDetailData Experimental - Get Synthetic test playback result detail data

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param testid
	@param testresultid
	@return ApiGetSyntheticResultDetailDataRequest
*/
func (a *SyntheticTestPlaybackResultsApiService) GetSyntheticResultDetailData(ctx context.Context, testid string, testresultid string) ApiGetSyntheticResultDetailDataRequest {
	return ApiGetSyntheticResultDetailDataRequest{
		ApiService:   a,
		ctx:          ctx,
		testid:       testid,
...
func (a *SyntheticTestPlaybackResultsApiService) GetSyntheticResultDetailDataExecute(r ApiGetSyntheticResultDetailDataRequest) (*TestResultDetailData, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *TestResultDetailData
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SyntheticTestPlaybackResultsApiService.GetSyntheticResultDetailData")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/synthetics/results/{testid}/{testresultid}/detail"
	localVarPath = strings.Replace(localVarPath, "{"+"testid"+"}", url.PathEscape(parameterToString(r.testid, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"testresultid"+"}", url.PathEscape(parameterToString(r.testresultid, "")), -1)
...
type ApiGetSyntheticResultListRequest struct {
	ctx               context.Context
	ApiService        *SyntheticTestPlaybackResultsApiService
	getTestResultList *GetTestResultList
}

func (r ApiGetSyntheticResultListRequest) GetTestResultList(getTestResultList GetTestResultList) ApiGetSyntheticResultListRequest {
	r.getTestResultList = &getTestResultList
	return r
}

func (r ApiGetSyntheticResultListRequest) Execute() (*TestResultListResult, *http.Response, error) {
	return r.ApiService.GetSyntheticResultListExecute(r)
}

/*
GetSyntheticResultList Experimental - Get a list of Synthetic test playback results

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetSyntheticResultListRequest
*/
func (a *SyntheticTestPlaybackResultsApiService) GetSyntheticResultList(ctx context.Context) ApiGetSyntheticResultListRequest {
	return ApiGetSyntheticResultListRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *SyntheticTestPlaybackResultsApiService) GetSyntheticResultListExecute(r ApiGetSyntheticResultListRequest) (*TestResultListResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *TestResultListResult
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SyntheticTestPlaybackResultsApiService.GetSyntheticResultList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/synthetics/results/list"
	...
	// body params
	localVarPostBody = r.getTestResultList
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKeyAuth"]; ok {
...
type ApiGetSyntheticResultMetadataRequest struct {
	ctx          context.Context
	ApiService   *SyntheticTestPlaybackResultsApiService
	testid       string
	testresultid string
...
func (r ApiGetSyntheticResultMetadataRequest) Execute() (*TestResultMetadata, *http.Response, error) {
	return r.ApiService.GetSyntheticResultMetadataExecute(r)
}

/*
GetSyntheticResultMetadata Experimental - Get Synthetic test playback detail result description(metadata)

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param testid
	@param testresultid
	@return ApiGetSyntheticResultMetadataRequest
*/
func (a *SyntheticTestPlaybackResultsApiService) GetSyntheticResultMetadata(ctx context.Context, testid string, testresultid string) ApiGetSyntheticResultMetadataRequest {
	return ApiGetSyntheticResultMetadataRequest{
		ApiService:   a,
		ctx:          ctx,
		testid:       testid,
...
func (a *SyntheticTestPlaybackResultsApiService) GetSyntheticResultMetadataExecute(r ApiGetSyntheticResultMetadataRequest) (*TestResultMetadata, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *TestResultMetadata
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SyntheticTestPlaybackResultsApiService.GetSyntheticResultMetadata")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/synthetics/results/{testid}/{testresultid}"
	localVarPath = strings.Replace(localVarPath, "{"+"testid"+"}", url.PathEscape(parameterToString(r.testid, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"testresultid"+"}", url.PathEscape(parameterToString(r.testresultid, "")), -1)
...
type ApiGetTestSummaryListRequest struct {
	ctx           context.Context
	ApiService    *SyntheticTestPlaybackResultsApiService
	getTestResult *GetTestResult
}

func (r ApiGetTestSummaryListRequest) GetTestResult(getTestResult GetTestResult) ApiGetTestSummaryListRequest {
	r.getTestResult = &getTestResult
	return r
}

func (r ApiGetTestSummaryListRequest) Execute() (*TestResultListResult, *http.Response, error) {
	return r.ApiService.GetTestSummaryListExecute(r)
}

/*
GetTestSummaryList Experimental - Get a list of Synthetic tests with success rate and average response time data

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetTestSummaryListRequest
*/
func (a *SyntheticTestPlaybackResultsApiService) GetTestSummaryList(ctx context.Context) ApiGetTestSummaryListRequest {
	return ApiGetTestSummaryListRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return TestResultListResult
func (a *SyntheticTestPlaybackResultsApiService) GetTestSummaryListExecute(r ApiGetTestSummaryListRequest) (*TestResultListResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SyntheticTestPlaybackResultsApiService.GetTestSummaryList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/synthetics/results/testsummarylist"
