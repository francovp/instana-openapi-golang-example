...
// WithResolvedName struct for WithResolvedName
type WithResolvedName struct {
...
func (o WithResolvedName) MarshalJSON() ([]byte, error) {
...
type NullableWithResolvedName struct {
	value *WithResolvedName
	isSet bool
}

func (v NullableWithResolvedName) Get() *WithResolvedName {
	return v.value
}

func (v *NullableWithResolvedName) Set(val *WithResolvedName) {
	v.value = val
	v.isSet = true
}

func (v NullableWithResolvedName) IsSet() bool {
	return v.isSet
}

func (v *NullableWithResolvedName) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWithResolvedName(val *WithResolvedName) *NullableWithResolvedName {
	return &NullableWithResolvedName{value: val, isSet: true}
}

func (v NullableWithResolvedName) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWithResolvedName) UnmarshalJSON(src []byte) error {
	v.isSet = true
