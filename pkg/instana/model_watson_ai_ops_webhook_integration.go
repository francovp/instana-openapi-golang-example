...
// WatsonAIOpsWebhookIntegration struct for WatsonAIOpsWebhookIntegration
type WatsonAIOpsWebhookIntegration struct {
...
func NewWatsonAIOpsWebhookIntegration(webhookUrl string, id string, kind string, name string) *WatsonAIOpsWebhookIntegration {
	this := WatsonAIOpsWebhookIntegration{}
	this.Id = id
	this.Kind = kind
	this.Name = name
...
func (o WatsonAIOpsWebhookIntegration) MarshalJSON() ([]byte, error) {
...
type NullableWatsonAIOpsWebhookIntegration struct {
	value *WatsonAIOpsWebhookIntegration
	isSet bool
}

func (v NullableWatsonAIOpsWebhookIntegration) Get() *WatsonAIOpsWebhookIntegration {
	return v.value
}

func (v *NullableWatsonAIOpsWebhookIntegration) Set(val *WatsonAIOpsWebhookIntegration) {
	v.value = val
	v.isSet = true
}

func (v NullableWatsonAIOpsWebhookIntegration) IsSet() bool {
	return v.isSet
}

func (v *NullableWatsonAIOpsWebhookIntegration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWatsonAIOpsWebhookIntegration(val *WatsonAIOpsWebhookIntegration) *NullableWatsonAIOpsWebhookIntegration {
	return &NullableWatsonAIOpsWebhookIntegration{value: val, isSet: true}
}

func (v NullableWatsonAIOpsWebhookIntegration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWatsonAIOpsWebhookIntegration) UnmarshalJSON(src []byte) error {
	v.isSet = true
