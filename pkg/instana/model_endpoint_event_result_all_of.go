...
// EndpointEventResultAllOf struct for EndpointEventResultAllOf
type EndpointEventResultAllOf struct {
...
// GetEndpointServiceId returns the EndpointServiceId field value if set, zero value otherwise.
func (o *EndpointEventResultAllOf) GetEndpointServiceId() string {
	if o == nil || isNil(o.EndpointServiceId) {
		var ret string
		return ret
	}
...
// GetEndpointServiceIdOk returns a tuple with the EndpointServiceId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EndpointEventResultAllOf) GetEndpointServiceIdOk() (*string, bool) {
	if o == nil || isNil(o.EndpointServiceId) {
		return nil, false
	}
	return o.EndpointServiceId, true
}
...
// SetEndpointServiceId gets a reference to the given string and assigns it to the EndpointServiceId field.
func (o *EndpointEventResultAllOf) SetEndpointServiceId(v string) {
	o.EndpointServiceId = &v
}

func (o EndpointEventResultAllOf) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.EndpointId) {
		toSerialize["endpointId"] = o.EndpointId
	}
	if !isNil(o.EndpointServiceId) {
		toSerialize["endpointServiceId"] = o.EndpointServiceId
	}
	return json.Marshal(toSerialize)
}

type NullableEndpointEventResultAllOf struct {
	value *EndpointEventResultAllOf
	isSet bool
}

func (v NullableEndpointEventResultAllOf) Get() *EndpointEventResultAllOf {
	return v.value
}

func (v *NullableEndpointEventResultAllOf) Set(val *EndpointEventResultAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableEndpointEventResultAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableEndpointEventResultAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEndpointEventResultAllOf(val *EndpointEventResultAllOf) *NullableEndpointEventResultAllOf {
	return &NullableEndpointEventResultAllOf{value: val, isSet: true}
}

func (v NullableEndpointEventResultAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEndpointEventResultAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
