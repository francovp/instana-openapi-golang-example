...
// TagFilterExpressionElement struct for TagFilterExpressionElement
type TagFilterExpressionElement struct {
...
func NewTagFilterExpressionElement(type_ string) *TagFilterExpressionElement {
	this := TagFilterExpressionElement{}
	this.Type = type_
	return &this
}
...
func (o TagFilterExpressionElement) MarshalJSON() ([]byte, error) {
...
type NullableTagFilterExpressionElement struct {
	value *TagFilterExpressionElement
	isSet bool
}

func (v NullableTagFilterExpressionElement) Get() *TagFilterExpressionElement {
	return v.value
}

func (v *NullableTagFilterExpressionElement) Set(val *TagFilterExpressionElement) {
	v.value = val
	v.isSet = true
}

func (v NullableTagFilterExpressionElement) IsSet() bool {
	return v.isSet
}

func (v *NullableTagFilterExpressionElement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagFilterExpressionElement(val *TagFilterExpressionElement) *NullableTagFilterExpressionElement {
	return &NullableTagFilterExpressionElement{value: val, isSet: true}
}

func (v NullableTagFilterExpressionElement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagFilterExpressionElement) UnmarshalJSON(src []byte) error {
	v.isSet = true
