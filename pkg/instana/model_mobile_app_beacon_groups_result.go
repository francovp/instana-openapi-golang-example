...
// MobileAppBeaconGroupsResult struct for MobileAppBeaconGroupsResult
type MobileAppBeaconGroupsResult struct {
	AdjustedTimeframe         *AdjustedTimeframe          `json:"adjustedTimeframe,omitempty"`
	CanLoadMore               *bool                       `json:"canLoadMore,omitempty"`
	Items                     []MobileAppBeaconGroupsItem `json:"items"`
	TotalHits                 *int64                      `json:"totalHits,omitempty"`
	TotalRepresentedItemCount *int64                      `json:"totalRepresentedItemCount,omitempty"`
	TotalRetainedItemCount    *int64                      `json:"totalRetainedItemCount,omitempty"`
}
...
func NewMobileAppBeaconGroupsResult(items []MobileAppBeaconGroupsItem) *MobileAppBeaconGroupsResult {
	this := MobileAppBeaconGroupsResult{}
	this.Items = items
	return &this
}
...
// GetAdjustedTimeframe returns the AdjustedTimeframe field value if set, zero value otherwise.
func (o *MobileAppBeaconGroupsResult) GetAdjustedTimeframe() AdjustedTimeframe {
	if o == nil || isNil(o.AdjustedTimeframe) {
		var ret AdjustedTimeframe
		return ret
	}
	return *o.AdjustedTimeframe
}

// GetAdjustedTimeframeOk returns a tuple with the AdjustedTimeframe field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MobileAppBeaconGroupsResult) GetAdjustedTimeframeOk() (*AdjustedTimeframe, bool) {
	if o == nil || isNil(o.AdjustedTimeframe) {
		return nil, false
	}
	return o.AdjustedTimeframe, true
}
...
// SetAdjustedTimeframe gets a reference to the given AdjustedTimeframe and assigns it to the AdjustedTimeframe field.
func (o *MobileAppBeaconGroupsResult) SetAdjustedTimeframe(v AdjustedTimeframe) {
	o.AdjustedTimeframe = &v
}
...
func (o *MobileAppBeaconGroupsResult) GetItems() []MobileAppBeaconGroupsItem {
	if o == nil {
		var ret []MobileAppBeaconGroupsItem
		return ret
	}
...
func (o *MobileAppBeaconGroupsResult) GetTotalRepresentedItemCount() int64 {
	if o == nil || isNil(o.TotalRepresentedItemCount) {
		var ret int64
		return ret
	}
...
// GetTotalRetainedItemCount returns the TotalRetainedItemCount field value if set, zero value otherwise.
func (o *MobileAppBeaconGroupsResult) GetTotalRetainedItemCount() int64 {
	if o == nil || isNil(o.TotalRetainedItemCount) {
		var ret int64
		return ret
	}
	return *o.TotalRetainedItemCount
}

// GetTotalRetainedItemCountOk returns a tuple with the TotalRetainedItemCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MobileAppBeaconGroupsResult) GetTotalRetainedItemCountOk() (*int64, bool) {
	if o == nil || isNil(o.TotalRetainedItemCount) {
		return nil, false
	}
	return o.TotalRetainedItemCount, true
}
...
// SetTotalRetainedItemCount gets a reference to the given int64 and assigns it to the TotalRetainedItemCount field.
func (o *MobileAppBeaconGroupsResult) SetTotalRetainedItemCount(v int64) {
	o.TotalRetainedItemCount = &v
}

func (o MobileAppBeaconGroupsResult) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if !isNil(o.AdjustedTimeframe) {
		toSerialize["adjustedTimeframe"] = o.AdjustedTimeframe
	}
	if !isNil(o.CanLoadMore) {
	...
	if !isNil(o.TotalRepresentedItemCount) {
		toSerialize["totalRepresentedItemCount"] = o.TotalRepresentedItemCount
	}
	if !isNil(o.TotalRetainedItemCount) {
		toSerialize["totalRetainedItemCount"] = o.TotalRetainedItemCount
	}
	return json.Marshal(toSerialize)
}

type NullableMobileAppBeaconGroupsResult struct {
	value *MobileAppBeaconGroupsResult
	isSet bool
}

func (v NullableMobileAppBeaconGroupsResult) Get() *MobileAppBeaconGroupsResult {
	return v.value
}

func (v *NullableMobileAppBeaconGroupsResult) Set(val *MobileAppBeaconGroupsResult) {
	v.value = val
	v.isSet = true
}

func (v NullableMobileAppBeaconGroupsResult) IsSet() bool {
	return v.isSet
}

func (v *NullableMobileAppBeaconGroupsResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMobileAppBeaconGroupsResult(val *MobileAppBeaconGroupsResult) *NullableMobileAppBeaconGroupsResult {
	return &NullableMobileAppBeaconGroupsResult{value: val, isSet: true}
}

func (v NullableMobileAppBeaconGroupsResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMobileAppBeaconGroupsResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
