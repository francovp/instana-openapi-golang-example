...
// BrowserScriptConfiguration struct for BrowserScriptConfiguration
type BrowserScriptConfiguration struct {
...
func NewBrowserScriptConfiguration(markSyntheticCall bool, syntheticType string) *BrowserScriptConfiguration {
	this := BrowserScriptConfiguration{}
...
func (o BrowserScriptConfiguration) MarshalJSON() ([]byte, error) {
...
type NullableBrowserScriptConfiguration struct {
	value *BrowserScriptConfiguration
	isSet bool
}

func (v NullableBrowserScriptConfiguration) Get() *BrowserScriptConfiguration {
	return v.value
}

func (v *NullableBrowserScriptConfiguration) Set(val *BrowserScriptConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableBrowserScriptConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableBrowserScriptConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBrowserScriptConfiguration(val *BrowserScriptConfiguration) *NullableBrowserScriptConfiguration {
	return &NullableBrowserScriptConfiguration{value: val, isSet: true}
}

func (v NullableBrowserScriptConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBrowserScriptConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
