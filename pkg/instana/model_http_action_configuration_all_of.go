...
// HttpActionConfigurationAllOf struct for HttpActionConfigurationAllOf
type HttpActionConfigurationAllOf struct {
...
func NewHttpActionConfigurationAllOf() *HttpActionConfigurationAllOf {
	this := HttpActionConfigurationAllOf{}
	return &this
}
...
func (o HttpActionConfigurationAllOf) MarshalJSON() ([]byte, error) {
...
type NullableHttpActionConfigurationAllOf struct {
	value *HttpActionConfigurationAllOf
	isSet bool
}

func (v NullableHttpActionConfigurationAllOf) Get() *HttpActionConfigurationAllOf {
	return v.value
}

func (v *NullableHttpActionConfigurationAllOf) Set(val *HttpActionConfigurationAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableHttpActionConfigurationAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableHttpActionConfigurationAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHttpActionConfigurationAllOf(val *HttpActionConfigurationAllOf) *NullableHttpActionConfigurationAllOf {
	return &NullableHttpActionConfigurationAllOf{value: val, isSet: true}
}

func (v NullableHttpActionConfigurationAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHttpActionConfigurationAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
