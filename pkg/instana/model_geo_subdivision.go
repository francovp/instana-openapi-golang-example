...
// GeoSubdivision struct for GeoSubdivision
...
func (o GeoSubdivision) MarshalJSON() ([]byte, error) {
...
type NullableGeoSubdivision struct {
	value *GeoSubdivision
	isSet bool
}

func (v NullableGeoSubdivision) Get() *GeoSubdivision {
	return v.value
}

func (v *NullableGeoSubdivision) Set(val *GeoSubdivision) {
	v.value = val
	v.isSet = true
}

func (v NullableGeoSubdivision) IsSet() bool {
	return v.isSet
}

func (v *NullableGeoSubdivision) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGeoSubdivision(val *GeoSubdivision) *NullableGeoSubdivision {
	return &NullableGeoSubdivision{value: val, isSet: true}
}

func (v NullableGeoSubdivision) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGeoSubdivision) UnmarshalJSON(src []byte) error {
	v.isSet = true
