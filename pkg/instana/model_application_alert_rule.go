...
// ApplicationAlertRule struct for ApplicationAlertRule
type ApplicationAlertRule struct {
	Aggregation *string `json:"aggregation,omitempty"`
	AlertType   string  `json:"alertType"`
	MetricName  string  `json:"metricName"`
	StableHash  *int32  `json:"stableHash,omitempty"`
}
...
// GetStableHash returns the StableHash field value if set, zero value otherwise.
func (o *ApplicationAlertRule) GetStableHash() int32 {
	if o == nil || isNil(o.StableHash) {
		var ret int32
		return ret
	}
	return *o.StableHash
...
// GetStableHashOk returns a tuple with the StableHash field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApplicationAlertRule) GetStableHashOk() (*int32, bool) {
	if o == nil || isNil(o.StableHash) {
		return nil, false
	}
	return o.StableHash, true
}
...
// SetStableHash gets a reference to the given int32 and assigns it to the StableHash field.
func (o *ApplicationAlertRule) SetStableHash(v int32) {
	o.StableHash = &v
}

func (o ApplicationAlertRule) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.StableHash) {
		toSerialize["stableHash"] = o.StableHash
	}
	return json.Marshal(toSerialize)
}

type NullableApplicationAlertRule struct {
	value *ApplicationAlertRule
	isSet bool
}

func (v NullableApplicationAlertRule) Get() *ApplicationAlertRule {
	return v.value
}

func (v *NullableApplicationAlertRule) Set(val *ApplicationAlertRule) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationAlertRule) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationAlertRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationAlertRule(val *ApplicationAlertRule) *NullableApplicationAlertRule {
	return &NullableApplicationAlertRule{value: val, isSet: true}
}

func (v NullableApplicationAlertRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationAlertRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
