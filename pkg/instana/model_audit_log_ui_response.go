...
// AuditLogUiResponse struct for AuditLogUiResponse
type AuditLogUiResponse struct {
...
func (o AuditLogUiResponse) MarshalJSON() ([]byte, error) {
...
type NullableAuditLogUiResponse struct {
	value *AuditLogUiResponse
	isSet bool
}

func (v NullableAuditLogUiResponse) Get() *AuditLogUiResponse {
	return v.value
}

func (v *NullableAuditLogUiResponse) Set(val *AuditLogUiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAuditLogUiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAuditLogUiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuditLogUiResponse(val *AuditLogUiResponse) *NullableAuditLogUiResponse {
	return &NullableAuditLogUiResponse{value: val, isSet: true}
}

func (v NullableAuditLogUiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuditLogUiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
