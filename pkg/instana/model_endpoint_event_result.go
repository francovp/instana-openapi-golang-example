...
// EndpointEventResult struct for EndpointEventResult
type EndpointEventResult struct {
...
func (o EndpointEventResult) MarshalJSON() ([]byte, error) {
...
type NullableEndpointEventResult struct {
	value *EndpointEventResult
	isSet bool
}

func (v NullableEndpointEventResult) Get() *EndpointEventResult {
	return v.value
}

func (v *NullableEndpointEventResult) Set(val *EndpointEventResult) {
	v.value = val
	v.isSet = true
}

func (v NullableEndpointEventResult) IsSet() bool {
	return v.isSet
}

func (v *NullableEndpointEventResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEndpointEventResult(val *EndpointEventResult) *NullableEndpointEventResult {
	return &NullableEndpointEventResult{value: val, isSet: true}
}

func (v NullableEndpointEventResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEndpointEventResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
