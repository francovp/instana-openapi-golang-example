...
// MobileAppBeaconResult struct for MobileAppBeaconResult
type MobileAppBeaconResult struct {
	AdjustedTimeframe         *AdjustedTimeframe     `json:"adjustedTimeframe,omitempty"`
	CanLoadMore               *bool                  `json:"canLoadMore,omitempty"`
	Items                     []MobileAppBeaconsItem `json:"items"`
...
func (o MobileAppBeaconResult) MarshalJSON() ([]byte, error) {
...
type NullableMobileAppBeaconResult struct {
	value *MobileAppBeaconResult
	isSet bool
}

func (v NullableMobileAppBeaconResult) Get() *MobileAppBeaconResult {
	return v.value
}

func (v *NullableMobileAppBeaconResult) Set(val *MobileAppBeaconResult) {
	v.value = val
	v.isSet = true
}

func (v NullableMobileAppBeaconResult) IsSet() bool {
	return v.isSet
}

func (v *NullableMobileAppBeaconResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMobileAppBeaconResult(val *MobileAppBeaconResult) *NullableMobileAppBeaconResult {
	return &NullableMobileAppBeaconResult{value: val, isSet: true}
}

func (v NullableMobileAppBeaconResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMobileAppBeaconResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
