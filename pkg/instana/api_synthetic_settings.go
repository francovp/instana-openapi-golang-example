...
// SyntheticSettingsApiService SyntheticSettingsApi service
type SyntheticSettingsApiService service

type ApiCreateSyntheticTestRequest struct {
	ctx           context.Context
	ApiService    *SyntheticSettingsApiService
	syntheticTest *SyntheticTest
}

func (r ApiCreateSyntheticTestRequest) SyntheticTest(syntheticTest SyntheticTest) ApiCreateSyntheticTestRequest {
	r.syntheticTest = &syntheticTest
	return r
}

func (r ApiCreateSyntheticTestRequest) Execute() (*SyntheticTest, *http.Response, error) {
	return r.ApiService.CreateSyntheticTestExecute(r)
}

/*
CreateSyntheticTest Experimental - Create a Synthetic test
...
```
	...
	@return ApiCreateSyntheticTestRequest
*/
func (a *SyntheticSettingsApiService) CreateSyntheticTest(ctx context.Context) ApiCreateSyntheticTestRequest {
	return ApiCreateSyntheticTestRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *SyntheticSettingsApiService) CreateSyntheticTestExecute(r ApiCreateSyntheticTestRequest) (*SyntheticTest, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SyntheticTest
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SyntheticSettingsApiService.CreateSyntheticTest")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/synthetics/settings/tests"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.syntheticTest == nil {
		return localVarReturnValue, nil, reportError("syntheticTest is required and must be specified")
	}
...
type ApiDeleteSyntheticLocationRequest struct {
	ctx        context.Context
	ApiService *SyntheticSettingsApiService
	id         string
}

func (r ApiDeleteSyntheticLocationRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteSyntheticLocationExecute(r)
}

/*
DeleteSyntheticLocation Experimental - Delete Synthetic location

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiDeleteSyntheticLocationRequest
*/
func (a *SyntheticSettingsApiService) DeleteSyntheticLocation(ctx context.Context, id string) ApiDeleteSyntheticLocationRequest {
	return ApiDeleteSyntheticLocationRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *SyntheticSettingsApiService) DeleteSyntheticLocationExecute(r ApiDeleteSyntheticLocationRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SyntheticSettingsApiService.DeleteSyntheticLocation")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/synthetics/settings/locations/{id}"
...
type ApiDeleteSyntheticTestRequest struct {
	ctx        context.Context
	ApiService *SyntheticSettingsApiService
	id         string
}

func (r ApiDeleteSyntheticTestRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteSyntheticTestExecute(r)
}

/*
DeleteSyntheticTest Experimental - Delete a Synthetic test

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiDeleteSyntheticTestRequest
*/
func (a *SyntheticSettingsApiService) DeleteSyntheticTest(ctx context.Context, id string) ApiDeleteSyntheticTestRequest {
	return ApiDeleteSyntheticTestRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *SyntheticSettingsApiService) DeleteSyntheticTestExecute(r ApiDeleteSyntheticTestRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SyntheticSettingsApiService.DeleteSyntheticTest")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/synthetics/settings/tests/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterToString(r.id, "")), -1)
...
type ApiGetSyntheticLocationRequest struct {
	ctx        context.Context
	ApiService *SyntheticSettingsApiService
	id         string
}

func (r ApiGetSyntheticLocationRequest) Execute() (*SyntheticLocation, *http.Response, error) {
	return r.ApiService.GetSyntheticLocationExecute(r)
}

/*
GetSyntheticLocation Experimental - Synthetic location

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiGetSyntheticLocationRequest
*/
func (a *SyntheticSettingsApiService) GetSyntheticLocation(ctx context.Context, id string) ApiGetSyntheticLocationRequest {
	return ApiGetSyntheticLocationRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
func (a *SyntheticSettingsApiService) GetSyntheticLocationExecute(r ApiGetSyntheticLocationRequest) (*SyntheticLocation, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SyntheticSettingsApiService.GetSyntheticLocation")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetSyntheticLocationsRequest struct {
	ctx        context.Context
	ApiService *SyntheticSettingsApiService
}

func (r ApiGetSyntheticLocationsRequest) Execute() ([]SyntheticLocation, *http.Response, error) {
	return r.ApiService.GetSyntheticLocationsExecute(r)
}

/*
GetSyntheticLocations Experimental - All Synthetic locations

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetSyntheticLocationsRequest
*/
func (a *SyntheticSettingsApiService) GetSyntheticLocations(ctx context.Context) ApiGetSyntheticLocationsRequest {
	return ApiGetSyntheticLocationsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return []SyntheticLocation
func (a *SyntheticSettingsApiService) GetSyntheticLocationsExecute(r ApiGetSyntheticLocationsRequest) ([]SyntheticLocation, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SyntheticSettingsApiService.GetSyntheticLocations")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/synthetics/settings/locations"
...
type ApiGetSyntheticTestRequest struct {
	ctx        context.Context
	ApiService *SyntheticSettingsApiService
	id         string
}

func (r ApiGetSyntheticTestRequest) Execute() (*SyntheticTest, *http.Response, error) {
	return r.ApiService.GetSyntheticTestExecute(r)
}

/*
GetSyntheticTest Experimental - A Synthetic test

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiGetSyntheticTestRequest
*/
func (a *SyntheticSettingsApiService) GetSyntheticTest(ctx context.Context, id string) ApiGetSyntheticTestRequest {
	return ApiGetSyntheticTestRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return SyntheticTest
func (a *SyntheticSettingsApiService) GetSyntheticTestExecute(r ApiGetSyntheticTestRequest) (*SyntheticTest, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SyntheticSettingsApiService.GetSyntheticTest")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetSyntheticTestsRequest struct {
	ctx           context.Context
	ApiService    *SyntheticSettingsApiService
	applicationId *string
}

func (r ApiGetSyntheticTestsRequest) ApplicationId(applicationId string) ApiGetSyntheticTestsRequest {
	r.applicationId = &applicationId
	return r
}

func (r ApiGetSyntheticTestsRequest) Execute() ([]SyntheticTest, *http.Response, error) {
	return r.ApiService.GetSyntheticTestsExecute(r)
}

/*
GetSyntheticTests Experimental - All Synthetic tests

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetSyntheticTestsRequest
*/
func (a *SyntheticSettingsApiService) GetSyntheticTests(ctx context.Context) ApiGetSyntheticTestsRequest {
	return ApiGetSyntheticTestsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return []SyntheticTest
func (a *SyntheticSettingsApiService) GetSyntheticTestsExecute(r ApiGetSyntheticTestsRequest) ([]SyntheticTest, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SyntheticSettingsApiService.GetSyntheticTests")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateSyntheticTestRequest struct {
	ctx           context.Context
	ApiService    *SyntheticSettingsApiService
	id            string
	syntheticTest *SyntheticTest
...
func (r ApiUpdateSyntheticTestRequest) SyntheticTest(syntheticTest SyntheticTest) ApiUpdateSyntheticTestRequest {
	r.syntheticTest = &syntheticTest
	return r
}

func (r ApiUpdateSyntheticTestRequest) Execute() (*SyntheticTest, *http.Response, error) {
	return r.ApiService.UpdateSyntheticTestExecute(r)
}

/*
UpdateSyntheticTest Experimental - Update a Synthetic test

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiUpdateSyntheticTestRequest
*/
func (a *SyntheticSettingsApiService) UpdateSyntheticTest(ctx context.Context, id string) ApiUpdateSyntheticTestRequest {
	return ApiUpdateSyntheticTestRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return SyntheticTest
func (a *SyntheticSettingsApiService) UpdateSyntheticTestExecute(r ApiUpdateSyntheticTestRequest) (*SyntheticTest, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SyntheticSettingsApiService.UpdateSyntheticTest")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
