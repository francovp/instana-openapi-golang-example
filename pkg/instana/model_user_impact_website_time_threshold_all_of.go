...
// GetImpactMeasurementMethod returns the ImpactMeasurementMethod field value if set, zero value otherwise.
func (o *UserImpactWebsiteTimeThresholdAllOf) GetImpactMeasurementMethod() string {
	if o == nil || isNil(o.ImpactMeasurementMethod) {
		var ret string
		return ret
	}
...
// GetImpactMeasurementMethodOk returns a tuple with the ImpactMeasurementMethod field value if set, nil otherwise
...
// SetImpactMeasurementMethod gets a reference to the given string and assigns it to the ImpactMeasurementMethod field.
...
func (o UserImpactWebsiteTimeThresholdAllOf) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.ImpactMeasurementMethod) {
