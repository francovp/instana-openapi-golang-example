...
// MobileAppBeaconsItem struct for MobileAppBeaconsItem
type MobileAppBeaconsItem struct {
	Beacon MobileAppMonitoringBeacon `json:"beacon"`
...
func (o *MobileAppBeaconsItem) GetBeacon() MobileAppMonitoringBeacon {
	if o == nil {
		var ret MobileAppMonitoringBeacon
		return ret
	}
...
func (o MobileAppBeaconsItem) MarshalJSON() ([]byte, error) {
...
type NullableMobileAppBeaconsItem struct {
	value *MobileAppBeaconsItem
	isSet bool
}

func (v NullableMobileAppBeaconsItem) Get() *MobileAppBeaconsItem {
	return v.value
}

func (v *NullableMobileAppBeaconsItem) Set(val *MobileAppBeaconsItem) {
	v.value = val
	v.isSet = true
}

func (v NullableMobileAppBeaconsItem) IsSet() bool {
	return v.isSet
}

func (v *NullableMobileAppBeaconsItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMobileAppBeaconsItem(val *MobileAppBeaconsItem) *NullableMobileAppBeaconsItem {
	return &NullableMobileAppBeaconsItem{value: val, isSet: true}
}

func (v NullableMobileAppBeaconsItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMobileAppBeaconsItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
