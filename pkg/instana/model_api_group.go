...
// GetPermissionSet returns the PermissionSet field value
func (o *ApiGroup) GetPermissionSet() ApiPermissionSetWithRoles {
	if o == nil {
		var ret ApiPermissionSetWithRoles
		return ret
	}
...
// GetPermissionSetOk returns a tuple with the PermissionSet field value
// and a boolean to check if the value has been set.
...
// SetPermissionSet sets field value
func (o *ApiGroup) SetPermissionSet(v ApiPermissionSetWithRoles) {
	o.PermissionSet = v
}

func (o ApiGroup) MarshalJSON() ([]byte, error) {
...
type NullableApiGroup struct {
	value *ApiGroup
	isSet bool
}

func (v NullableApiGroup) Get() *ApiGroup {
	return v.value
}

func (v *NullableApiGroup) Set(val *ApiGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableApiGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableApiGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiGroup(val *ApiGroup) *NullableApiGroup {
	return &NullableApiGroup{value: val, isSet: true}
}

func (v NullableApiGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
