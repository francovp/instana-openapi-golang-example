...
// MetricAPIResult struct for MetricAPIResult
...
func (o MetricAPIResult) MarshalJSON() ([]byte, error) {
...
type NullableMetricAPIResult struct {
	value *MetricAPIResult
	isSet bool
}

func (v NullableMetricAPIResult) Get() *MetricAPIResult {
	return v.value
}

func (v *NullableMetricAPIResult) Set(val *MetricAPIResult) {
	v.value = val
	v.isSet = true
}

func (v NullableMetricAPIResult) IsSet() bool {
	return v.isSet
}

func (v *NullableMetricAPIResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetricAPIResult(val *MetricAPIResult) *NullableMetricAPIResult {
	return &NullableMetricAPIResult{value: val, isSet: true}
}

func (v NullableMetricAPIResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetricAPIResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
