...
// MobileAppAnalyzeApiService MobileAppAnalyzeApi service
type MobileAppAnalyzeApiService service

type ApiGetMobileAppBeaconGroupsRequest struct {
	ctx                      context.Context
	ApiService               *MobileAppAnalyzeApiService
	fillTimeSeries           *bool
	getMobileAppBeaconGroups *GetMobileAppBeaconGroups
}

func (r ApiGetMobileAppBeaconGroupsRequest) FillTimeSeries(fillTimeSeries bool) ApiGetMobileAppBeaconGroupsRequest {
	r.fillTimeSeries = &fillTimeSeries
	return r
}

func (r ApiGetMobileAppBeaconGroupsRequest) GetMobileAppBeaconGroups(getMobileAppBeaconGroups GetMobileAppBeaconGroups) ApiGetMobileAppBeaconGroupsRequest {
	r.getMobileAppBeaconGroups = &getMobileAppBeaconGroups
	return r
}

func (r ApiGetMobileAppBeaconGroupsRequest) Execute() (*MobileAppBeaconGroupsResult, *http.Response, error) {
	return r.ApiService.GetMobileAppBeaconGroupsExecute(r)
}

/*
GetMobileAppBeaconGroups Get grouped beacon metrics

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetMobileAppBeaconGroupsRequest
*/
func (a *MobileAppAnalyzeApiService) GetMobileAppBeaconGroups(ctx context.Context) ApiGetMobileAppBeaconGroupsRequest {
	return ApiGetMobileAppBeaconGroupsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return MobileAppBeaconGroupsResult
func (a *MobileAppAnalyzeApiService) GetMobileAppBeaconGroupsExecute(r ApiGetMobileAppBeaconGroupsRequest) (*MobileAppBeaconGroupsResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *MobileAppBeaconGroupsResult
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MobileAppAnalyzeApiService.GetMobileAppBeaconGroups")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/mobile-app-monitoring/analyze/beacon-groups"
	...
	// body params
	localVarPostBody = r.getMobileAppBeaconGroups
	if r.ctx != nil {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		var v MobileAppBeaconGroupsResult
...
type ApiGetMobileAppBeaconsRequest struct {
	ctx                 context.Context
	ApiService          *MobileAppAnalyzeApiService
	getMobileAppBeacons *GetMobileAppBeacons
}

func (r ApiGetMobileAppBeaconsRequest) GetMobileAppBeacons(getMobileAppBeacons GetMobileAppBeacons) ApiGetMobileAppBeaconsRequest {
	r.getMobileAppBeacons = &getMobileAppBeacons
	return r
}

func (r ApiGetMobileAppBeaconsRequest) Execute() (*MobileAppBeaconResult, *http.Response, error) {
	return r.ApiService.GetMobileAppBeaconsExecute(r)
}

/*
GetMobileAppBeacons Get all beacons

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetMobileAppBeaconsRequest
*/
func (a *MobileAppAnalyzeApiService) GetMobileAppBeacons(ctx context.Context) ApiGetMobileAppBeaconsRequest {
	return ApiGetMobileAppBeaconsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *MobileAppAnalyzeApiService) GetMobileAppBeaconsExecute(r ApiGetMobileAppBeaconsRequest) (*MobileAppBeaconResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *MobileAppBeaconResult
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MobileAppAnalyzeApiService.GetMobileAppBeacons")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/mobile-app-monitoring/analyze/beacons"
	...
	// body params
	localVarPostBody = r.getMobileAppBeacons
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKeyAuth"]; ok {
