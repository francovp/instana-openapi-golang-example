...
func (r ApiGetAuditLogsRequest) Execute() (*AuditLogUiResponse, *http.Response, error) {
...
func (a *AuditLogApiService) GetAuditLogsExecute(r ApiGetAuditLogsRequest) (*AuditLogUiResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *AuditLogUiResponse
	)
