...
// SetChangeSummary gets a reference to the given ChangeSummary and assigns it to the ChangeSummary field.
...
func (o ConfigVersion) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.ChangeSummary) {
		toSerialize["changeSummary"] = o.ChangeSummary
	}
	if !isNil(o.Created) {
