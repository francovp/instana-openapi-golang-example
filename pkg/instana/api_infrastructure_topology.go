...
// InfrastructureTopologyApiService InfrastructureTopologyApi service
type InfrastructureTopologyApiService service

type ApiGetRelatedHostsRequest struct {
	ctx        context.Context
	ApiService *InfrastructureTopologyApiService
	snapshotId string
}

func (r ApiGetRelatedHostsRequest) Execute() ([]string, *http.Response, error) {
...
*/
func (a *InfrastructureTopologyApiService) GetRelatedHosts(ctx context.Context, snapshotId string) ApiGetRelatedHostsRequest {
	return ApiGetRelatedHostsRequest{
		ApiService: a,
		ctx:        ctx,
...
//
//	@return []string
func (a *InfrastructureTopologyApiService) GetRelatedHostsExecute(r ApiGetRelatedHostsRequest) ([]string, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InfrastructureTopologyApiService.GetRelatedHosts")
	if err != nil {
...
func (r ApiGetTopologyRequest) IncludeData(includeData bool) ApiGetTopologyRequest {
	r.includeData = &includeData
	return r
}

func (r ApiGetTopologyRequest) Execute() (*Topology, *http.Response, error) {
	return r.ApiService.GetTopologyExecute(r)
}

/*
GetTopology Gets the infrastructure topology

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetTopologyRequest
*/
func (a *InfrastructureTopologyApiService) GetTopology(ctx context.Context) ApiGetTopologyRequest {
	return ApiGetTopologyRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return Topology
func (a *InfrastructureTopologyApiService) GetTopologyExecute(r ApiGetTopologyRequest) (*Topology, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InfrastructureTopologyApiService.GetTopology")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/infrastructure-monitoring/topology"
