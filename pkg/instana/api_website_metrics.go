...
func (r ApiGetBeaconMetricsRequest) Execute() (*WebsiteMetricResult, *http.Response, error) {
...
Deprecated
*/
func (a *WebsiteMetricsApiService) GetBeaconMetrics(ctx context.Context) ApiGetBeaconMetricsRequest {
	return ApiGetBeaconMetricsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
// Deprecated
func (a *WebsiteMetricsApiService) GetBeaconMetricsExecute(r ApiGetBeaconMetricsRequest) (*WebsiteMetricResult, *http.Response, error) {
	var (
...
type ApiGetBeaconMetricsV2Request struct {
	ctx                 context.Context
	ApiService          *WebsiteMetricsApiService
	getWebsiteMetricsV2 *GetWebsiteMetricsV2
}

func (r ApiGetBeaconMetricsV2Request) GetWebsiteMetricsV2(getWebsiteMetricsV2 GetWebsiteMetricsV2) ApiGetBeaconMetricsV2Request {
	r.getWebsiteMetricsV2 = &getWebsiteMetricsV2
	return r
}

func (r ApiGetBeaconMetricsV2Request) Execute() (*MetricAPIResult, *http.Response, error) {
	return r.ApiService.GetBeaconMetricsV2Execute(r)
}

/*
GetBeaconMetricsV2 Get beacon metrics

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetBeaconMetricsV2Request
*/
func (a *WebsiteMetricsApiService) GetBeaconMetricsV2(ctx context.Context) ApiGetBeaconMetricsV2Request {
	return ApiGetBeaconMetricsV2Request{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *WebsiteMetricsApiService) GetBeaconMetricsV2Execute(r ApiGetBeaconMetricsV2Request) (*MetricAPIResult, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebsiteMetricsApiService.GetBeaconMetricsV2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/website-monitoring/v2/metrics"
	...
	// body params
	localVarPostBody = r.getWebsiteMetricsV2
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKeyAuth"]; ok {
...
func (r ApiGetPageLoadRequest) Execute() ([]WebsiteMonitoringBeacon, *http.Response, error) {
...
*/
func (a *WebsiteMetricsApiService) GetPageLoad(ctx context.Context, id string, timestamp int64) ApiGetPageLoadRequest {
	return ApiGetPageLoadRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
func (a *WebsiteMetricsApiService) GetPageLoadExecute(r ApiGetPageLoadRequest) ([]WebsiteMonitoringBeacon, *http.Response, error) {
	var (
