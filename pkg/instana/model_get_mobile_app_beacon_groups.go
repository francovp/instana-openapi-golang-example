...
// GetMobileAppBeaconGroups struct for GetMobileAppBeaconGroups
type GetMobileAppBeaconGroups struct {
	Group               MobileAppBeaconTagGroup                   `json:"group"`
	Metrics             []MobileAppMonitoringMetricsConfiguration `json:"metrics"`
	...
	TagFilters          []DeprecatedTagFilter                     `json:"tagFilters,omitempty"`
...
func (o *GetMobileAppBeaconGroups) GetGroup() MobileAppBeaconTagGroup {
	if o == nil {
		var ret MobileAppBeaconTagGroup
		return ret
	}
...
func (o *GetMobileAppBeaconGroups) GetMetrics() []MobileAppMonitoringMetricsConfiguration {
	if o == nil {
		var ret []MobileAppMonitoringMetricsConfiguration
		return ret
	}
...
// SetTagFilters gets a reference to the given []DeprecatedTagFilter and assigns it to the TagFilters field.
...
func (o GetMobileAppBeaconGroups) MarshalJSON() ([]byte, error) {
...
type NullableGetMobileAppBeaconGroups struct {
	value *GetMobileAppBeaconGroups
	isSet bool
}

func (v NullableGetMobileAppBeaconGroups) Get() *GetMobileAppBeaconGroups {
	return v.value
}

func (v *NullableGetMobileAppBeaconGroups) Set(val *GetMobileAppBeaconGroups) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMobileAppBeaconGroups) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMobileAppBeaconGroups) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMobileAppBeaconGroups(val *GetMobileAppBeaconGroups) *NullableGetMobileAppBeaconGroups {
	return &NullableGetMobileAppBeaconGroups{value: val, isSet: true}
}

func (v NullableGetMobileAppBeaconGroups) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMobileAppBeaconGroups) UnmarshalJSON(src []byte) error {
	v.isSet = true
