...
// ViolationsInPeriodApplicationTimeThreshold struct for ViolationsInPeriodApplicationTimeThreshold
type ViolationsInPeriodApplicationTimeThreshold struct {
...
func NewViolationsInPeriodApplicationTimeThreshold(type_ string) *ViolationsInPeriodApplicationTimeThreshold {
	this := ViolationsInPeriodApplicationTimeThreshold{}
	this.Type = type_
	return &this
}
...
func (o ViolationsInPeriodApplicationTimeThreshold) MarshalJSON() ([]byte, error) {
...
type NullableViolationsInPeriodApplicationTimeThreshold struct {
	value *ViolationsInPeriodApplicationTimeThreshold
	isSet bool
}

func (v NullableViolationsInPeriodApplicationTimeThreshold) Get() *ViolationsInPeriodApplicationTimeThreshold {
	return v.value
}

func (v *NullableViolationsInPeriodApplicationTimeThreshold) Set(val *ViolationsInPeriodApplicationTimeThreshold) {
	v.value = val
	v.isSet = true
}

func (v NullableViolationsInPeriodApplicationTimeThreshold) IsSet() bool {
	return v.isSet
}

func (v *NullableViolationsInPeriodApplicationTimeThreshold) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViolationsInPeriodApplicationTimeThreshold(val *ViolationsInPeriodApplicationTimeThreshold) *NullableViolationsInPeriodApplicationTimeThreshold {
	return &NullableViolationsInPeriodApplicationTimeThreshold{value: val, isSet: true}
}

func (v NullableViolationsInPeriodApplicationTimeThreshold) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViolationsInPeriodApplicationTimeThreshold) UnmarshalJSON(src []byte) error {
	v.isSet = true
