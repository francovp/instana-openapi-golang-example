...
// MobileAppBeaconTagGroup struct for MobileAppBeaconTagGroup
type MobileAppBeaconTagGroup struct {
...
func (o *MobileAppBeaconTagGroup) GetGroupbyTagSecondLevelKey() string {
	if o == nil || isNil(o.GroupbyTagSecondLevelKey) {
		var ret string
		return ret
	}
...
func (o MobileAppBeaconTagGroup) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.GroupbyTagSecondLevelKey) {
		toSerialize["groupbyTagSecondLevelKey"] = o.GroupbyTagSecondLevelKey
	}
	return json.Marshal(toSerialize)
}

type NullableMobileAppBeaconTagGroup struct {
	value *MobileAppBeaconTagGroup
	isSet bool
}

func (v NullableMobileAppBeaconTagGroup) Get() *MobileAppBeaconTagGroup {
	return v.value
}

func (v *NullableMobileAppBeaconTagGroup) Set(val *MobileAppBeaconTagGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableMobileAppBeaconTagGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableMobileAppBeaconTagGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMobileAppBeaconTagGroup(val *MobileAppBeaconTagGroup) *NullableMobileAppBeaconTagGroup {
	return &NullableMobileAppBeaconTagGroup{value: val, isSet: true}
}

func (v NullableMobileAppBeaconTagGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMobileAppBeaconTagGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
