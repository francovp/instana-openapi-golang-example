...
// WebsiteEventBasedSliEntity struct for WebsiteEventBasedSliEntity
type WebsiteEventBasedSliEntity struct {
	BadEventFilterExpression  TagFilterExpressionElement `json:"badEventFilterExpression"`
	BeaconType                string                     `json:"beaconType"`
	GoodEventFilterExpression TagFilterExpressionElement `json:"goodEventFilterExpression"`
...
func NewWebsiteEventBasedSliEntity(badEventFilterExpression TagFilterExpressionElement, beaconType string, goodEventFilterExpression TagFilterExpressionElement, sliType string) *WebsiteEventBasedSliEntity {
	this := WebsiteEventBasedSliEntity{}
	this.SliType = sliType
	this.BadEventFilterExpression = badEventFilterExpression
	this.BeaconType = beaconType
	this.GoodEventFilterExpression = goodEventFilterExpression
	return &this
}
...
// GetBadEventFilterExpression returns the BadEventFilterExpression field value
...
// GetBadEventFilterExpressionOk returns a tuple with the BadEventFilterExpression field value
...
// GetBeaconTypeOk returns a tuple with the BeaconType field value
// and a boolean to check if the value has been set.
func (o *WebsiteEventBasedSliEntity) GetBeaconTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.BeaconType, true
}

// SetBeaconType sets field value
func (o *WebsiteEventBasedSliEntity) SetBeaconType(v string) {
	o.BeaconType = v
}

// GetGoodEventFilterExpression returns the GoodEventFilterExpression field value
...
// GetGoodEventFilterExpressionOk returns a tuple with the GoodEventFilterExpression field value
// and a boolean to check if the value has been set.
...
// SetGoodEventFilterExpression sets field value
...
func (o WebsiteEventBasedSliEntity) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["badEventFilterExpression"] = o.BadEventFilterExpression
	}
	if true {
		toSerialize["beaconType"] = o.BeaconType
	}
	if true {
...
type NullableWebsiteEventBasedSliEntity struct {
	value *WebsiteEventBasedSliEntity
	isSet bool
}

func (v NullableWebsiteEventBasedSliEntity) Get() *WebsiteEventBasedSliEntity {
	return v.value
}

func (v *NullableWebsiteEventBasedSliEntity) Set(val *WebsiteEventBasedSliEntity) {
	v.value = val
	v.isSet = true
}

func (v NullableWebsiteEventBasedSliEntity) IsSet() bool {
	return v.isSet
}

func (v *NullableWebsiteEventBasedSliEntity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebsiteEventBasedSliEntity(val *WebsiteEventBasedSliEntity) *NullableWebsiteEventBasedSliEntity {
	return &NullableWebsiteEventBasedSliEntity{value: val, isSet: true}
}

func (v NullableWebsiteEventBasedSliEntity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebsiteEventBasedSliEntity) UnmarshalJSON(src []byte) error {
	v.isSet = true
