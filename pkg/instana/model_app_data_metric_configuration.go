...
type AppDataMetricConfiguration struct {
	...
	NumeratorTagFilterExpression *TagFilterExpressionElement `json:"numeratorTagFilterExpression,omitempty"`
}
...
// GetNumeratorTagFilterExpression returns the NumeratorTagFilterExpression field value if set, zero value otherwise.
func (o *AppDataMetricConfiguration) GetNumeratorTagFilterExpression() TagFilterExpressionElement {
	if o == nil || isNil(o.NumeratorTagFilterExpression) {
		var ret TagFilterExpressionElement
		return ret
	}
	return *o.NumeratorTagFilterExpression
}

// GetNumeratorTagFilterExpressionOk returns a tuple with the NumeratorTagFilterExpression field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppDataMetricConfiguration) GetNumeratorTagFilterExpressionOk() (*TagFilterExpressionElement, bool) {
	if o == nil || isNil(o.NumeratorTagFilterExpression) {
		return nil, false
	}
	return o.NumeratorTagFilterExpression, true
}
...
// SetNumeratorTagFilterExpression gets a reference to the given TagFilterExpressionElement and assigns it to the NumeratorTagFilterExpression field.
func (o *AppDataMetricConfiguration) SetNumeratorTagFilterExpression(v TagFilterExpressionElement) {
	o.NumeratorTagFilterExpression = &v
}
...
func (o AppDataMetricConfiguration) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.NumeratorTagFilterExpression) {
		toSerialize["numeratorTagFilterExpression"] = o.NumeratorTagFilterExpression
	}
